...
2. `showcase-*-routes.ts` (60 endpoints, ~2800 linjer 105258-108050) — **kartlagt 2026-05-10:** ~40 unike sub-segmenter, krever splitt i ~8 sub-moduler. Sub-modul-progresjon:
   ...
   - `showcase-categories-routes.ts` (4) — GET/POST /categories, GET /profession/:profession, GET /day-categories ✅ **gjort** (commit pending push). 4 deps (app, pool, getTableColumns, mapShowcaseItemRow).

...
2. `showcase-*-routes.ts` (60 endpoints, ~2800 linjer 105258-108050) — **kartlagt 2026-05-10:** ~40 unike sub-segmenter, krever splitt i ~8 sub-moduler. Sub-modul-progresjon:
   ...
   - `showcase-items-routes.ts` (7) — items CRUD inkl. legacy/alias URL-er ✅ **gjort** (commit pending push). 4 deps (app, pool, updateShowcaseItemRecord, mapShowcaseItemRow). De 2 helpers blir værende i index.ts (12 bruk hver, brukt av mange ikke-ekstraktrte endpoints).

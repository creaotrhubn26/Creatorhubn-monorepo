        ...
        SceneData(
            nodes: [
                ...
                Node(id: "key-light", name: "Key Light", kind: .light, enabled: true,
                     transform: Transform(position: [2.45, 3.10, 2.80], rotationEulerDeg: [-35, -45, 0], scale: .one),
                ...
                Node(id: "back-light", name: "Back Light", kind: .light, enabled: true,
                     transform: Transform(position: [0, 4.2, -1.6], rotationEulerDeg: [-60, 0, 0], scale: .one),
                ...
                Node(id: "camera-a", name: "Camera A", kind: .camera, enabled: true,
                     transform: Transform(position: [0.2, 1.4, 4.6], rotationEulerDeg: [0, -2, 0], scale: .one),
                ...
                Node(id: "camera-b", name: "Camera B", kind: .camera, enabled: true,
                     transform: Transform(position: [-2.8, 1.5, 4.1], rotationEulerDeg: [0, 18, 0], scale: .one),
                ...
                Node(id: "camera-c", name: "Camera C", kind: .camera, enabled: true,
                     transform: Transform(position: [2.9, 1.5, 4.0], rotationEulerDeg: [0, -19, 0], scale: .one),

...
struct PitchSlideRenderer: View {
    ...
    private var coverSlide: some View {
        VStack(alignment: .leading, spacing: 28) {
            ...
            if let tagline = coverTagline, !tagline.isEmpty {
                Text(tagline)
                    .font(.appScaled(size: 56, weight: .semibold))
    ...
    private var frictionSlide: some View {
        VStack(alignment: .leading, spacing: 28) {
            ...
            Spacer().frame(height: 24)
            Text(slide.titleMd)
                .font(.appScaled(size: 52, weight: .semibold))
                .foregroundStyle(.white)
                .fixedSize(horizontal: false, vertical: true)
    ...
    private var howItWorksSlide: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            HStack(spacing: 32) {
                ...
                Text(slide.bodyMd)
                    .font(.appScaled(size: 20, weight: .regular))
                    .foregroundStyle(Self.muted)
                    .lineSpacing(6)
        ...
        VStack(alignment: .leading, spacing: 16) {
            ...
            ForEach(Array(items.enumerated()), id: \.offset) { _, item in
                HStack(alignment: .top, spacing: 12) {
                    ...
                    Text(item)
                        .font(.appScaled(size: 19, weight: .regular))
    ...
    private var nextStepSlide: some View {
        VStack(alignment: .leading, spacing: 24) {
            ...
            Text(slide.titleMd)
                .font(.appScaled(size: 64, weight: .semibold))
                .foregroundStyle(.white)
                .fixedSize(horizontal: false, vertical: true)
            Text(slide.bodyMd)
                .font(.appScaled(size: 22, weight: .regular))

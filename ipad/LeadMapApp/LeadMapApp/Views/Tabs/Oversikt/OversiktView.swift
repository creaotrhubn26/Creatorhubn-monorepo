        ...
        ZStack(alignment: .bottomTrailing) {
            ...
            MapReader { proxy in
                Map(position: $miniCamera, interactionModes: [.pan, .zoom]) {
                    ...
                    // Bruker den felles serverdrevne profilavataren, med initialer hvis
...
// Den kanoniske profilflaten ligger i Leadbook/MinProfil.swift.
    ...
    private var profileHeader: some View {
        HStack(spacing: 14) {
            LeadgridProfileAvatar(
                imageURL: appState.profileImageURL,
                initials: initials,
                size: 52,

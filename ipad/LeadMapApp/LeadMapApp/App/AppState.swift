...
final class AppState {
    ...
    func refreshAll() async {
        ...
        do {
            ...
            // Resultatene tilhører org-konteksten refreshen startet med.
            // Ikke publiser eller push dem dersom brukeren byttet org mens
            // de parallelle kallene var i flight.
            guard activeOrganizationId == organizationId else { return }
            self.leads = newLeads
            self.leadsLoadState = .loaded

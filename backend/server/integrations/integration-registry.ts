...
export const INTEGRATION_REGISTRY_ENTRIES: IntegrationRegistryEntry[] = [
  ...
  // ── Salgstrigger-kilder ────────────────────────────────────────────
  entry({
    integrationId: "ted-tenders",
    provider: "EU Publications Office",
    displayName: "TED (EU-anbud, inkl. norske over terskelverdi)",
    category: "public_data",
    purpose: "Anbuds-triggere per vertikal — salgsvindu med frist (trigger-basert salg)",
    supportedDataTypes: ["tender_notices"],
    authenticationType: "none",
    credentialReference: null,
    apiBaseUrl: "https://api.ted.europa.eu",
    apiVersion: "v3",
    availabilityStatus: "active",
    implementationStatus: "active",
    accessLevel: "public",
    ...
    syncMode: "scheduled",
    termsStatus: "ok",
    geographicCoverage: "EU/EØS",
    documentationReference: "backend/server/integrations/sales-trigger-sync.ts",
  }),
  entry({
    integrationId: "gdelt",
    provider: "GDELT Project",
    displayName: "GDELT (globalt nyhetsdatasett)",
    category: "public_data",
    purpose: "Strategisignaler i norske medier per vertikal og lead-selskap",
  ...
  entry({
    integrationId: "doffin",
    provider: "DFØ",
    displayName: "Doffin (norske anbud, også under terskelverdi)",
    category: "public_data",
    purpose: "Full norsk anbudsdekning for trigger-basert salg — TED dekker kun over EU-terskel",
    supportedDataTypes: ["tender_notices"],
    authenticationType: "api_key",
    credentialReference: "DOFFIN_API_KEY (gratis nøkkel via dfo.no/anskaffelser utviklerportal)",
    apiBaseUrl: "https://api.doffin.no",
    apiVersion: "v2",
    availabilityStatus: "active",
    implementationStatus: "missingCredentials",
    accessLevel: "app_granted",
    tenantScope: "per_org",
    syncMode: "scheduled",
    termsStatus: "ok",
  ...
  entry({
    integrationId: "nav-jobs",
    provider: "NAV",
    displayName: "NAV stillingsfeed (arbeidsplassen.no)",
    category: "public_data",
    purpose: "Strategiske ansettelser som kjøpssignal (ESG-/bærekraftsroller, vekststillinger)",
    supportedDataTypes: ["job_postings"],
    authenticationType: "api_key",
    credentialReference: "NAV_FEED_TOKEN (gratis — pam-stilling-feed, søkes hos NAV)",
    apiBaseUrl: "https://pam-stilling-feed.nav.no",
    apiVersion: "v1",
    availabilityStatus: "active",
    implementationStatus: "missingCredentials",
    accessLevel: "app_granted",
  ...
  entry({
    integrationId: "nordic-business-search",
    provider: "Brønnøysundregistrene / data.altinn.no",
    displayName: "Nordisk virksomhetssøk (NO/SE/FI/IS)",
    category: "public_data",
    purpose: "Sanntids virksomhetsoppslag i fire nordiske land — aktiveres når Leadgrid skal utenfor Norge (berikelse + territorietall for nye markeder)",
    supportedDataTypes: ["company_profile", "organization_status", "registration_date"],
    authenticationType: "api_key",
    credentialReference: "NORDIC_BUSINESS_API_KEY (registrering på data.altinn.no — verifisert 2026-07-13 at alt bak roten krever nøkkel)",
    apiBaseUrl: "https://data.altinn.no",
    apiVersion: null,
    availabilityStatus: "active",
    implementationStatus: "missingCredentials",
    accessLevel: "app_granted",
    ...
    syncMode: "on_demand",
    termsStatus: "requiresReview",
    geographicCoverage: "NO/SE/FI/IS",
    documentationReference: "docs/integration-audit/01 (ekspansjons-kilder); kobles i lead-brreg-service når nøkkel finnes",
  }),
  ...
  // ── Tilskudds- og innsynskilder (undersøkt per kilde 2026-07-13) ──
  entry({
    integrationId: "einnsyn",
    provider: "Digdir",
    displayName: "eInnsyn (offentlige postjournaler)",
    category: "public_data",
    purpose: "Journalposter fra stat/kommune — hvem korresponderer med hvilke etater (avansert etterretning). VERIFISERT: api.einnsyn.no/journalpost svarer åpent",
    supportedDataTypes: ["journal_entries"],
    authenticationType: "none",
    credentialReference: null,
    apiBaseUrl: "https://api.einnsyn.no",
    apiVersion: null,
    availabilityStatus: "active",
    implementationStatus: "discovered",
    accessLevel: "public",
    ...
    termsStatus: "ok",
    geographicCoverage: "NO",
    documentationReference: "undersøkt 2026-07-13 — API åpent; kobling bygges ved behov",
  }),
  entry({
    integrationId: "innovasjon-norge-tilsagn",
    provider: "Innovasjon Norge",
    displayName: "IN tilsagn (lån/tilskudd per bedrift)",
    category: "public_data",
    purpose: "Bedrifter med ferske tilsagn = budsjett i bevegelse (kjøpssignal). Datasett offisielt PUBLIC i Felles datakatalog, men distribusjons-URL ikke eksponert og portalene bot-blokkerte — tilgangsvei må avklares med IN",
    supportedDataTypes: ["grant_awards"],
    authenticationType: "none",
    credentialReference: null,
    apiBaseUrl: null,
    apiVersion: null,
    ...
    termsStatus: "requiresReview",
    geographicCoverage: "NO",
    documentationReference: "data.norge.no datasett 260ac6dd (undersøkt 2026-07-13)",
  }),
  entry({
    integrationId: "nfi-tildelinger",
    provider: "Norsk filminstitutt",
    displayName: "NFI-tildelinger (produksjonsstøtte film/TV)",
    category: "public_data",
    purpose: "Filmselskaper med fersk produksjonsstøtte = casting-/crew-behov NÅ (TRR-kjernen). Publiseres kun som HTML-side (nfi.no/tildelinger, verifisert — ingen API/strukturert data); UI-scraping brytes mot egne regler — spør NFI om datatilgang",
    supportedDataTypes: ["grant_awards"],
    authenticationType: "none",
    credentialReference: null,
    apiBaseUrl: null,
    ...
    termsStatus: "requiresReview",
    geographicCoverage: "NO",
    documentationReference: "undersøkt 2026-07-13 — HTML-only; kontakt NFI for uttrekk",
  }),
  entry({
    integrationId: "kulturdirektoratet-tildelinger",
    provider: "Kulturdirektoratet",
    displayName: "Kulturdirektoratets tildelinger (dans/scenekunst)",
    category: "public_data",
    purpose: "Dansekompanier/scenekunst med fersk støtte = prosjekt i gang. Ingen API funnet på probede stier (undersøkt 2026-07-13) — datatilgang må avklares",
    supportedDataTypes: ["grant_awards"],
    authenticationType: "none",
    credentialReference: null,
    apiBaseUrl: null,
    ...
    termsStatus: "requiresReview",
    geographicCoverage: "NO",
    documentationReference: "undersøkt 2026-07-13 — ingen maskinlesbar kilde funnet",
  }),
  entry({
    integrationId: "enova-prosjekter",
    provider: "Enova",
    displayName: "Enova-støtte (bærekraftsinvesteringer)",
    category: "public_data",
    purpose: "Bedrifter med Enova-støtte = bærekraftsinvestering i gang (kobler til strategitriggerne). Prosjektliste-URL flyttet — ny kilde ikke lokalisert ennå",
    supportedDataTypes: ["grant_awards"],
    authenticationType: "none",
    credentialReference: null,
    apiBaseUrl: null,
    ...
    termsStatus: "requiresReview",
    geographicCoverage: "NO",
    documentationReference: "undersøkt 2026-07-13 — kilde må re-lokaliseres",
  }),

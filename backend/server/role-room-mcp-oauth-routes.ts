...
<form method="post" action="${OAUTH_BASE}/authorize">
  ...
  <button name="decision" value="approve" style="background:#5d76cb;color:#fff;border:0;padding:12px 18px;border-radius:8px;font-weight:700;cursor:pointer">Godkjenn</button>

...
import { archiveToRoleRoomB2, deleteFromRoleRoomB2, presignRoleRoomB2Download, getFromRoleRoomB2, slugifyForKey } from "./b2-archive-helper";
...
export function setupProjectWorkspaceRoutes(deps: ProjectWorkspaceRoutesDeps): void {
  ...
  const mapVideoVersion = async (v: any, ttl = 3600) => {
    ...
    return {
      ...
      fileUrl: streamUrl || (v.b2_key ? await presignRoleRoomB2Download(v.b2_key, ttl) : (v.file_url || null)),

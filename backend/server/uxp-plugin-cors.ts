...
export const UXP_PLUGIN_API_PATHS = [
  ...
  "/api/projects/:projectId/video-collaboration",
  "/api/projects/:projectId/video-comments",
  "/api/projects/:projectId/video-comments/:commentId",
  "/api/projects/:projectId/video-comments/:commentId/task",
  "/api/projects/:projectId/video-tasks/:taskId",
  "/api/projects/:projectId/video-rounds",
  "/api/projects/:projectId/video-rounds/:roundId",
  "/api/projects/:projectId/video-approval-steps",
  "/api/projects/:projectId/video-transcription/generate",

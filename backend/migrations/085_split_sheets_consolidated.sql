...
CREATE INDEX IF NOT EXISTS idx_split_sheets_created_at ON split_sheets(created_at);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_contributors_sheet_id ON split_sheet_contributors(split_sheet_id);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_contributors_status ON split_sheet_contributors(invitation_status);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_versions_sheet_id ON split_sheet_versions(split_sheet_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_versions_version_number ON split_sheet_versions(split_sheet_id, version_number);
CREATE INDEX IF NOT EXISTS idx_split_sheet_versions_created_at ON split_sheet_versions(created_at);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_revenue_sheet_id ON split_sheet_revenue(split_sheet_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_revenue_period ON split_sheet_revenue(period_start, period_end);
CREATE INDEX IF NOT EXISTS idx_split_sheet_revenue_source ON split_sheet_revenue(revenue_source);
CREATE INDEX IF NOT EXISTS idx_split_sheet_revenue_platform ON split_sheet_revenue(platform);
CREATE INDEX IF NOT EXISTS idx_split_sheet_revenue_created_at ON split_sheet_revenue(created_at);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_payments_sheet_id ON split_sheet_payments(split_sheet_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_payments_contributor_id ON split_sheet_payments(contributor_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_payments_revenue_id ON split_sheet_payments(revenue_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_payments_status ON split_sheet_payments(payment_status);
CREATE INDEX IF NOT EXISTS idx_split_sheet_payments_date ON split_sheet_payments(payment_date);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_comments_sheet_id ON split_sheet_comments(split_sheet_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_comments_parent_id ON split_sheet_comments(parent_comment_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_comments_user_id ON split_sheet_comments(user_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_comments_created_at ON split_sheet_comments(created_at);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_templates_user_id ON split_sheet_templates(user_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_templates_system ON split_sheet_templates(is_system_template);
CREATE INDEX IF NOT EXISTS idx_split_sheet_templates_public ON split_sheet_templates(is_public);
CREATE INDEX IF NOT EXISTS idx_split_sheet_templates_usage ON split_sheet_templates(usage_count DESC);
...
CREATE INDEX IF NOT EXISTS idx_contributor_access_token ON split_sheet_contributor_access(access_token);
CREATE INDEX IF NOT EXISTS idx_contributor_access_contributor ON split_sheet_contributor_access(contributor_id);
CREATE INDEX IF NOT EXISTS idx_contributor_access_expires ON split_sheet_contributor_access(expires_at);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_invoices_sheet ON split_sheet_invoices(split_sheet_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_invoices_status ON split_sheet_invoices(status);
CREATE INDEX IF NOT EXISTS idx_split_sheet_invoices_fiken ON split_sheet_invoices(fiken_invoice_id);
...
CREATE INDEX IF NOT EXISTS idx_split_sheet_calendar_events_sheet ON split_sheet_calendar_events(split_sheet_id);
CREATE INDEX IF NOT EXISTS idx_split_sheet_calendar_events_date ON split_sheet_calendar_events(event_date);
CREATE INDEX IF NOT EXISTS idx_split_sheet_calendar_events_type ON split_sheet_calendar_events(event_type);
...
DROP TRIGGER IF EXISTS update_split_sheets_updated_at ON split_sheets;
CREATE TRIGGER update_split_sheets_updated_at BEFORE UPDATE ON split_sheets
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_contributors_updated_at ON split_sheet_contributors;
CREATE TRIGGER update_split_sheet_contributors_updated_at BEFORE UPDATE ON split_sheet_contributors
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_revenue_updated_at ON split_sheet_revenue;
CREATE TRIGGER update_split_sheet_revenue_updated_at BEFORE UPDATE ON split_sheet_revenue
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_payments_updated_at ON split_sheet_payments;
CREATE TRIGGER update_split_sheet_payments_updated_at BEFORE UPDATE ON split_sheet_payments
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_comments_updated_at ON split_sheet_comments;
CREATE TRIGGER update_split_sheet_comments_updated_at BEFORE UPDATE ON split_sheet_comments
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_templates_updated_at ON split_sheet_templates;
CREATE TRIGGER update_split_sheet_templates_updated_at BEFORE UPDATE ON split_sheet_templates
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_songflow_links_updated_at ON split_sheet_songflow_links;
CREATE TRIGGER update_split_sheet_songflow_links_updated_at BEFORE UPDATE ON split_sheet_songflow_links
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_invoices_updated_at ON split_sheet_invoices;
CREATE TRIGGER update_split_sheet_invoices_updated_at BEFORE UPDATE ON split_sheet_invoices
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_split_sheet_calendar_events_updated_at ON split_sheet_calendar_events;
...
DROP TRIGGER IF EXISTS auto_calculate_payments ON split_sheet_revenue;
...
DROP TRIGGER IF EXISTS sync_split_sheet_songflow_columns_trigger ON split_sheet_songflow_links;

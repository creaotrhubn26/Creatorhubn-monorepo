# Reknaren (arbeidsnavn) — norsk regnskapsplattform
...
createdb reknaren_dev && createdb reknaren_test

# Kjør migrasjoner
DATABASE_URL=postgres://<bruker>@localhost:5432/reknaren_dev npm run migrate

# Kjør testene (bruker TEST_DATABASE_URL, default reknaren_test lokalt)
npm test

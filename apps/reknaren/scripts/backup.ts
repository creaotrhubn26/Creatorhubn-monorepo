 ...
 *
 * Miljø: DATABASE_URL, REKNAREN_STORAGE_DIR (default ./data/documents),
 * REKNAREN_BACKUP_DIR (default ./backups).
 */
import { loadConfig } from '../src/config.js';
import { runBackup, verifyBackup } from '../src/ops/backup.js';

const config = loadConfig();
const backupDir = process.env.REKNAREN_BACKUP_DIR ?? './backups';

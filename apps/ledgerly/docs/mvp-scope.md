...
- **Prosjekt og avdelinger (kostnadsbærere)** — register med stabile koder, validering ved bokføring/faktura, dimensjon på kostnads- og inntektslinjer, lønnsomhetsrapport per prosjekt/avdeling og egen UI-skjerm.
...
- **Frontend** — SPA-en i `web/` dekker den vertikale flyten med tre presentasjonsnivåer (enkel/avansert/regnskapsfører).

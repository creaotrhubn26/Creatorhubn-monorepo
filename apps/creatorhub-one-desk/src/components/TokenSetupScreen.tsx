...
export default function TokenSetupScreen({ onSaved, onBack: _onBack }: Props) {
  // _onBack reservert for fremtidig bak-knapp i den nye chub://-paste-UX-en.
  // Vi mottar den fra App.tsx slik at type-kontrakten matcher.

...
// Incremental SHA-256 keeps large Premiere exports out of plugin memory while
// producing the checksum required by the private S3 upload contract.
...
class Sha256 {
  ...
  update(input) {
    if (this.finished) throw new Error("SHA-256 er allerede ferdigstilt.");

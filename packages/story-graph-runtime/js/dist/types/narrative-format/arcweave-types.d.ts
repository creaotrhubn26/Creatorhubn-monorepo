...
export type ArcweaveAttributeValueType = 'string' | 'component-list' | 'asset-list' | 'integer' | 'float' | 'boolean';
...
export declare function isArcweaveFolder(value: unknown): value is ArcweaveFolder;

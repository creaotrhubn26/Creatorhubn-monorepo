...
function RoleSummaryHeader({
  ...
  return (
    <Alert
      ...
      sx={{
        mb: 2,
        bgcolor: `${roleMeta?.color ?? '#93a4dc'}15`,
        border: `1px solid ${roleMeta?.color ?? '#93a4dc'}66`,
      }}
    >
      <Stack spacing={1}>
...
const ROLE_COLUMNS = [
  { key: 'admin', label: 'Admin', color: '#93a4dc' },
  ...
  return (
    <Dialog open={open} onClose={onClose} fullWidth maxWidth="lg">
      ...
      <DialogContent dividers>
        ...
        <Stack direction="row" spacing={3} sx={{ mt: 2, p: 1.5, bgcolor: 'rgba(147, 164, 220,0.06)', borderRadius: 1 }}>

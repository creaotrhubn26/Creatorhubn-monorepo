...
import { TerritoryManagerDashboard } from '../../components/leadgrid/TerritoryManagerDashboard';
...
export default function MarketingCockpitTab() {
  ...
  return (
    ...
    <Stack spacing={2} data-testid="marketing-cockpit-root">
        ...
        <>
          ...
          <Box sx={{ display: 'grid', gap: 1.5, gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' } }}>
            <Card sx={PANEL_SX} data-testid="panel-mentions">
              <CardContent sx={{ p: 2 }}>
                <SectionHeader icon={<TagIcon sx={{ color: '#93a4dc', fontSize: 20 }} />}
      ...
      {cockpitTab === 'b2b' && (<>
        <Divider sx={{ borderColor: 'rgba(93, 118, 203,0.32)' }}>
          <Chip label="B2B-AKKVISISJON" size="small"
            sx={{ background: 'rgba(75, 61, 143,0.18)', color: '#93a4dc', fontSize: '0.7rem', fontWeight: 700 }} />
        </Divider>
      ...
      {cockpitTab === 'leads' && (<>
        <Divider sx={{ borderColor: 'rgba(93, 118, 203,0.32)' }}>
          <Chip label="MIN DAG" size="small"
            sx={{ background: 'rgba(147, 164, 220,0.18)', color: '#93a4dc', fontSize: '0.7rem', fontWeight: 700 }} />
        </Divider>
        <LeadMapMyDayPanel />
        <Divider sx={{ borderColor: 'rgba(93, 118, 203,0.32)' }}>

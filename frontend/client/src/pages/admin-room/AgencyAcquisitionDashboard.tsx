...
export default function AgencyAcquisitionDashboard() {
  ...
  if (loading) {
    return (
      <Card sx={{ bgcolor: '#2a3d56', border: '1px solid rgba(93, 118, 203,0.18)' }}>
  ...
  return (
    <Card sx={{
      bgcolor: '#2a3d56', border: '1px solid rgba(93, 118, 203,0.18)',
      borderRadius: 2,
    }}>
      <CardContent>
        {/* Header */}
        <Stack direction="row" alignItems="center" justifyContent="space-between" sx={{ mb: 3 }}>
          <Stack direction="row" alignItems="center" spacing={1.4}>
            <Box sx={{
              ...
              <TrendingUpOutlinedIcon sx={{ color: '#93a4dc', fontSize: 24 }} />
            </Box>
            <Stack>
        ...
        <Stack direction="row" spacing={1.4} sx={{ mb: 3 }}>
          {[
            {
              label: 'Total leads', value: t.total, color: '#93a4dc',
        ...
        <Box sx={{ mb: 3, p: 2, borderRadius: 1.6, bgcolor: 'rgba(93, 118, 203,0.04)', border: '1px solid rgba(93, 118, 203,0.18)' }}>
                ...
                <Stack key={stage.key} direction="row" alignItems="flex-end" sx={{ flex: 1 }}>
                  <Box sx={{ flex: 1 }}>
                    ...
                    <Box sx={{
                      ...
                      <Typography sx={{ fontSize: '1.4rem', fontWeight: 800, color: '#2a3152', lineHeight: 1 }}>
                        {stage.count}
                      </Typography>
                      <Typography sx={{ fontSize: '0.68rem', fontWeight: 700, color: '#2a3152', mt: 0.2 }}>
                        {meta.label}
                      </Typography>
                    </Box>
                  </Box>
        ...
        <Stack direction={{ xs: 'column', md: 'row' }} spacing={1.4} sx={{ mb: 3 }}>
          {/* Pipeline-verdi */}
          <Box sx={{ flex: 1, p: 2, borderRadius: 1.6, bgcolor: 'rgba(93, 118, 203,0.04)', border: '1px solid rgba(93, 118, 203,0.18)' }}>
            ...
            <Stack spacing={0.8}>
              {[
                ...
                { label: 'Vektet pipeline (alle stadier)', value: data.pipelineValueNok.weighted_pipeline, weight: 100, color: '#93a4dc' },
              ].map((p) => (
                <Box key={p.label}>
          ...
          <Box sx={{ flex: 1, p: 2, borderRadius: 1.6, bgcolor: 'rgba(93, 118, 203,0.04)', border: '1px solid rgba(93, 118, 203,0.18)' }}>
            <Stack direction="row" alignItems="center" spacing={0.8} sx={{ mb: 1.4 }}>
              <TrendingUpOutlinedIcon sx={{ color: '#93a4dc', fontSize: 18 }} />
              <Typography sx={{ fontSize: '0.84rem', fontWeight: 700, color: '#f5f3ff' }}>
                ...
                return (
                  <Box key={lead.id} sx={{
                    ...
                    <Box sx={{
                      ...
                      <GroupsOutlinedIcon sx={{ color: '#2a3152', fontSize: 18 }} />
                    </Box>
                    ...
                    <Stack direction="row" spacing={0.8} alignItems="center">
                      ...
                      {nextStatus && (
                        <Button
                          ...
                          sx={{
                            bgcolor: stageMeta.color, color: '#2a3152',
        ...
        <Menu
          ...
          PaperProps={{ sx: { bgcolor: '#2a3d56', color: '#f5f3ff', border: '1px solid rgba(93, 118, 203,0.3)' } }}
        >
        ...
        {/* Top sources */}
        <Box sx={{ p: 2, borderRadius: 1.6, bgcolor: 'rgba(93, 118, 203,0.04)', border: '1px solid rgba(93, 118, 203,0.18)' }}>
          <Typography sx={{ fontSize: '0.84rem', fontWeight: 700, color: '#f5f3ff', mb: 1.4 }}>
            Topp-kilder
          </Typography>
          {topSources.length === 0 ? (
                    ...
                    <Box sx={{ flex: 1, position: 'relative' }}>
                      <LinearProgress
                        ...
                        sx={{
                          ...
                          '& .MuiLinearProgress-bar': { bgcolor: '#93a4dc' },
                        }}
                      />
                    </Box>

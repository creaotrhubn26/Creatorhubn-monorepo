...
class AuditLogger {
  ...
  private exportToCSV(events: AuditEvent[]): string {
    ...
    const headers = [
      'id','timestamp','userId','sessionId','action','resource','resourceId','severity','category','tags','ipAddress','userAgent'
    ];

...
export const ADMIN_EMAIL_DESIGNER_PRESETS: AdminEmailDesignerPreset[] = [
  {
    ...
    description: 'Sendes når en redigeringspartner godkjennes som prototype-tester (0 % i en periode).',
    summary: 'Gratulerer-mail som bekrefter prototype-status, periode og 0 % gebyr.',
  ...
  },
  {
    ...
    category: 'Partnerprogram',
    description: 'Sendes når en redigeringspartner godkjennes som vanlig kunde (med partner-fee).',
    summary: 'Gratulerer-mail som bekrefter partner-status og plattformgebyr.',

...
export default function AIAnalyticsInsights({
  ...
  const { data: insightsData, refetch: refetchInsights, isLoading: insightsLoading } = useQuery({
    ...
    queryFn: async () => {
      ...
      return apiRequest(`/api/ai/analytics/insights?startDate=${dateRange}&endDate=today`, { headers });
    },
  ...
  const { data: predictionsData, isLoading: predictionsLoading } = useQuery({
    ...
    queryFn: async () => {
      const headers = await auth.getAuthHeader();
      return apiRequest(`/api/ai/analytics/predictions?startDate=${dateRange}&endDate=today`, { headers });
    },
  ...
  const { data: reportData, isLoading: reportLoading } = useQuery({
    ...
    queryFn: async () => {
      const headers = await auth.getAuthHeader();
      return apiRequest(`/api/ai/analytics/report?startDate=${dateRange}&endDate=today`, { headers });
    },

    ...
    return {
      ...
      loginPanel: {
        ...
        fields: [
          ...
          { key: 'subtitle',    label: 'Undertittel', type: 'multiline' },
          {
            key: 'useCases',
            label: 'Brukstilfeller (én per linje: rolleId|Beskrivelse)',
            type: 'multiline',
            helperText: 'Eks: photographer|Book talent, brief crew og lever ferdige bilder',
          },
          {
            key: 'stats',
            label: 'Statistikk (én per linje: verdi|etikett)',
            type: 'multiline',
            helperText: 'Eks: 1 247|kreative',
          },
          {
            key: 'testimonials',
            label: 'Attester (én per linje: rolleId|sitat|navn|tittel)',
            type: 'multiline',
            helperText: 'Eks: casting_director|The Role Room sparte meg...|Maria H.|Casting Director',
          },
          { key: 'ctaButtonLabel', label: 'Innloggingsknapp-tekst (standard: Logg Inn)' },
          {
            key: 'demoMode',
            label: 'Demo-modus — tillat gjest-inngang uten innlogging',
            type: 'switch',
            helperText: 'Når av: skjuler «Gå inn uten innlogging»-knappen overalt',
          },
        ],
        ...
        demoMode: true,
        useCases: [
          'photographer|Book talent, brief crew og lever ferdige bilder',
          'director|Bygg shotliste, koordiner crew og hold deadline',
          'talent|Søk auditions og motta rolletilbud direkte',
          'producer|Planlegg innspilling og logistikk i én flyt',
          'agent|Send klienter til riktige auditions automatisk',
          'casting_director|Finn rett talent til rett rolle — raskt',
          'client|Følg produksjonen fra brief til ferdig levering',
        ].join('\n'),
      },
      intro: {
        id: 'intro',
        title: 'Intro & Backdrop',
        fields: [
          { key: 'enabled',          label: 'Vis intro-video ved sideåpning', type: 'switch' },
          { key: 'videoUrl',         label: 'Intro-video URL' },
          { key: 'skipLabel',        label: 'Hopp over-tekst' },
          { key: 'backdropVideoUrl', label: 'Bakgrunnsvideo URL' },
          { key: 'whyLabel',         label: 'Seksjonstittel — Hvorfor' },
          { key: 'whyText',          label: 'Hvorfor-tekst', type: 'multiline' },
          { key: 'howLabel',         label: 'Seksjonstittel — Slik' },
          { key: 'howText',          label: 'Slik-tekst', type: 'multiline' },
          { key: 'whatLabel',        label: 'Seksjonstittel — Hva du får' },
        ],
        enabled:          true,
        ...
        whyText:          'Vi tror at hver god fortelling starter med de rette menneskene i de rette rollene.',
        howLabel:         'Slik gjør vi det',
        howText:          'Vi samler roller, kandidater, auditions og produksjonsplan i ett arbeidsrom — slik at du aldri mister oversikten.',

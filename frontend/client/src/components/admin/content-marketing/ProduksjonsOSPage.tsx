      ...
      <Container maxWidth="md">
        ...
        >
          <Typography component="h2" sx={{ color: '#fff', fontWeight: 800, fontSize: { xs: '1.3rem', md: '1.5rem' }, mb: 2 }}>
            Tre vertikaler bygget på samme kjerne
          </Typography>
          <Typography sx={{ color: 'rgba(229,231,235,0.78)', fontSize: { xs: '0.94rem', md: '1rem' }, lineHeight: 1.65, mb: 2.5 }}>
            Produksjonsteam er kjernevertikalen. To andre er bygget på samme datalag og
            kjøres som egne pillarer med dedikert pris og funksjonalitet.
          </Typography>
          <Stack spacing={1.5}>
            <Box
              component="a"

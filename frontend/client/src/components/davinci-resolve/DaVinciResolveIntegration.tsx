...
export default function DaVinciResolveIntegration() {
const queryClient = useQueryClient();
  
  // Theming system
  const theming = useTheming('videographer');
  
  // Database connection for DaVinciResolveIntegration
  ...
  const updateDaVinciResolveIntegration = useMutation({

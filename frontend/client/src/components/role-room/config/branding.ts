...
export const BRANDING_LABELS_EN: Partial<Record<BrandingTextTokenKey, string>> = {
  ...
  // ── Fase 2c: full EN-sweep av DEFAULT_TOKENS.labels (736 nøkler, agent-oversatt + gjennomgått) ──
// --- Access / permission messages ---
  noAccessSchedule: 'You do not have access to edit the production plan',
  noAccessShotList: 'You do not have access to edit shot lists',
  noAccessSharing: 'You do not have access to sharing settings',
  mustCreateProject: 'You must create a project first',
  needCandidateAndRole: 'You must have at least one candidate and one role before you can create a schedule',

// --- Roles (casting) ---
  assignedRolesLabel: 'Assigned roles',
  consentSignedLabel: 'consents signed',
  unknownRoleLabel: 'Unknown role',
  roleOwnerLabel: 'Owner',
  roleDirectorLabel: 'Director',
  roleProducerLabel: 'Producer',
  roleCastingDirectorLabel: 'Casting Director',
  roleProductionManagerLabel: 'Production Manager',
  roleCameraTeamLabel: 'Camera Team',
  roleAgencyLabel: 'Agency',
  roleNameRequired: 'Role must have a name',
  roleSaveError: 'Error saving role',
...
// --- Candidates ---
  candidateNameRequired: 'Candidate must have a name',
  candidateSaveError: 'Error saving candidate',
  confirmDeleteCandidate: 'Are you sure you want to delete this candidate?',
  candidateDeleteError: 'Error deleting candidate',

// --- Schedule / calendar (casting) ---
...
// --- Users / team ---
  ...
  confirmRemoveUserLabel: 'Are you sure you want to remove this user?',
  removeUserErrorLabel: 'Error removing user',

// --- Projects / admin chrome ---
  activeProjectLabel: 'Active project',
  editProjectAriaLabel: 'Edit {project}',
  editProjectLabel: 'Edit project',
  confirmDeleteProjectWithWarning: 'Are you sure you want to delete the project "{project}"? This action cannot be undone.',
  projectDeleteError: 'Could not delete the project. Try again.',
  deleteProjectAriaLabel: 'Delete {project}',
  deleteProjectLabel: 'Delete project',
  tutorialLabel: 'Tutorial',
  tutorialTitle: 'Interactive tutorial',
  switchProfessionLabel: 'Switch view',
  editTutorialsLabel: 'Edit tutorials',
  manageUsersLabel: 'Manage users',
  confirmResetDemoProjects: 'Reset demo projects? This will restore the default data.',
  demoDataResetSuccess: 'Demo data reset',
  resetDemoDataLabel: 'Reset demo data',
  showIntroLabel: 'Show introduction',
  showIntroTitle: 'Show introduction again',
  logoutLabel: 'Log out',
  loginLabel: 'Log in',
  rolesStatLabel: '{total} roles ({open} open)',
  candidatesStatLabel: '{count} candidates',
  upcomingStatLabel: '{count} upcoming',
...
// --- Candidate list / filters ---
  ...
  candidateStatusAll: 'All statuses',
  candidateStatusPending: 'Pending',
  candidateStatusRequested: 'Requested',
  candidateStatusSelected: 'Selected',
  candidateStatusConfirmed: 'Confirmed',
  candidateStatusRejected: 'Rejected',
  listViewLabel: 'List view',
  kanbanViewLabel: 'Kanban view',
  draggingCandidateLabel: 'Dragging candidate: {name}',
  cancelLabel: 'Cancel',
  quickContactLabel: 'Quick contact:',
  emailTooltipPrefix: 'Email: ',
  callTooltipPrefix: 'Call: ',
  dateLabel: 'Date',
  candidateLabel: 'Candidate',
  roleLabel: 'Role',
  allCandidatesLabel: 'All candidates',
  allRolesLabel: 'All roles',
  resetFiltersLabel: 'Reset filters',

// --- Role dialog ---
  roleDialogNewTitle: 'New role',
  roleDialogEditTitle: 'Edit role',
  roleBasicsSectionLabel: 'Basics',
  roleNameLabel: 'Role name',
  roleDescriptionLabel: 'Description',
  roleMinAgeLabel: 'Min age',
  roleMaxAgeLabel: 'Max age',
  genderLabel: 'Gender',
  genderMaleLabel: 'Male',
  genderFemaleLabel: 'Female',
  genderNonBinaryLabel: 'Non-binary',
  genderAllLabel: 'All',
  roleStatusOpen: 'Open',
  roleStatusFilled: 'Filled',
  roleStatusCancelled: 'Cancelled',
  roleRequirementsSectionLabel: 'Requirements and associations',
  roleAppearanceLabel: 'Appearance',
  roleAppearancePlaceholder: 'height, hair color...',
  roleSkillsLabel: 'Skills',
  roleSkillsPlaceholder: 'acting, dance...',
  roleSpecialNeedsLabel: 'Special needs',
  roleSpecialNeedsPlaceholder: 'uniform, dialect...',
  roleScenesLabel: 'Scenes',
  rolePropsLabel: 'Props',
  saveRoleLabel: 'Save role',
  deleteLabel: 'Delete',

// --- Candidate dialog ---
  candidateDialogNewTitle: 'New candidate',
  candidateDialogEditTitle: 'Edit candidate',
  nameLabel: 'Name',
  emailLabel: 'Email',
  phoneLabel: 'Phone',
  addressLabel: 'Address',
  mediaSectionLabel: 'Photos / Video',
  uploadMediaLabel: 'Upload photos/video',
  candidatePhotoAltLabel: 'Candidate photo {index}',
  auditionNotesLabel: 'Audition notes',
  emergencyContactSectionLabel: 'Emergency contact',
  relationshipLabel: 'Relationship',
  consentSectionLabel: 'Consent',
  sendConsentOnSaveLabel: 'Send consent contract after saving',
  consentSendHelpText: 'The candidate will receive an invitation to sign the consent contract via email or SMS',
  saveLabel: 'Save',

// --- Schedule dialog ---
  scheduleDialogNewTitle: 'New schedule',
  scheduleDialogEditTitle: 'Edit schedule',
  timeLabel: 'Time',
  locationLabel: 'Location',
  noLocationLabel: 'No location',
  locationFallbackLabel: 'Or enter an address',
  locationFallbackPlaceholder: 'Used if a location is not registered',
  sceneOptionalLabel: 'Scene (optional)',
  noSceneLabel: 'No scene',
  notesLabel: 'Notes',
...
// --- Project list / delete ---
  allProjectsLabel: 'All projects ({count})',
  lastUpdatedLabel: 'Last updated:',
  unknownLabel: 'Unknown',
  candidatesCountLabel: '{count} candidates',
  confirmDeleteProjectShort: 'Are you sure you want to delete "{project}"?',
  confirmDeleteProjectDialogBody: 'Are you sure you want to delete the project "{project}"?',
  deleteProjectWarning: 'This action cannot be undone. All data associated with the project will be permanently deleted.',
  projectDeleteErrorShort: 'Could not delete the project.',
  closeLabel: 'Close',
  projectIdLabel: 'Project ID',
  editProjectTitle: 'Edit Project',
  newCastingProjectTitle: 'New Role Room project',
  newProjectPrefix: 'New',

// --- Profession / photo & video terms ---
  professionPhotographerName: 'Photographer',
  termPhotoProject: 'Photo project',
  termPhotoShot: 'Photo',
  termPhotoShoot: 'Photo shoot',
  termPhotoShootDay: 'Photo day',
  termPhotoShotList: 'Photo list',
  termPhotoPortfolio: 'Portfolio',
  termPhotoSingle: 'Photo',
  termPhotoPlural: 'Photos',
  professionVideographerName: 'Videographer',
  termVideoProject: 'Video project',
  termVideoShootDay: 'Shoot day',
  termVideoShotList: 'Scene list',
  termVideoPlural: 'Videos',
  propsHeaderLabel: 'Props',

// --- Manuscript export tooltip ---
  exportTooltip: 'Export the entire manuscript with production data as JSON',

// --- Manuscript — toasts (not yet in EN) ---
  manuscriptToastOffline: 'Offline - working in offline mode',
  manuscriptToastMissingTitle: 'Please fill in a title',
  manuscriptToastCreated: 'Manuscript created',
  manuscriptToastCreateError: 'Error creating manuscript',
  manuscriptToastSaved: 'Manuscript saved',
  manuscriptToastSaveError: 'Error saving manuscript',
  manuscriptToastAutoBreakdownPrefix: 'Automatic breakdown complete: ',
  manuscriptToastAutoBreakdownScenesLabel: ' scenes, ',
  manuscriptToastAutoBreakdownCharactersLabel: ' characters found',
  manuscriptToastAutoBreakdownError: 'Error during automatic breakdown',
  manuscriptToastExported: 'Manuscript exported as JSON',
  manuscriptToastExportError: 'Error during export',
  manuscriptToastImported: 'Manuscript imported and ready to use',
  manuscriptToastImportError: 'Error during import',
  manuscriptToastTemplateAppliedPrefix: 'Template "',
  manuscriptToastTemplateAppliedSuffix: '" applied',
  manuscriptToastTemplateApplyError: 'Error applying template',
  manuscriptToastTemplateInsertedPrefix: 'Template "',
  manuscriptToastTemplateInsertedSuffix: '" inserted',
  manuscriptToastDeleted: 'Manuscript deleted',
  manuscriptToastDeleteError: 'Error deleting manuscript',
  manuscriptToastCoverUpdated: 'Cover updated',
  manuscriptToastSceneSaved: 'Scene saved',
  manuscriptToastSceneSaveError: 'Could not save scene changes',
  manuscriptToastSceneDeleted: 'Scene deleted',
  manuscriptToastSceneDeleteError: 'Could not delete scene',
  manuscriptToastSceneCreated: 'New scene created',
  manuscriptToastSceneCreateError: 'Could not create scene',
  manuscriptToastSceneOrderUpdated: 'Scene order updated',
  manuscriptToastSceneOrderError: 'Could not update scene order',
  manuscriptToastUpdateError: 'Could not save manuscript changes',
  manuscriptToastParsedHeadingsPrefix: 'Parsed ',
  manuscriptToastParsedHeadingsSuffix: ' scenes from the manuscript',

// --- Manuscript — stat suffixes / save-state / badges ---
  manuscriptPagesSuffix: 'pages',
  manuscriptScenesSuffix: 'scenes',
  manuscriptCharactersSuffix: 'characters',
  manuscriptWordsSuffix: 'words',
  manuscriptStatusDraftBadge: 'DRAFT',
  manuscriptStatusReviewBadge: 'REVIEW',
  manuscriptStatusApprovedBadge: 'APPROVED',
  manuscriptStatusProductionBadge: 'PRODUCTION',
  manuscriptStatusCompletedBadge: 'COMPLETED',
  manuscriptSavedLabelShort: 'Saved',
  manuscriptSavedLabel: 'Saved',
  manuscriptSavingLabel: 'Saving...',
  manuscriptUnsavedShort: '● Unsaved',
  manuscriptUnsavedLong: '● Unsaved changes',
  manuscriptSaveErrorTooltip: 'Error during auto-save - try saving manually',
  manuscriptSaveErrorLabel: 'Save error',
  manuscriptOnlineTooltip: 'Connected to network',
  manuscriptOfflineTooltip: 'Working offline - changes are saved locally',

// --- Manuscript — tabs ---
  manuscriptTabActs: 'Acts',
  manuscriptTabScenes: 'Scenes',
  manuscriptTabCharacters: 'Characters',
  manuscriptTabDialogue: 'Dialogue',
  manuscriptTabProduction: 'Production',

// --- Manuscript — stat tooltips ---
  manuscriptTooltipPages: 'Approximate number of pages based on the manuscript',
  manuscriptTooltipRuntime: 'Estimated runtime based on industry standard (1 page ~ 1 min)',
  manuscriptTooltipWords: 'Total number of words in the manuscript',
  manuscriptTooltipHeadings: 'Number of scene headings in the manuscript',
  manuscriptTooltipCharacters: 'Number of unique characters in the manuscript',

// --- Manuscript — Acts ---
  manuscriptActsTitle: 'Acts / Chapters',
  manuscriptActsAddShort: 'New Act',
  manuscriptActsAddLong: 'Add Act',
  manuscriptActsEmptyTitle: 'No acts yet',
  manuscriptActsEmptyBody: 'Create acts to structure the manuscript into chapters or acts.',
  manuscriptActsCardTitlePrefix: 'Act',
  manuscriptActsNoDescription: 'No description',
  manuscriptActsNoPages: 'No pages',
  manuscriptActsPageLabel: 'p.',
  manuscriptActsTableNumber: 'Act #',
  manuscriptActsTableTitle: 'Title',
  manuscriptActsTableDescription: 'Description',
  manuscriptActsTablePages: 'Pages',
  manuscriptActsTableDuration: 'Duration',
  manuscriptActsTableActions: 'Actions',
  manuscriptActsDialogNewTitle: 'New Act',
  manuscriptActsDialogEditTitle: 'Edit Act',
  manuscriptActsFieldNumber: 'Act Number',
  manuscriptActsFieldTitle: 'Title',
  manuscriptActsFieldDescription: 'Description',
  manuscriptActsFieldPageStart: 'Start Page',
  manuscriptActsFieldPageEnd: 'End Page',
  manuscriptActsFieldRuntime: 'Estimated Duration (minutes)',
  manuscriptActsFieldColor: 'Color code (hex)',
  manuscriptActsDialogCancel: 'Cancel',
  manuscriptActsDialogCreate: 'Create',
  manuscriptActsDialogUpdate: 'Update',
  manuscriptActsSuccessUpdated: 'Act updated',
  manuscriptActsSuccessCreated: 'Act created',
  manuscriptActsSuccessDeleted: 'Act deleted',
  manuscriptActsErrorSave: 'Error saving act',
  manuscriptActsErrorDelete: 'Error deleting act',
  manuscriptActsDeleteConfirm: 'Are you sure you want to delete this act?',

// --- Manuscript — Scenes ---
  manuscriptScenesAddShort: 'New Scene',
  manuscriptScenesAddLong: 'Add Scene',
  manuscriptScenesEmptyTitle: 'No scenes yet',
  manuscriptScenesEmptyBody: 'Use "Auto Breakdown" to generate scenes from the manuscript.',
  manuscriptScenesPageSuffix: 'pages',
  manuscriptScenesCharactersSuffix: 'characters',

// --- Manuscript — Characters ---
  manuscriptCharactersTitle: 'Characters',
  manuscriptCharactersSearchPlaceholder: 'Search characters...',
  manuscriptCharactersLeadCount: 'lead roles',
  manuscriptCharactersSupportingCount: 'supporting roles',
  manuscriptCharactersMinorCount: 'minor roles',
  manuscriptCharactersEmptyTitle: 'No characters found',
  manuscriptCharactersEmptyBody: 'Characters are pulled from dialogue and scene data.',
  manuscriptCharactersAgeLabel: 'Age',
  manuscriptCharactersDialogueLabel: 'lines',
  manuscriptCharactersSceneLabel: 'scenes',
  manuscriptCharactersScenesLabel: 'Scenes',
  manuscriptCharactersScenesMoreSuffix: 'more',  // TODO-review
  manuscriptCharactersDialogTitle: 'Edit Character',
  manuscriptCharactersFieldAlias: 'Nickname / Alias',
  manuscriptCharactersFieldAliasPlaceholder: "e.g. 'Dr. N' or 'The Paleontologist'",
  manuscriptCharactersFieldAge: 'Age',
  manuscriptCharactersFieldAgePlaceholder: "e.g. '30s' or '45'",
  manuscriptCharactersFieldRole: 'Role type',
  manuscriptCharactersRoleLead: 'Lead',
  manuscriptCharactersRoleSupporting: 'Supporting',
  manuscriptCharactersRoleMinor: 'Minor',
  manuscriptCharactersRoleExtra: 'Extra',
  manuscriptCharactersFieldDescription: 'Description',
  manuscriptCharactersFieldDescriptionPlaceholder: 'Character description, background, motivation...',
  manuscriptCharactersDialogCancel: 'Cancel',
  manuscriptCharactersDialogSave: 'Save',
  manuscriptCharactersUpdatedSuccess: 'Character profile updated',

// --- Manuscript — Dialogue ---
  manuscriptDialogueTitle: 'All Dialogue',
  manuscriptDialogueAddButton: 'Add Line',
  manuscriptDialogueFilterCharacter: 'Filter character',
  manuscriptDialogueFilterScene: 'Filter scene',
  manuscriptDialogueFilterAll: 'All',
  manuscriptDialogueEmptyTitle: 'No dialogue found yet',
  manuscriptDialogueEmptyBody: 'Click "Add Line" to get started.',
  manuscriptDialogueDialogEditTitle: 'Edit Line',
  manuscriptDialogueDialogNewTitle: 'New Line',
  manuscriptDialogueFieldCharacter: 'Character',
  manuscriptDialogueFieldCharacterPlaceholder: 'e.g. NORA TIDEMANN',
  manuscriptDialogueFieldCharacterHelper: 'Write the character name in capital letters',
  manuscriptDialogueFieldDialogue: 'Dialogue',
  manuscriptDialogueFieldDialoguePlaceholder: 'What does the character say?',
  manuscriptDialogueFieldParenthetical: 'Parenthetical (optional)',
  manuscriptDialogueFieldParentheticalPlaceholder: 'e.g. smiling, worried, to Anna',
  manuscriptDialogueFieldParentheticalHelper: 'Directing instructions for the actor',
  manuscriptDialogueFieldEmotion: 'Emotion (optional)',
  manuscriptDialogueEmotionNone: 'None',
  manuscriptDialogueEmotionNeutral: 'Neutral',
  manuscriptDialogueEmotionHappy: 'Happy',
  manuscriptDialogueEmotionSad: 'Sad',
  manuscriptDialogueEmotionAngry: 'Angry',
  manuscriptDialogueEmotionFrightened: 'Frightened',
  manuscriptDialogueEmotionSurprised: 'Surprised',
  manuscriptDialogueEmotionConfused: 'Confused',
  manuscriptDialogueEmotionDetermined: 'Determined',
  manuscriptDialogueEmotionHopeful: 'Hopeful',
  manuscriptDialogueEmotionDesperate: 'Desperate',
  manuscriptDialogueEmotionWistful: 'Wistful',
  manuscriptDialogueEmotionMysterious: 'Mysterious',
  manuscriptDialogueDialogCancel: 'Cancel',
  manuscriptDialogueDialogCreate: 'Create',
  manuscriptDialogueDialogUpdate: 'Update',
  manuscriptDialogueDeleteConfirm: 'Are you sure you want to delete this line?',
  manuscriptDialogueSuccessCreated: 'Dialogue created and synced',
  manuscriptDialogueSuccessUpdated: 'Dialogue updated and synced',
  manuscriptDialogueSuccessDeleted: 'Dialogue deleted and synced',
  manuscriptDialogueErrorSave: 'Error saving dialogue',
  manuscriptDialogueErrorDelete: 'Error deleting dialogue',

// --- Manuscript — Revisions ---
  manuscriptRevisionsTitleShort: 'Revisions',
  manuscriptRevisionsTitleLong: 'Script Revisions & Diff Viewer',
  manuscriptRevisionsNewShort: 'New',
  manuscriptRevisionsNewLong: 'New Revision',
  manuscriptRevisionsEmptyTitle: 'No revisions yet',
  manuscriptRevisionsEmptyBodyShort: 'Create one to save snapshots.',
  manuscriptRevisionsEmptyBodyLong: 'Create a revision to save a snapshot of the manuscript and compare changes over time.',
  manuscriptRevisionsHistoryTitle: 'Revision history',
  manuscriptRevisionsNoDescription: 'No description',
  manuscriptRevisionsRestoreTooltip: 'Restore',
  manuscriptRevisionsDeleteTooltip: 'Delete',
  manuscriptRevisionsDeleteConfirm: 'Are you sure you want to delete this revision?',
  manuscriptRevisionsDeleteError: 'Error deleting revision',
  manuscriptRevisionsRestoreConfirm: 'Do you want to restore this version? Current changes will be overwritten.',
  manuscriptRevisionsRestoredSuccess: 'Revision restored',
  manuscriptRevisionsDeletedSuccess: 'Revision deleted',
  manuscriptRevisionsCreateDialogTitle: 'Create New Revision',
  manuscriptRevisionsCreateInfoShort: 'A revision saves a snapshot of the manuscript.',
  manuscriptRevisionsCreateInfoLong: 'A revision saves a snapshot of the current manuscript. You can later compare revisions and see changes over time.',
  manuscriptRevisionsNameLabel: 'Revision name',
  manuscriptRevisionsNamePlaceholder: "e.g. 'Draft 2' or 'After director meeting'",
  manuscriptRevisionsNotesLabel: 'Notes / Change description',
  manuscriptRevisionsNotesPlaceholder: 'Describe what changed in this revision...',
  manuscriptRevisionsCurrentVersionLabel: 'Current',
  manuscriptRevisionsNewVersionLabel: 'New',
  manuscriptRevisionsSaveShort: 'Save',
  manuscriptRevisionsSaveLong: 'Save Revision',
  manuscriptRevisionsNameRequiredError: 'Revision name is required',
  manuscriptRevisionsCreateError: 'Error creating revision',
  manuscriptRevisionsCreatedSuccess: 'Revision created',

// --- Templates (manuscript) ---
  templatePanelTitle: 'Manuscript templates',
  templateSearchPlaceholder: 'Search for templates...',
  templateTabAll: 'All',
  templateTabMine: 'My templates',
  templateTabRecent: 'Recently used',
  templateTabStructures: 'Structures',
  templateEmpty: 'No templates found',
  templatePagesLabel: 'pages',
  templateBeatPagePrefix: 'p.',
  templateDeleteConfirm: 'Are you sure you want to delete this template?',
  templatePreviewTooltip: 'Preview',
  templateApplyTooltip: 'Apply template',
  templatePreviewClose: 'Close',
  templatePreviewApply: 'Apply template',

// --- Production view — header / toolbar ---
  productionManuscriptLabel: 'MANUSCRIPT',
  productionManuscriptShort: 'SCRIPT',  // TODO-review
  productionLineLabel: 'Line',
  productionOfLabel: 'of',
  productionZoomIn: 'Zoom in',
  productionZoomOut: 'Zoom out',
  productionReadThroughStop: 'End Read Through',
  productionTalentShow: 'Show Cast',
  productionTalentHide: 'Hide Cast',
  productionShootingDayPlannerTooltip: 'Shooting Plan - Day Planner',
  productionLiveSetConnectTooltip: 'Connect to Live Set (sync timeline)',
  productionLiveSetDisconnectTooltip: 'Disconnect from Live Set',
  productionSearchPlaceholder: 'Search scenes...',
  productionFiltersLabel: 'SMART FILTERS',
  productionScenesLabel: 'Scenes',
  productionScenesLabelLower: 'scenes',
  productionScenesShortLabel: 'SCENES',
  productionCameraLabel: 'Camera',
  productionCameraLabelUpper: 'CAMERA',
  productionLightLabelUpper: 'LIGHT',
  productionSoundLabelUpper: 'SOUND',
  productionLightLabel: 'Light',
  productionSoundLabel: 'Sound',
  productionProgressLabel: 'PRODUCTION PROGRESS',
  productionCompleteLabel: 'complete',
  productionTotalLabel: 'total',
  productionActLabel: 'Act',
  productionVisibleLabel: 'visible',

// --- Production view — scene create/delete ---
  productionAddSceneTooltip: 'Add scene',
  productionNewSceneLabel: 'New scene',
  productionNewSceneDialogTitle: 'Create new scene',
  productionNewSceneDialogBody: 'A new scene will be created with default values. You can edit the scene afterward.',
  productionNewSceneDialogAction: 'Create scene',
  productionNewSceneHeadingDefault: 'NEW SCENE',
  productionNewSceneLocationDefault: 'Location',
  productionDeleteSceneTitle: 'Delete scene?',
  productionDeleteSceneBody: 'Are you sure you want to delete this scene? This action cannot be undone.',
  productionDeleteSceneAction: 'Delete scene',
  productionExportProductionTooltip: 'Export production data',

// --- Production view — quick actions ---
  productionQuickActionsLabel: 'PRODUCTION:',
  productionNeedsTooltip: 'Set scene needs (camera/light/sound)',
  productionNeedsButton: 'Needs',
  productionScheduleTooltip: 'Schedule scene on a shooting day',
  productionScheduleButton: 'Schedule',
  productionChecklistTooltip: 'Pre-production checklist',
  productionChecklistButton: 'Checklist',
  productionBulkShotsTooltip: 'Generate multiple shots from a template',
  productionLineCoverageTooltip: 'Shot-to-dialogue coverage',
  productionLineCoverageButton: 'Line coverage',
  productionSyncStatusTooltip: 'Sync status with Stripboard',
  productionSyncStatusButton: 'Sync',

// --- Production view — scene detail / notes ---
  productionReferenceImageLabel: 'REFERENCE IMAGE',
  productionReferenceFromCasting: 'FROM CASTING',
  productionDialogueLabel: 'DIALOGUE',
  productionDialogueLinesLabel: 'lines',
  productionDialogueLinesTitle: 'DIALOGUE LINES',
  productionNoDialogueLabel: 'No dialogue in this scene',
  productionAddNoteTooltip: 'Add note',
  productionReadThroughPlaceholder: 'Write notes from the read-through...',
  productionCameraNoteLabel: 'CAMERA NOTE',
  productionCameraNoteEditPlaceholder: 'Write camera note...',
  productionCameraNotePlaceholder: 'Click to add a camera note...',
  productionDirectorNoteLabel: 'DIRECTOR',
  productionDirectorNoteEditPlaceholder: 'Write director note...',
  productionDirectorNotePlaceholder: 'Click to add a director note...',
  productionStatusNotStarted: 'Not started',
  productionStatusInProgress: 'In progress',
  productionStatusComplete: 'Complete',
  productionAddShotTooltip: 'Add shot',
  productionNoShotsLabel: 'No shots in this scene',
  productionAddFirstShotLabel: 'Add the first shot',
  productionSelectSceneTitle: 'Select a scene from the list',
  productionSelectSceneBody: 'Click a scene in the left panel to see the manuscript',

// --- Production view — timeline / views ---
  productionTimelineZoomIn: 'Zoom in',
  productionTimelineZoomOut: 'Zoom out',
  productionOvertimeLabel: 'Overtime',
  productionGridViewActive: 'Grid view active',
  productionListViewActive: 'List view active',
  productionActiveSceneLabel: 'ACTIVE SCENE',
  productionNewShotDescriptionDefault: 'New shot',

// --- Production view — shot inspector ---
  productionCameraSectionLabel: 'CAMERA',
  productionLensLabel: 'Lens',
  productionMovementLabel: 'Movement',
  productionLightingSectionLabel: 'LIGHT',
  productionSoundSectionLabel: 'SOUND',
  productionCameraEquipmentLabel: 'CAMERA EQUIPMENT',
  productionSyncedTooltip: 'Connected to equipment inventory',
  productionSyncedLabel: 'SYNCED',
  productionInventoryLabel: 'FROM INVENTORY',
  productionLensLabelUpper: 'LENS',
  productionShotListLabel: 'FROM SHOT LISTS',
  productionCopySettingsTooltip: 'Copy settings to the next shot',
  productionSavePresetTooltip: 'Save as preset',

// --- Production view — references ---
  productionReferencesLabel: 'REFERENCES',
  productionReferencesUploadedSuffix: 'uploaded',
  productionReferencesUploadedLabel: 'UPLOADED',
  productionReferenceUploadedSource: 'Uploaded',
  productionReferenceTitlePrefix: 'Reference',
  productionCenterPanelLabel: 'Center',
  productionUploadLabel: 'Upload',
  productionSearchReferencesLabel: 'Search references',
  productionReferenceSearchTitle: 'Search Film References',
  productionReferenceSearchBack: '← Back to search',
  productionReferenceSearchPlaceholder: 'Search film: Blade Runner, Inception, cinematographer: Roger Deakins...',
  productionSearchLabel: 'Search',
  productionSourceAllLabel: 'All sources',
  productionReferenceSearchLoading: 'Searching the film database...',

// --- Production view — camera/light/sound default values ---
  productionDefaultRig: 'Tripod',
  productionDefaultKeyLight: 'Soft side light',
  productionDefaultSideLight: 'Warm tone',
  productionDefaultAtmos: 'Muted room tone',
  productionRigOptionTripod: 'Tripod',
  productionKeyLightOptionSoftSide: 'Soft side light',
  productionSideLightOptionWarmTone: 'Warm tone',
  productionAtmosOptionRoomTone: 'Muted room tone',
  productionAtmosOptionQuiet: 'Atmos: Quiet',
  productionAtmosOptionNatural: 'Atmos: Natural',
  productionAtmosOptionCityTraffic: 'Atmos: City traffic',
  productionAtmosOptionNature: 'Atmos: Nature',
  productionAtmosOptionInterior: 'Atmos: Interior',
  productionMovementSlowPushIn: 'Slow push-in',
  productionLightingKeySoftSide: 'Soft side light',

// --- Production view — reference search / attribution ---
  productionDirectorNoteBadge: 'D',  // TODO-review
  productionReferenceSelectFramePrefix: 'Select a frame from',
  productionReferenceSelectFrameSuffix: 'to add as a reference',
  productionReferenceChooseAction: 'Choose action',
  productionAddToCenterPanelLabel: '+ Center panel',
  productionOpenShotCafeLabel: 'See all frames on shot.cafe',
  productionShotCafeFilmsLabel: 'Films from shot.cafe',
  productionResultsLabel: 'results',
  productionMoodImagesLabel: 'Mood images',
  productionReferenceEmptyTitle: 'Search for film references',
  productionReferenceEmptyBody: 'Search for films like "Blade Runner", "Sicario" or cinematographers like "Roger Deakins"',
  productionReferenceAttribution: 'Film references from shot.cafe • Mood images from Unsplash • For reference and education only',

// --- Production view — stripboard / day planner / live set ---
  productionShootingDayPlannerTitlePrefix: 'Shooting Plan -',
  productionLiveSetDayTitle: 'Select Shooting Day for Live Set',
  productionLiveSetDayBody: 'Select which shooting day you want to follow in Live Set Mode:',
  productionDayLabel: 'Day',
  productionDayStatusWrapped: 'Wrapped',  // TODO-review
  productionDayStatusInProgress: 'In progress',
  productionDayStatusPlanned: 'Planned',

// --- Production view — export dialog ---
  productionExportDialogTitle: 'Export production data',
  productionExportDialogBody: 'Export all scenes, equipment, shot lists and metadata as a JSON file.',
  productionExportDialogContentsLabel: 'Contents:',
  productionExportDialogEquipmentLabel: 'Equipment and metadata',
  productionExportDialogAction: 'Export JSON',

// --- Production view — cast & talent panel ---
  productionCharactersLabel: 'characters',
  productionInSceneLabel: 'IN SCENE',
  productionNoConfirmedCastTitle: 'No confirmed cast yet',
  productionNoConfirmedCastBodyPrefix: 'Go to Auditions in',
  productionNoConfirmedCastBodySuffix: 'to confirm candidates',

// --- Production view — preset / note dialogs ---
  productionSavePresetDialogTitle: 'Save as preset',
  productionSavePresetDialogBody: 'Give the preset a name to save the current camera and lighting settings.',
  productionSavePresetNamePlaceholder: "e.g. 'Intimate dialogue', 'Action scene'",
  productionSavePresetSettingsLabel: 'Settings to be saved:',
  productionSavePresetAction: 'Save preset',
  productionAddNoteTitle: 'Add production note',
  productionAddNoteBodyPrefix: 'Choose note type for scene',
  productionDirectorLabel: 'Director',
  productionAddNotePlaceholder: 'Write note...',
  productionAddLabel: 'Add',

// --- Production view — add shot dialog ---
  productionAddShotDialogTitle: 'Add storyboard shot',
  productionBackLabel: '← Back',
  productionAddShotModeLabel: 'Choose how you want to add a shot to the scene',
  productionAddShotUploadTitle: 'Upload your own image',
  productionAddShotUploadBody: 'Upload a storyboard or reference image from your machine',
  productionAddShotReferenceTitle: 'Search reference shots',
  productionAddShotReferenceBody: 'Find inspiration from Shot.cafe, films and image databases',
  productionAddShotUploadPrompt: 'Upload an image for your storyboard shot',
  productionAddShotChooseAnother: 'Choose another image',
  productionAddShotPickImage: 'Click to select an image',
  productionAddShotFormats: 'Supports JPG, PNG, WebP',
  productionAddShotReferencePrompt: 'Search for reference images from Shot.cafe and other sources',
  productionAddShotSearchPlaceholder: 'Search: Blade Runner, cinematographer: Roger Deakins, noir lighting...',
  productionAddShotWithImage: 'Add with image',
  productionAddShotWithoutImage: 'Add without image',

// --- Production view — scene needs / schedule / checklist ---
  productionSceneNeedsTitle: 'Scene Needs - Scene',
  productionSceneNeedsBody: 'Mark which departments are missing planning for this scene:',
  productionSceneNeedsCameraDetail: 'Lens, movement, rig not planned',
  productionSceneNeedsLightDetail: 'Lighting plan not finalized',
  productionSceneNeedsSoundDetail: 'Sound plan/microphone not set',
  productionScheduleDialogTitle: 'Schedule Scene to Stripboard',
  productionScheduleDialogBody: 'Select a shooting day for this scene:',
  productionScheduleRemoveLabel: 'Remove from plan (not scheduled)',
  productionChecklistProgressLabel: 'of 6 tasks completed',
  productionChecklistLocation: 'Location confirmed',
  productionChecklistCast: 'Cast confirmed available',
  productionChecklistProps: 'Props ready',
  productionChecklistEquipment: 'Equipment assigned',
  productionChecklistPermits: 'Permits obtained',
  productionChecklistScript: 'Script locked',

// --- Production view — bulk shots / line coverage ---
  productionBulkShotTitle: 'Generate Shot List - Scene',
  productionBulkShotBody: 'Choose a template to automatically generate shots based on the scene type:',
  productionBulkShotsCreatedLabel: 'SHOTS THAT WILL BE CREATED:',
  productionBulkShotsAction: 'Generate',
  productionLineCoverageBody: 'Mark which dialogue lines are covered by each shot for continuity tracking:',
  productionLinesCoveredLabel: 'lines covered',
  productionCoveredByLabel: 'Covered by',
  productionUncoveredDialogueLabel: 'dialogue line(s) are not covered by any shots!',

// --- Production view — misc buttons ---
  productionSaveLabel: 'Save',
  productionExitFullscreen: 'Exit fullscreen',
  productionEnterFullscreen: 'Fullscreen',
  productionCancelLabel: 'Cancel',

// --- Story Arc / Story Writer landing ---
  storyArcTagline: 'Role Room pre-production, script flow and shot list',
  storyLogicChip: 'Structure your story',
  storyWriterChip: 'Write manuscript',

// --- Dance — profession / terms ---
  danceProfessionFreelanceName: 'Freelance dancer',
  danceTermPiece: 'Piece',
  danceTermPiecePlural: 'Pieces',
  danceTermSection: 'Section',
  danceTermSectionPlural: 'Sections',
  danceTermRun: 'Run',
  danceTermRunPlural: 'Runs',
  danceTermRehearsal: 'Rehearsal',
  danceTermRehearsalPlural: 'Rehearsals',
  danceTermPerformance: 'Performance',
  danceTermPerformancePlural: 'Performances',
  danceTermDancer: 'Dancer',
  danceTermDancerPlural: 'Dancers',
  danceTermChoreographer: 'Choreographer',
  danceTermChoreographerPlural: 'Choreographers',
  danceTermInstructor: 'Instructor',
  danceTermInstructorPlural: 'Instructors',
  danceTermStudent: 'Student',
  danceTermStudentPlural: 'Students',
  danceTermClass: 'Class',
  danceTermClassPlural: 'Classes',
  danceTermStudioRoom: 'Studio',  // TODO-review
  danceTermStudioRoomPlural: 'Studios',  // TODO-review
  danceTermSeason: 'Season',
  danceTermSeasonPlural: 'Seasons',
  danceTermGig: 'Gig',
  danceTermCount: 'Count',
  danceTermFormation: 'Formation',

// --- Dance — genres ---
  danceGenreContemporary: 'Contemporary',
  danceGenreBallet: 'Ballet',
  danceGenreFolk: 'Folk dance',
  danceGenreOther: 'Other',

// --- Dance — tabs ---
  danceTabDashboard: 'Overview',
  danceTabPieces: 'Pieces',
  danceTabFormations: 'Formations',
  danceTabSeason: 'Season',
  danceTabRehearsalLog: 'Rehearsal log',
  danceTabPricing: 'Pricing',
  danceTabAdminPlans: 'Admin · Plans',
  danceTabAdminTesters: 'Admin · Testers',
  danceTabAdminSettings: 'Admin · Settings',
  danceTabPerformances: 'Performances',
  danceTabReel: 'Reel portfolio',
  danceTabAnalysis: 'Analysis',
  danceTabClasses: 'Classes',
  danceTabStudents: 'Students',
  danceTabInstructors: 'Instructors',
  danceTabRooms: 'Studios',  // TODO-review
  danceTabMusic: 'Music archive',
  danceTabMovementVocab: 'Movement vocabulary',
  danceTabInjuries: 'Injury log',
  danceTabGrants: 'Grants',
  danceTabBilling: 'Billing',
  danceTabTeamDescription: 'Invite members, create roles and control what each role can access.',
  danceTabAddons: 'Modules',  // TODO-review
  danceTabAddonsDescription: 'Enable extra modules as needed — video review pro, marketing package, AI assistance.',

// --- Dance — tab descriptions ---
  danceTabPiecesDescription: 'Break down choreography into sections with music cues and dancers per section.',
  danceTabFormationsDescription: 'Draw stage formations and animate A→B transitions. Saved per project.',
  danceTabSeasonDescription: 'Season timeline: auditions, rehearsals, performances, festivals and breaks.',
  danceTabRehearsalLogDescription: 'Log each rehearsal with recordings and notes. AI compares against previous runs.',
  danceTabVideoDescription: 'Upload rehearsal video, comment on second + count, draw on the frame, record voice instructions — all in one thread.',
  danceTabPerformancesDescription: 'Plan, run and document performances and tours.',
  danceTabReelDescription: 'Clips organized by gig/production. AI-tagged for quick search when casting asks for a reel.',
  danceTabClassesDescription: 'Semester courses, drop-in, workshops — registration and attendance.',
  danceTabStudentsDescription: 'Student register with guardian info, payment status and progress.',
  danceTabInstructorsDescription: 'Instructor calendar, substitute cover, hours delivered per month.',
  danceTabMusicDescription: 'Store choreography music with BPM tagging and rights status (TONO).',
  danceTabInjuriesDescription: 'Log injuries and rehab — documentation ready for NAV applications.',
  danceTabGrantsDescription: 'Application templates for Kulturrådet, Fond for lyd og bilde, and municipal funds.',
  danceTabUnionDescription: 'Status in Skuda/NoDa, tariff application and automatic workday logging.',

// --- Dance — read-through / live set ---
  danceReadThroughHeader: 'Music read-through',
  danceReadThroughStartButton: 'Start read-through',
  danceReadThroughStopButton: 'End read-through',
  danceReadThroughPlayLabel: 'Play music',
  danceReadThroughCountLabel: 'Count',
  danceLiveSetHeader: 'Rehearsal mode',
  danceLiveSetRollingChip: 'RECORDING',
  danceLiveSetTakeLabel: 'Run',
  danceLiveSetCutButton: 'Stop',

// --- Dance — AI actions ---
  danceAiCoverageCheckLabel: 'Check choreography coverage',
  danceAiReplanLabel: 'Re-plan rehearsal',
  danceAiContinuityLabel: 'Compare against previous run',
  danceAiEndOfDayLabel: 'Rehearsal brief',

// --- Dance — movement archive ---
  danceArchiveHeader: 'Movement archive',
  danceArchiveTabSearch: 'Search the archive',
  danceArchiveTabSuggested: 'Suggested from piece',
  danceArchiveUploadCta: 'Upload choreography clip',
  danceArchiveSourceUrlHint: 'Paste video link (Vimeo/YouTube)',

// --- Dance — rights / union / grants / billing ---
  danceRightsChoreographyOwnedLabel: 'Choreography rights (NoDa)',
  danceRightsMusicClearedLabel: 'Music rights (TONO clearance)',
  danceRightsMusicNotClearedWarning: 'Music not TONO-cleared — check before the performance',
  danceUnionMembershipStatus: 'Membership status in NoDa/Skuda',
  danceUnionTariffAppliedLabel: 'Tariff applied',
  danceUnionWorkdayLogLabel: 'Workdays (for NAV/Skuda)',
  danceGrantKulturradetLabel: 'Kulturrådet — Independent performing arts (dance)',
  danceGrantMunicipalLabel: 'Municipal grant',
  danceGrantApplicationDeadlineLabel: 'Application deadline',
  danceBillingEhfLabel: 'EHF invoice',
  danceBillingKidLabel: 'KID number',
  danceBillingFikenIntegrationLabel: 'Fiken integration',
  danceBillingTripletexIntegrationLabel: 'Tripletex integration',

// --- Dance — onboarding / empty states ---
  danceOnboardingWelcomeStudio: "Welcome — let's set up your studio.",
  danceOnboardingWelcomeFreelance: "Welcome — let's set up your artist profile.",
  danceEmptyPiecesTitle: 'No pieces yet',
  danceEmptyPiecesBody: 'Create your first piece to get started',
  danceEmptyRehearsalsTitle: 'No rehearsals logged',
  danceEmptyClassesTitle: 'No classes in the season yet',
  danceEmptyGigsTitle: 'No gigs registered yet',
  danceEmptyReelTitle: 'The reel portfolio is empty — upload your first clip',

// --- Choreography builder ---
  choreographyBuilderSubtitle: 'Build the choreography as musical segments',
  choreographyBuilderAddSegment: 'Add segment',
  choreographyBuilderSaveLabel: 'Save choreography',
  choreographyBuilderPlayLabel: 'Play with music',
  choreographyBuilderTotalDuration: 'Total duration',
  choreographyBuilderKeyLabel: 'Key',
  choreographyBuilderEmpty: 'No segments yet — add your first segment to get started',
  choreographySegmentVerse: 'Verse',
  choreographySegmentChorus: 'Chorus',
  choreographySegmentLift: 'Lift / partner work',
  choreographySegmentFormationChange: 'Formation change',
  choreographyLayerMusic: 'Music',
  choreographyLayerChoreography: 'Choreography',
  choreographyLayerFormation: 'Formation',
  choreographyLayerCamera: 'Camera / video',
  choreographyLayerLighting: 'Lighting',
  choreographyLayerCostumes: 'Costume / props',
  choreographyLayerNotes: 'Notes',
  choreographyInspectorTitle: 'Segment details',
  choreographyInspectorTimingLabel: 'Timing',
  choreographyInspectorDurationLabel: 'Duration',
  choreographyInspectorDancersLabel: 'Dancers involved',
  choreographyInspectorFormationLabel: 'Formation',
  choreographyInspectorMovementLabel: 'Movement notes',
  choreographyInspectorEnergyLabel: 'Energy / intensity',
  choreographyInspectorVideoRefLabel: 'Video reference',
  choreographyInspectorApprovalLabel: 'Approval status',
  choreographyEnergyLow: 'Low',
  choreographyEnergyControlled: 'Controlled',
  choreographyEnergyHigh: 'High',
  choreographyEnergySharp: 'Sharp',
  choreographyEnergyExplosive: 'Explosive',
  choreographyApprovalDraft: 'Draft',
  choreographyApprovalReview: 'In review',
  choreographyApprovalApproved: 'Approved',
  choreographyApprovalLocked: 'Locked (ready for performance)',

// --- Dance — booking / dancer profiles ---
  danceBookingCalendarLabel: 'Dancer calendar',
  danceBookingAvailabilityLabel: 'Availability',
  danceBookingFromCrewNote: 'Built on the same infrastructure as the Crew module — dance-specific view.',
  dancerProfileHeader: 'Dancer profiles',
  dancerProfileEditTitle: 'Edit profile',
  dancerProfileNewTitle: 'New dancer profile',
  dancerProfileSkillsLabel: 'Skills',
  dancerProfileBodyLabel: 'Body',
  dancerProfileAvailabilityLabel: 'Availability',
  dancerProfileInjuryLabel: 'Injury status',
  dancerProfileNotesLabel: 'Notes',
  dancerProfileEmptyState: 'No dancer profiles yet — add the first one',

...
const SpotListItem = memo(({ spot, variant = 'default', spaceLabel, index }: SpotListItemProps) => {
  ...
  const hoverBgColor = variant === 'ev' ? 'rgba(34,211,238,0.24)' : 'rgba(118, 102, 230,0.24)';
  const hoverBorderColor = variant === 'ev' ? 'rgba(34,211,238,0.55)' : 'rgba(118, 102, 230,0.52)';
          ...
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            ...
            <IconButton 
              ...
              sx={{ 
                ...
                minWidth: 44,
                minHeight: 44,
                '&:hover': { bgcolor: 'rgba(118, 102, 230,0.24)' },
              }}
          ...
          <Stack spacing={{ xs: 2.5, sm: 3, md: 2.75, lg: 3, xl: 3.5 }}>
                  ...
                  >
                            ...
                            <CardContent sx={{ p: 1.2 }}>
                              ...
                              <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 0.6, mt: 1 }}>
                                ...
                                <Chip
                                  ...
                                  sx={{ bgcolor: 'rgba(118, 102, 230,0.18)', color: '#c4bef4' }}
                                />
                                <Chip
                                  size="small"
                              ...
                              <Box sx={{ display: 'flex', gap: 0.7, flexWrap: 'wrap', mt: 1 }}>
                                ...
                                {contact.website ? (
                                  <Button
                                    ...
                                    sx={{ textTransform: 'none', color: '#c4bef4' }}
                                  >
                                    Åpne kanal
                                  </Button>
                                ) : null}
                    ...
                    <Stack spacing={1}>
                      ...
                      <Card sx={{ bgcolor: 'rgba(255,255,255,0.03)', border: '1px solid rgba(255,255,255,0.14)', borderRadius: 2 }}>
                        <CardContent sx={{ p: 1.2 }}>
                          <Typography sx={{ color: '#fff', fontWeight: 700, fontSize: '0.95rem', display: 'flex', alignItems: 'center', gap: 0.7 }}>
                            <AccessTimeIcon sx={{ color: '#c4bef4' }} />
                            Fristlinje
                          </Typography>
                          <Stack spacing={0.7} sx={{ mt: 1 }}>
            ...
            <Card sx={{ 
              ...
              <CardContent sx={{ p: { xs: 2.5, sm: 3, md: 2.75, lg: 3, xl: 3.5 } }}>
                ...
                <Divider sx={{ mb: { xs: 3, sm: 3.5, md: 3.25, lg: 3.5, xl: 4 }, borderColor: 'rgba(118, 102, 230,0.24)' }} />
                <Box
                  sx={{
                    display: 'grid',
                    gridTemplateColumns: { xs: '1fr', sm: 'repeat(2, minmax(0, 1fr))' },

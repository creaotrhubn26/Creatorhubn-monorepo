...
const panelInfo = [
  { name: 'Oversikt', icon: DashboardIcon, color: 'var(--role-violet, #756be7)' },
  ...
  { name: 'Produksjonsplan', icon: CalendarIcon, color: '#4227b0' },
  { name: 'Team', icon: TeamIcon, color: '#00d4ff' },
  { name: 'Utstyr', icon: PropIcon, color: '#523ee0' },
  ...
  { name: 'Klientsamarbeid', icon: ReviewsIcon, color: '#9e93ed' },
...
const stepIndicatorMeta: Record<string, { label: string; subtitle: string; icon: IconComponentType; color?: string }> = {
  ...
  'overview': { label: 'Oversikt', subtitle: 'Status', icon: DashboardIcon, color: 'var(--role-violet, #756be7)' },
  ...
  'production-plan': { label: 'Kalender', subtitle: 'Produksjonsplan', icon: CalendarIcon, color: '#4227b0' },
  'team': { label: 'Team', subtitle: 'Ressurser', icon: TeamIcon, color: '#00d4ff' },
  'equipment': { label: 'Utstyr', subtitle: 'Ressurser', icon: PropIcon, color: '#523ee0' },
  ...
  'producer-equipment': { label: 'Utstyr/rekvisitter', subtitle: 'Produksjon', icon: PropIcon, color: '#523ee0' },
  ...
  'producer-reviews': { label: 'Klientsamarbeid', subtitle: 'Godkjenning', icon: ReviewsIcon, color: '#9e93ed' },

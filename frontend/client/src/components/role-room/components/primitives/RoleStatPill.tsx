 ...
 *   <RoleStatPillRow
 *     pills={[
 *       { icon: <InventoryIcon />, count: 324, label: 'Totalt utstyr', color: '#9d97ee' },
 ...
 *   <RoleStatPill icon={...} count={324} label="Totalt utstyr" color="#9d97ee" />
 */
...
export interface RoleStatPillProps {
  ...
  label: string;
  /** Hex-farge for ikon-bg + tall — eks "#9d97ee" (lilla), "#10b981" (grønn) */
  color: string;

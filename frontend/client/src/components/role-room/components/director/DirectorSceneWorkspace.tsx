            ...
            return (
              <Button
                ...
                sx={{
                  ...
                  bgcolor: selected ? 'rgba(118, 102, 230,0.16)' : 'transparent',
                  border: selected ? '1px solid rgba(158, 147, 237,0.34)' : '1px solid transparent',
                  '&:hover': { bgcolor: selected ? 'rgba(118, 102, 230,0.22)' : 'rgba(255,255,255,0.045)' },
                  ...focusVisibleStyles,
                }}
              >
                <Typography component="span" sx={{ display: 'block', color: selected ? '#c4bef4' : roleTokens.textMuted, fontSize: '0.68rem', fontWeight: 780 }}>
                  {itemContext.label}
                </Typography>
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} justifyContent="space-between" alignItems={{ xs: 'flex-start', sm: 'center' }} gap={1.5}>
              <Box sx={{ minWidth: 0 }}>
                <Stack direction="row" spacing={0.75} alignItems="center" sx={{ mb: 0.6, flexWrap: 'wrap' }}>
                  <Chip size="small" label={context.label.toUpperCase()} sx={{ color: '#c4bef4', bgcolor: 'rgba(118, 102, 230,0.14)' }} />

  ...
  },
  {
    ...
    instructions: {
      ...
      prerequisites: [
        ...
        'E-posten ELLER LinkedIn-profil-URL-en til produsenten (linkedin.com/in/…).',
        '👉 VIKTIG: dere må være LinkedIn-koblet (eller minst at du følger produsenten) FØR LinkedIn finner profilen i søket. Send en koblings-forespørsel til produsenten først — ellers får du «User not found».',
        'Cirka 3–5 minutter.',
      ],
      steps: [
        '⚠️ FØR DU STARTER: åpne LinkedIn og send en koblings-forespørsel til produsenten (eller følg profilen). LinkedIn skjuler ofte profiler i sin egen søkefunksjon hvis dere ikke er koblet — uten dette får du «User not found» når du prøver å legge til.',
        ...
        'Skriv inn enten produsentens e-post ELLER deres LinkedIn-profilnavn. Tips: e-post er mest pålitelig — profil-søk krever ofte at dere er koblet på LinkedIn først (se prerequisite over).',
        'Hvis LinkedIn fortsatt ikke finner profilen: be produsenten sende deg sin LinkedIn-URL (linkedin.com/in/produsent-navn) og lim inn ID-en (siste del av URL-en) i søkefeltet.',
      ...
      successCheck: 'Vent 5–10 minutter, gå tilbake til denne siden, og last den på nytt. LinkedIn-kontoen din skal dukke opp her som «Tilkoblet». Hvis ikke: dobbeltsjekk at dere er LinkedIn-koblet og at riktig profil ble valgt (LinkedIn vil noen ganger feilmatche på navn).',

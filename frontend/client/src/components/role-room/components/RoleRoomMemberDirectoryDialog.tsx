  ...
  return (
    <Box
      ...
      sx={{
        ...
        '&:hover': { borderColor: 'rgba(93, 118, 203,0.4)', bgcolor: 'rgba(93, 118, 203,0.04)' },
      }}
    >
      <Avatar
        ...
        sx={{ width: 48, height: 48, bgcolor: '#5d76cb', flexShrink: 0 }}
      >
    ...
    <DialogContent sx={{ p: 0, overflow: 'auto', flex: 1 }}>
      ...
      <Box sx={{
        ...
        background: profile.bannerImageUrl
          ...
          : 'linear-gradient(135deg, #2a3d56 0%, #2b2553 50%, #302a83 100%)',
      }} />
            ...
            <Stack spacing={0.75} sx={{ mt: 0.5 }}>
              {sharedProjects.map((proj) => (
                <Stack key={proj.id} direction="row" spacing={1} alignItems="center"
                       sx={{ p: 1, borderRadius: 1.5, bgcolor: 'rgba(93, 118, 203,0.06)' }}>
                  <WorkOutline sx={{ fontSize: 18, color: 'rgba(93, 118, 203,0.8)', flexShrink: 0 }} />
                  <Box sx={{ minWidth: 0, flex: 1 }}>
                    <Typography variant="body2" sx={{ fontWeight: 600 }} noWrap>
                      {proj.name}
                    </Typography>

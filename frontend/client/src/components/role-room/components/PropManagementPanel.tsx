...
const CATEGORY_DEFINITIONS: CategoryDefinition[] = [
  ...
  { key: 'admin', label: 'Administrasjon', color: '#6157c2', itemType: 'equipment' },
  ...
  { key: 'decoration', label: 'Dekorasjon', color: '#4227b0', itemType: 'prop' },
  { key: 'costume', label: 'Kostyme', color: '#e91e63', itemType: 'prop' },
  { key: 'prop', label: 'Rekvisitt', color: '#5e47bc', itemType: 'prop' },
  { key: 'food', label: 'Mat', color: '#4caf50', itemType: 'prop' },
  { key: 'other', label: 'Annet', color: '#523ee0', itemType: 'prop' },
];
...
export function PropManagementPanel({ projectId, onUpdate }: PropManagementPanelProps) {
    ...
    PaperProps: {
      sx: {
        ...
        '& .MuiMenuItem-root': {
          ...
          '&.Mui-selected': {
            bgcolor: 'rgba(82, 62, 224, 0.25)',
            '&:hover': {
              bgcolor: 'rgba(82, 62, 224, 0.35)',
            },
          },
        },
      },
  ...
  const getCategoryColor = (category?: string): string => {
    const normalized = normalizeCategoryKey(category);
    if (!normalized) return '#523ee0';
    return CATEGORY_BY_KEY.get(normalized)?.color || '#523ee0';
  };
  ...
  const generatePropsHTML = (project: any, props: any[]): string => {
    ...
    const propIconSVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#523ee0" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-bottom: 5px solid #523ee0; padding: 30px 35px; margin: -50px -60px 40px -60px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); }
    .title { font-size: 36px; font-weight: 800; color: #523ee0; margin-bottom: 10px; letter-spacing: -1px; line-height: 1.2; display: flex; align-items: center; gap: 12px; }
    .title svg { flex-shrink: 0; }
    .subtitle { color: #64748b; font-size: 15px; font-weight: 500; margin-top: 5px; }
    .summary { background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-left: 6px solid #523ee0; padding: 30px; margin-bottom: 45px; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); }
    .summary-title { font-size: 20px; font-weight: 700; color: #523ee0; margin-bottom: 25px; letter-spacing: -0.3px; display: flex; align-items: center; gap: 12px; }
    ...
    .summary-number { font-size: 36px; font-weight: 800; color: #523ee0; display: block; margin-bottom: 8px; line-height: 1; }
    ...
    th { background: linear-gradient(135deg, #523ee0 0%, #3928d9 100%); color: white; font-weight: 700; padding: 18px 20px; text-align: left; font-size: 12px; text-transform: uppercase; letter-spacing: 0.8px; border: none; }
  ...
  return (
    <Box
      ...
      sx={{
        ...
        border: '1px solid rgba(82, 62, 224,0.24)',
        background:
          'radial-gradient(1200px 380px at 10% -10%, rgba(82, 62, 224,0.16), transparent 55%), linear-gradient(180deg, rgba(17, 15, 44,0.74) 0%, rgba(12,10,26,0.64) 100%)',
    ...
    >
        ...
        >
          <Box
            sx={{
              ...
              borderRadius: { xs: 2, sm: 3 },
              background: 'linear-gradient(135deg, rgba(82, 62, 224, 0.25) 0%, rgba(82, 62, 224, 0.15) 100%)',
              border: '2px solid rgba(82, 62, 224, 0.4)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              boxShadow: '0 4px 12px rgba(82, 62, 224, 0.2)',
              transition: 'all 0.2s ease',
              '&:hover': {
                transform: 'scale(1.05)',
                boxShadow: '0 6px 16px rgba(82, 62, 224, 0.3)',
              },
            }}
          >
            <Inventory2Icon
          ...
          <Box>
            <Typography
              ...
              sx={{
                ...
                background: 'linear-gradient(135deg, #fff 0%, #9e93ed 100%)',
          ...
          <Tooltip title="Vis/skjul statistikk">
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                color: showStats ? '#523ee0' : 'rgba(255,255,255,0.7)',
                borderColor: showStats ? '#523ee0' : 'rgba(255,255,255,0.2)',
                px: { xs: 1, sm: 2 },
                ...focusVisibleStyles,
              }}
            >
          ...
          <Tooltip title="Lagerstyring, reservasjoner og konsistens">
            <Button
              ...
              sx={{
                ...
                borderColor: warehouseIssueCount > 0 ? '#ef5350' : 'rgba(158, 147, 237,0.5)',
                px: { xs: 1, sm: 2 },
                ...focusVisibleStyles,
                '&:hover': {
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
          ...
          <Button
            ...
            sx={{
              minHeight: 34,
              bgcolor: itemTypeFilter === 'all' ? 'rgba(82, 62, 224,0.2)' : 'transparent',
              borderColor: 'rgba(82, 62, 224,0.45)',
              color: '#9e93ed',
              fontWeight: 700,
              textTransform: 'none',
            }}
          ...
          <Button
            ...
            sx={{
              minHeight: 34,
              bgcolor: itemTypeFilter === 'prop' ? 'rgba(66, 39, 176,0.2)' : 'transparent',
              borderColor: 'rgba(158, 147, 237,0.5)',
              color: '#9e93ed',
              fontWeight: 700,
              textTransform: 'none',
            }}
        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Button
            ...
            sx={{
              minHeight: 34,
              bgcolor: panelMode === 'standard' ? 'rgba(82, 62, 224,0.2)' : 'transparent',
              borderColor: 'rgba(82, 62, 224,0.45)',
              color: '#9e93ed',
              fontWeight: 700,
              textTransform: 'none',
        ...
        >
          <Box sx={{ textAlign: 'center' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5, mb: 0.5 }}>
              <PropsIcon sx={{ fontSize: { xs: 16, sm: 18, md: 17, lg: 19, xl: 22 }, color: '#523ee0' }} />
            </Box>
          ...
          <Tooltip title="Vis/skjul filtre">
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                bgcolor: showFilters ? 'rgba(82, 62, 224,0.2)' : 'transparent',
                color: showFilters ? '#523ee0' : 'rgba(255,255,255,0.7)',
                borderColor: showFilters ? '#523ee0' : 'rgba(255,255,255,0.2)',
                ...focusVisibleStyles,
              }}
            >
              <FilterIcon />
          ...
          <Tooltip title="Kortvisning">
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                bgcolor: viewMode === 'grid' ? 'rgba(82, 62, 224,0.2)' : 'transparent',
                color: viewMode === 'grid' ? '#523ee0' : 'rgba(255,255,255,0.7)',
                borderColor: viewMode === 'grid' ? '#523ee0' : 'rgba(255,255,255,0.2)',
                ...focusVisibleStyles,
              }}
            >
              <GridViewIcon />
          ...
          <Tooltip title="Tabellvisning">
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                bgcolor: viewMode === 'table' ? 'rgba(82, 62, 224,0.2)' : 'transparent',
                color: viewMode === 'table' ? '#523ee0' : 'rgba(255,255,255,0.7)',
                borderColor: viewMode === 'table' ? '#523ee0' : 'rgba(255,255,255,0.2)',
                ...focusVisibleStyles,
              }}
            >
              <TableViewIcon />
        ...
        >
          ...
          {(filterCategory !== 'all' || searchQuery || itemTypeFilter !== 'all') && (
            <Button
              ...
              sx={{ color: '#523ee0', minHeight: TOUCH_TARGET_SIZE, ...focusVisibleStyles }}
            >
              Nullstill
            </Button>
          )}
      ...
      {props.length === 0 ? (
              ...
              <TableRow sx={{ bgcolor: 'rgba(255,255,255,0.05)' }}>
                <TableCell padding="checkbox">
                  <Checkbox
                    ...
                    sx={{ color: 'rgba(255,255,255,0.87)', '&.Mui-checked': { color: '#523ee0' } }}
                  />
                </TableCell>
                <TableCell>
                  <TableSortLabel
                    ...
                    sx={{ color: '#fff', '&:hover': { color: '#523ee0' } }}
                  >
                    Navn
                  </TableSortLabel>
                </TableCell>
            ...
            <TableBody>
              {filteredAndSortedProps.map((prop) => {
                ...
                <TableRow
                  key={prop.id}
                  sx={{
                    bgcolor: selectedIds.has(prop.id) ? 'rgba(82, 62, 224,0.1)' : 'transparent',
                ...
                >
                  ...
                  <TableCell>
                    <Chip
                      ...
                      size="small"
                      sx={{
                        bgcolor: effectiveType === 'equipment' ? 'rgba(100,181,246,0.2)' : 'rgba(158, 147, 237,0.2)',
                        color: effectiveType === 'equipment' ? '#64b5f6' : '#9e93ed',
                        border: `1px solid ${effectiveType === 'equipment' ? 'rgba(100,181,246,0.5)' : 'rgba(158, 147, 237,0.5)'}`,
                      }}
                    />
                  </TableCell>
                  <TableCell>
        ...
        >
          {filteredAndSortedProps.map((prop) => {
            ...
            const itemTypeColor = itemType === 'equipment' ? '#64b5f6' : '#9e93ed';
            const warehouseTotalsForItem = warehouseStockByItem[prop.id];
            return (
            <Box key={prop.id} role="listitem" sx={{ minWidth: 0 }}>
              <Card
                ...
                sx={{
                  ...
                  bgcolor: selectedIds.has(prop.id) ? 'rgba(82, 62, 224,0.08)' : 'rgba(255,255,255,0.03)',
                  border: selectedIds.has(prop.id) ? '2px solid #523ee0' : '2px solid rgba(82, 62, 224,0.2)',
                  borderRadius: 3,
                  overflow: 'hidden',
                  transition: 'all 0.25s cubic-bezier(0.4, 0, 0.2, 1)',
                  ...focusVisibleStyles,
                  '&:hover': {
                    borderColor: 'rgba(82, 62, 224,0.6)',
                    boxShadow: '0 8px 24px rgba(82, 62, 224,0.25)',
              ...
              >
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          borderRadius: 3,
                          bgcolor: 'rgba(82, 62, 224,0.30)',
                          border: '3px solid rgba(82, 62, 224,0.50)',
                          display: 'flex',
                          alignItems: 'center',
                          justifyContent: 'center',
                          boxShadow: '0 8px 24px rgba(82, 62, 224,0.30)',
                        }}
                      >
                        <Inventory2Icon sx={{ fontSize: { xs: 36, sm: 42, md: 48 }, color: '#523ee0' }} />
                      </Box>
                    </Box>
                  )}
                ...
                <CardContent sx={{ p: { xs: 2, sm: 2.5 }, flex: 1, display: 'flex', flexDirection: 'column' }}>
                  ...
                  {prop.quantity && prop.quantity > 1 && (
                    ...
                    >
                      <InventoryIcon sx={{ fontSize: 16, color: '#9d97ee' }} />
                      <Typography sx={{ color: '#9d97ee', fontSize: '0.85rem', fontWeight: 700 }}>
                        {prop.quantity} stk
                      </Typography>
                    </Box>
                  )}
                  ...
                  {(prop.assignedScenes?.length || 0) > 0 && (
                    ...
                    >
                      ...
                      >
                        <CategoryIcon sx={{ fontSize: 16, color: '#9e93ed' }} />
                      </Box>
                      <Typography sx={{ color: '#9e93ed', fontSize: '0.8rem', fontWeight: 600 }}>
                  ...
                  <Collapse in={expandedCards.has(prop.id)}>
                    <Box sx={{ mt: 1, pt: 2, borderTop: '2px solid rgba(82, 62, 224,0.2)' }}>
                      {prop.notes && (
                        <Box
                          sx={{
                            p: 1.5,
                        ...
                        <Box>
                          ...
                          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                            ...
                            {prop.images.length > 5 && (
                              ...
                              >
                                <Typography sx={{ color: '#9e93ed', fontWeight: 700, fontSize: '0.9rem' }}>
                                  +{prop.images.length - 5}
                                </Typography>
                              </Box>
                            )}
                  ...
                  <Box
                    sx={{
                      ...
                      pt: { xs: 2, sm: 2.5 },
                      mt: 'auto',
                      borderTop: '2px solid rgba(82, 62, 224,0.2)',
                    }}
                  >
                    <Button
                      variant="contained"
                      ...
                      sx={{
                        bgcolor: expandedCards.has(prop.id) ? 'rgba(82, 62, 224,0.25)' : 'rgba(82, 62, 224,0.15)',
                        color: expandedCards.has(prop.id) ? '#9e93ed' : '#fff',
                        fontSize: { xs: '0.8rem', sm: '0.875rem' },
                        fontWeight: 600,
                        minHeight: TOUCH_TARGET_SIZE,
                        px: { xs: 2, sm: 2.5 },
                        border: expandedCards.has(prop.id) ? '2px solid rgba(82, 62, 224,0.5)' : '2px solid rgba(82, 62, 224,0.3)',
                        borderRadius: 2,
                        textTransform: 'none',
                        boxShadow: expandedCards.has(prop.id) ? '0 4px 12px rgba(82, 62, 224,0.3)' : '0 2px 8px rgba(82, 62, 224,0.2)',
                        transition: 'all 0.2s ease',
                        '&:hover': {
                          bgcolor: 'rgba(82, 62, 224,0.35)',
                          borderColor: 'rgba(82, 62, 224,0.6)',
      ...
      <Snackbar
        ...
        action={
          <Button color="primary" size="small" onClick={handleUndoDelete} sx={{ color: '#523ee0' }}>
            Angre
          </Button>
        }
        sx={{
          ...
          >
            <TextField
              ...
              sx={{
                ...
                '& .MuiInputLabel-root.Mui-focused': { color: '#523ee0' },
              }}
            />
            ...
            <Box sx={{ gridColumn: '1 / -1' }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mb: 1.5 }}>
                <ImageIcon sx={{ color: '#523ee0', fontSize: { xs: '1.25rem', sm: '1.5rem' } }} />
                <Typography variant="subtitle2" sx={{ color: '#523ee0', fontWeight: 600 }}>
                  Bilder
                </Typography>
              </Box>

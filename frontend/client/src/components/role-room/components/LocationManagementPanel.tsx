...
export function LocationManagementPanel({
  ...
  const generateLocationsHTML = (project: any, locations: any[]): string => {
    ...
    const locationIconSVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5d76cb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    th { background: linear-gradient(135deg, #5d76cb 0%, #3e3180 100%); color: white; font-weight: 700; padding: 18px 20px; text-align: left; font-size: 12px; text-transform: uppercase; letter-spacing: 0.8px; border: none; }
  ...
  return (
    ...
    >
        ...
        >
          <Box
            sx={{
              ...
              boxShadow: '0 4px 14px rgba(93, 118, 203,0.26)',
              transition: 'all 0.2s ease',
              '&:hover': {
                transform: 'scale(1.05)',
                boxShadow: '0 6px 18px rgba(93, 118, 203,0.35)',
              },
          ...
          <Tooltip title="Ny lokasjon (Ctrl+N)">
            <Button
              ...
              sx={{
                ...
                flex: { xs: 1, sm: 'none' },
                ...focusVisibleStyles,
                '&:hover': { bgcolor: '#32127a !important' },
              }}
            >
        ...
        >
          <Box sx={{ textAlign: 'center', p: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5, mb: 0.5 }}>
              <LocationIcon sx={{ fontSize: { xs: 16, sm: 18, md: 17, lg: 19, xl: 22 }, color: '#5d76cb' }} />
            </Box>
            <Typography variant="h4" sx={{ color: '#5d76cb', fontWeight: 700, fontSize: { xs: '1.5rem', sm: '2rem', md: '1.6rem', lg: '1.85rem', xl: '2.5rem' } }}>
              {stats.total}
            </Typography>
          ...
          <Box sx={{ textAlign: 'center', p: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5, mb: 0.5 }}>
              <MapIcon sx={{ fontSize: { xs: 16, sm: 18, md: 17, lg: 19, xl: 22 }, color: '#4b3d8f' }} />
            </Box>
            <Typography variant="h4" sx={{ color: '#4b3d8f', fontWeight: 700, fontSize: { xs: '1.5rem', sm: '2rem', md: '1.6rem', lg: '1.85rem', xl: '2.5rem' } }}>
              ...
              <TableRow sx={{ bgcolor: 'rgba(255,255,255,0.05)' }}>
                <TableCell padding="checkbox" sx={{ py: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
                  <Checkbox
                    ...
                    sx={{ color: 'rgba(255,255,255,0.87)', '&.Mui-checked': { color: '#5d76cb' } }}
                  />
                </TableCell>
                <TableCell sx={{ py: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
                  <TableSortLabel
                    ...
                    sx={{ color: '#fff', fontSize: { xs: '0.875rem', sm: '1rem', md: '0.95rem', lg: '1.05rem', xl: '1.125rem' }, '&:hover': { color: '#5d76cb' } }}
                  >
                    Navn
                  </TableSortLabel>
                </TableCell>
            ...
            <TableBody>
              {filteredAndSortedLocations.map((location) => (
                <TableRow
                  key={location.id}
                  sx={{
                    bgcolor: selectedIds.has(location.id) ? 'rgba(93, 118, 203,0.1)' : 'transparent',
                      ...
                      {location.address && (
                        <Tooltip title={copiedId === location.id ? 'Kopiert!' : 'Kopier adresse'}>
                          <IconButton
                            ...
                            sx={{ color: copiedId === location.id ? '#5d76cb' : 'rgba(255,255,255,0.3)', minWidth: TOUCH_TARGET_SIZE, minHeight: TOUCH_TARGET_SIZE }}
                          >
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: { xs: 0.5, sm: 0.75, md: 0.625, lg: 0.75, xl: 1 } }}>
                      ...
                      <Tooltip title="Rediger">
                        <IconButton
                          ...
                          sx={{ color: '#5d76cb', minWidth: TOUCH_TARGET_SIZE, minHeight: TOUCH_TARGET_SIZE }}
                        >
                        ...
                        >
                          <CardContent sx={{ p: { xs: 1.25, sm: 1.5 } }}>
                            ...
                            >
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', gap: 1, flexWrap: 'wrap' }}>
                                <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.75 }}>
                                  <LinkIcon sx={{ fontSize: 16, color: '#c3cbe6' }} />
                                  <Typography sx={{ color: '#dfe4f3', fontSize: '0.74rem', textTransform: 'uppercase', fontWeight: 700 }}>
                              ...
                              <Collapse in={sceneLinksExpanded}>
                                <Box sx={{ mt: 1, display: 'flex', gap: 0.65, flexWrap: 'wrap' }}>
                                  ...
                                  <Chip size="small" icon={<StoryboardIcon sx={{ fontSize: 15 }} />} label={`${linkedSceneSummary.storyboard} storyboard`} sx={{ bgcolor: 'rgba(147, 164, 220,0.2)', color: '#c3cbe6' }} />
                                </Box>
                                          ...
                                          return (
                                            <Box
                                              ...
                                              sx={{
                                                p: 0.8,
                                                borderRadius: 1.25,
                                                bgcolor: selected ? 'rgba(93, 118, 203,0.2)' : 'rgba(255,255,255,0.04)',
                                                border: `1px solid ${selected ? 'rgba(93, 118, 203,0.38)' : 'rgba(255,255,255,0.16)'}`,
                                              }}
                                            >
                                              <FormControlLabel
                                                control={
                            ...
                            >
                              ...
                              <Box sx={{ mt: 1, display: 'flex', gap: 0.65, flexWrap: 'wrap' }}>
                                ...
                                <Chip
                                  ...
                                  sx={{ bgcolor: 'rgba(147, 164, 220,0.2)', color: '#c3cbe6' }}
                                />
                                          ...
                                          {mediaSceneOptions.map((scene) => {
                                            ...
                                            return (
                                              <Chip
                                                ...
                                                label={scene.label}
                                                sx={{
                                                  bgcolor: selected ? 'rgba(93, 118, 203,0.24)' : 'rgba(255,255,255,0.08)',
                                                  color: selected ? '#dfe4f3' : 'rgba(255,255,255,0.78)',
                                                  border: `1px solid ${
                                                    selected ? 'rgba(93, 118, 203,0.5)' : 'rgba(255,255,255,0.18)'
                                                  }`,
                                                }}
                                              />
                                            );
                                    ...
                                    >
                                      ...
                                      >
                                        <Button
                                          ...
                                          sx={{ textTransform: 'none', color: '#c3cbe6', borderColor: 'rgba(93, 118, 203,0.45)' }}
                                        >
                                          Legg til URL
                                        </Button>
                                        <Button
                                ...
                                <Box sx={{ mt: 1, display: 'flex', gap: 0.75, flexWrap: 'wrap' }}>
                                  ...
                                  {proContactPhone ? (
                                    <Chip
                                      ...
                                      sx={{ bgcolor: 'rgba(147, 164, 220,0.22)', color: '#dfe4f3' }}
                                    />
                                  ) : null}
                                  {proContactEmail ? (
                                    <Chip
                    ...
                    <CardContent>
                      ...
                      <Stack spacing={1}>
                        ...
                        <Box sx={{ p: 1, borderRadius: 1.5, bgcolor: 'rgba(93, 118, 203,0.12)', border: '1px solid rgba(93, 118, 203,0.25)' }}>
                          ...
                          <Typography sx={{ color: '#c3cbe6', fontWeight: 800, fontSize: '1.1rem' }}>{allShots.filter((shot) => shot.locationId).length}</Typography>
                        </Box>
          ...
          {filteredAndSortedLocations.map((location) => {
            ...
            >
              ...
              >
                ...
                <Box
                  sx={{
                    background: `linear-gradient(135deg, ${typeColor}25 0%, rgba(93, 118, 203,0.15) 100%)`,
                                  ...
                                  <Tooltip key={entry.key} title={entry.label} arrow>
                                    <Box
                                      sx={{
                                        ...
                                        color: '#c3cbe6',
                                        border: '1px solid rgba(75, 61, 143,0.32)',
                                      }}
                                    >
                                      {entry.icon}
                                    </Box>
                ...
                >
                  ...
                  {location.address && (
                    ...
                    >
                      ...
                      {location.coordinates?.lat && location.coordinates?.lng ? (
                        ...
                        >
                          <LocationIcon sx={{ fontSize: { xs: 20, sm: 24, md: 22, lg: 26, xl: 30 }, color: '#c3cbe6' }} />
                        </Box>
                      )}
                      <Box sx={{ flex: 1, minWidth: 0 }}>
                        <Typography
                      ...
                      <Tooltip title={copiedId === location.id ? 'Kopiert!' : 'Kopier'}>
                        <IconButton
                          size="small"
                          onClick={() => handleCopyAddress(location.address ?? '', location.id)}
                          sx={{ color: copiedId === location.id ? '#5d76cb' : 'rgba(255,255,255,0.4)', minWidth: TOUCH_TARGET_SIZE, minHeight: TOUCH_TARGET_SIZE }}
                        >
                  ...
                  {location.coordinates && (
                    ...
                    >
                      ...
                      >
                        <LocationIcon sx={{ fontSize: { xs: 14, sm: 16, md: 15, lg: 18, xl: 20 }, color: '#93a4dc' }} />
                      </Box>
                      <Box sx={{ flex: 1, minWidth: 0 }}>
                        <Typography sx={{ 
                          color: '#93a4dc', 
                  ...
                  {normalizeSceneIds(location.assignedScenes).length > 0 && (
                    ...
                    >
                      ...
                      >
                        <AssessmentIcon sx={{ fontSize: { xs: 14, sm: 16, md: 15, lg: 18, xl: 20 }, color: '#c3cbe6' }} />
                      </Box>
                      <Typography sx={{ color: '#c3cbe6', fontSize: { xs: '0.8rem', sm: '0.875rem', md: '0.85rem', lg: '0.88rem', xl: '1rem' }, fontWeight: 600 }}>
                  ...
                  <Collapse in={expandedCards.has(location.id)}>
                    <Box sx={{ mt: { xs: 0.75, sm: 1, md: 1.125, lg: 1.25, xl: 1.5 }, pt: { xs: 1.5, sm: 1.75, md: 1.875, lg: 2, xl: 2.25 }, borderTop: '1px solid rgba(93, 118, 203,0.22)' }}>
                      {location.notes && (
                        <Box
                          sx={{
                        ...
                        <Stack spacing={{ xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 }}>
                          ...
                          {location.contactInfo.phone && (
                            ...
                            >
                              ...
                              >
                                <PhoneIcon sx={{ fontSize: { xs: 20, sm: 22, md: 21, lg: 24, xl: 28 }, color: '#93a4dc' }} />
                              </Box>
                              <Box>
                                <Typography sx={{ color: 'rgba(255,255,255,0.87)', fontSize: { xs: '0.65rem', sm: '0.7rem', md: '0.68rem', lg: '0.75rem', xl: '0.85rem' }, fontWeight: 600, textTransform: 'uppercase' }}>
                                  Telefon
                                ...
                                <Typography
                                  ...
                                  sx={{ color: '#93a4dc', fontSize: { xs: '0.95rem', sm: '1rem', md: '0.975rem', lg: '1.05rem', xl: '1.125rem' }, fontWeight: 700, textDecoration: 'none', '&:hover': { textDecoration: 'underline' } }}
                                >
                                  {location.contactInfo.phone}
                                </Typography>
                              </Box>
                  ...
                  >
                    <Button
                      ...
                      sx={{
                        bgcolor: expandedCards.has(location.id) ? '#3e3180 !important' : '#4b3d8f !important',
                        color: '#fff !important',
                        ...
                        border: expandedCards.has(location.id)
                          ? '1px solid rgba(195, 203, 230,0.45)'
                          : '1px solid rgba(147, 164, 220,0.32)',
                        borderRadius: 2,
                        textTransform: 'none',
                        boxShadow: expandedCards.has(location.id) 
                          ? '0 2px 8px rgba(93, 118, 203,0.22)' 
                          : '0 1px 4px rgba(93, 118, 203,0.12)',
                        transition: 'all 0.25s cubic-bezier(0.4, 0, 0.2, 1)',
                        '&:hover': {
                          bgcolor: expandedCards.has(location.id) ? '#32127a !important' : '#3e3180 !important',
                          borderColor: 'rgba(195, 203, 230,0.5)',
                          transform: 'translateY(-1px)',
                          boxShadow: '0 4px 10px rgba(93, 118, 203,0.3)',
                        },
                        '&:active': {
                      ...
                      <Tooltip title="Rediger" arrow>
                        <IconButton
                          ...
                          sx={{
                            ...
                            '&:hover': { bgcolor: 'rgba(93, 118, 203,0.2)', transform: 'translateY(-1px)' },
                            ...focusVisibleStyles,
                          }}
                        >
      ...
      <Snackbar
        ...
        action={
          <Button color="primary" size="small" onClick={handleUndoDelete} sx={{ color: '#5d76cb' }}>
            Angre
          </Button>
        }
        sx={{
        ...
        >
          <Stack direction="row" spacing={1.5} alignItems="center">
            <Box
              sx={{
                ...
                display: 'grid',
                placeItems: 'center',
                background: 'linear-gradient(135deg, rgba(93, 118, 203,0.92), rgba(75, 61, 143,0.88))',
                border: '1px solid rgba(195, 203, 230,0.42)',
                boxShadow: '0 10px 22px rgba(75, 61, 143,0.36)',
              }}
            >
          ...
          <IconButton
            ...
            sx={{
              ...
              '&:hover': { bgcolor: 'rgba(30,41,59,0.85)', borderColor: 'rgba(93, 118, 203,0.55)' },
            }}
          >
          ...
          <Stack spacing={{ xs: 2.5, sm: 3, md: 2.75, lg: 3, xl: 3.5 }}>
            <TextField
              ...
              sx={{
                ...
                '& .MuiInputLabel-root.Mui-focused': { color: '#5d76cb' },
              }}
            />
            ...
            <Box>
                  ...
                  <TextField
                    ...
                    InputProps={{
                      ...
                      endAdornment: (
                        <>
                          {addressSuggestionsLoading && (
                            <CircularProgress size={16} sx={{ color: '#5d76cb', mr: 1 }} />
                          )}
              ...
              <Button
                ...
                sx={{
                  ...
                  px: { xs: 1.5, sm: 2, md: 1.75, lg: 2, xl: 2.5 },
                  py: { xs: 0.75, sm: 1, md: 0.875, lg: 1, xl: 1.25 },
                  '&:hover': { borderColor: '#5d76cb', bgcolor: 'rgba(93, 118, 203,0.1)' },
                }}
              >
                  ...
                  <FormControlLabel
                    ...
                    control={
                      <Checkbox
                        ...
                        sx={{ color: '#5d76cb', '&.Mui-checked': { color: '#5d76cb' } }}
                      />
                    }
                    label={getFacilityLabel(facility)}
                    sx={{ 
        ...
        >
          <Button
            ...
            sx={{ 
              ...
              py: { xs: 0.75, sm: 1, md: 0.875, lg: 1, xl: 1.25 },
              ...focusVisibleStyles,
              '&:hover': { bgcolor: 'rgba(30,41,59,0.88)', borderColor: 'rgba(93, 118, 203,0.48)' },
            }}
          >
            Avbryt
          </Button>
          <Button
            ...
            sx={{
              ...
              boxShadow: '0 10px 24px rgba(75, 61, 143,0.45)',
              backgroundImage: 'linear-gradient(135deg, #5d76cb 0%, #4b3d8f 100%)',
              '&:hover': { backgroundImage: 'linear-gradient(135deg, #4b3d8f 0%, #3e3180 100%)' },
            }}
          >

                      ...
                      <Box sx={{ mt: 1.25 }}>
                        ...
                        {(selectedMedia.kind === 'photo' || selectedMedia.kind === 'panorama') && (
                          <>
                            ...
                            <Box data-testid="scout-pin-canvas" onPointerDown={addPinAt} sx={{ position: 'relative', overflow: 'hidden', borderRadius: 2, minHeight: 220, maxHeight: 520, bgcolor: '#1b122c', border: '1px solid rgba(125,211,252,.2)', touchAction: 'pan-y', cursor: readOnly ? 'default' : 'crosshair' }}>

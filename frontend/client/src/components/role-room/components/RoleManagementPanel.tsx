...
function RoleManagementPanelInner({
  ...
  const generateRolesHTML = (project: ProjectExportInfo, roles: Role[]): string => {
    ...
    const roleIconSVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5d76cb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .progress-fill {
      height: 100%;
      background: linear-gradient(90deg, #5d76cb 0%, #b7794d 100%);
      border-radius: 10px;
    }
    .section {
      margin-bottom: 50px;
    ...
    th {
      background: linear-gradient(135deg, #5d76cb 0%, #b7794d 100%);
      color: white;
      font-weight: 700;
      padding: 18px 20px;
      text-align: left;
  ...
  return (
    ...
    >
        ...
        >
          <Box
            sx={{
              ...
              background: 'linear-gradient(145deg, rgba(93, 118, 203,0.34) 0%, rgba(110,75,52,0.32) 100%)',
              border: '1px solid rgba(93, 118, 203,0.48)',
              display: 'flex',
              alignItems: 'center',
          ...
          <Box>
            <Typography
              ...
              sx={{
                ...
                background: 'linear-gradient(135deg, #f7e7d5 0%, #5d76cb 100%)',
          ...
          >
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={1} sx={{ alignItems: { md: 'center' }, flexWrap: 'wrap' }}>
              ...
              <Button
                ...
                sx={{ minHeight: 34, color: proPreset === 'casting_focus' ? '#2a3152' : roleTextMuted, borderColor: roleBorder, bgcolor: proPreset === 'casting_focus' ? roleTabAccent : 'transparent' }}
              >
                Casting-fokus
              </Button>
              <Button
                ...
                sx={{ minHeight: 34, color: proPreset === 'critical_roles' ? '#2a3152' : roleTextMuted, borderColor: roleBorder, bgcolor: proPreset === 'critical_roles' ? roleTabAccent : 'transparent' }}
              >
                Kritiske roller
              </Button>
              <Button
                ...
                sx={{ minHeight: 34, color: proPreset === 'this_week' ? '#2a3152' : roleTextMuted, borderColor: roleBorder, bgcolor: proPreset === 'this_week' ? roleTabAccent : 'transparent' }}
              >
                Denne uka
              </Button>
              <Button
                ...
                sx={{ minHeight: 34, color: proPreset === 'all_roles' ? '#2a3152' : roleTextMuted, borderColor: roleBorder, bgcolor: proPreset === 'all_roles' ? roleTabAccent : 'transparent' }}
              >
                Alle
              </Button>
            </Stack>
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={1} sx={{ alignItems: { md: 'center' }, flexWrap: 'wrap', justifyContent: { lg: 'flex-end' } }}>
              ...
              <Button
                ...
                sx={{ minHeight: 34, borderColor: roleBorder, color: proListMode === 'cards' ? '#2a3152' : roleTextMuted, bgcolor: proListMode === 'cards' ? roleTabAccent : 'transparent' }}
              >
              ...
              <Button
                ...
                sx={{ minHeight: 34, borderColor: roleBorder, color: proListMode === 'table' ? '#2a3152' : roleTextMuted, bgcolor: proListMode === 'table' ? roleTabAccent : 'transparent' }}
              >
              ...
              <Button
                ...
                sx={{ minHeight: 34, borderColor: roleBorder, color: proCompareMode ? '#2a3152' : roleTextMuted, bgcolor: proCompareMode ? roleTabAccent : 'transparent' }}
              >
                ...
                {pipelineCounts.map((pipelineItem) => (
                  <Button
                    ...
                    sx={{
                      ...
                      minHeight: 34,
                      borderColor: roleBorder,
                      color: proPipelineFilter === pipelineItem.status ? '#2a3152' : roleTextMuted,
                        ...
                        {proRoles.map((role) => {
                          ...
                          return (
                            <TableRow
                              ...
                              sx={{
                                cursor: 'pointer',
                                bgcolor: isSelected ? 'rgba(93, 118, 203,0.14)' : 'transparent',
                    ...
                    {proRoles.map((role) => {
                      ...
                      return (
                        <Card
                          ...
                          sx={{
                            cursor: 'pointer',
                            bgcolor: isSelected ? 'rgba(93, 118, 203,0.18)' : roleSurfaceMuted,
                        ...
                        >
                          ...
                          {recommendedAction.nextStatus && (
                            <Button
                              ...
                              sx={{ mt: 0.75, bgcolor: roleTabAccent, color: '#2a3152', fontWeight: 700 }}
                            >
                    ...
                    {proDetailTab === 'handlinger' && (
                      <Stack spacing={1}>
                        <Button
                          ...
                          sx={{ bgcolor: roleTabAccent, color: '#2a3152', fontWeight: 700 }}
                        >
                          Rediger rolle
                        </Button>
                        <Button
        ...
        >
          <Box sx={statTileSx}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5, mb: 0.5 }}>
              <TheaterComedyIcon sx={{ fontSize: { xs: 16, sm: 18, md: 17, lg: 19, xl: 22 }, color: 'var(--role-accent, #5d76cb)' }} />
            </Box>
            <Typography variant="h4" sx={{ color: 'var(--role-accent, #5d76cb)', fontWeight: 700, fontSize: { xs: '1.5rem', sm: '2rem', md: '1.6rem', lg: '1.85rem', xl: '2.5rem' } }}>
              {stats.total}
            </Typography>
          ...
          <Tooltip title="Kortvisning">
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                bgcolor: viewMode === 'grid' ? 'rgba(93, 118, 203,0.26)' : 'transparent',
                color: viewMode === 'grid' ? 'var(--role-accent, #5d76cb)' : 'rgba(255,255,255,0.7)',
                borderColor: viewMode === 'grid' ? 'var(--role-accent, #5d76cb)' : 'rgba(255,255,255,0.2)',
                ...focusVisibleStyles,
              }}
            >
              <GridViewIcon />
          ...
          <Tooltip title="Tabellvisning">
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                bgcolor: viewMode === 'table' ? 'rgba(93, 118, 203,0.26)' : 'transparent',
                color: viewMode === 'table' ? 'var(--role-accent, #5d76cb)' : 'rgba(255,255,255,0.7)',
                borderColor: viewMode === 'table' ? 'var(--role-accent, #5d76cb)' : 'rgba(255,255,255,0.2)',
                fontSize: { xs: '0.875rem', sm: '1rem', md: '0.95rem', lg: '1.05rem', xl: '1.125rem' },
                ...focusVisibleStyles,
              }}
            >
      ...
      {poolMode === 'project' && (searchQuery || statusFilter !== 'all') && (
        <Alert
          ...
          sx={{
            ...
            bgcolor: 'rgba(93, 118, 203,0.14)',
            color: '#fff',
            '& .MuiAlert-icon': { color: 'var(--role-accent, #5d76cb)' },
          }}
        >
              ...
              <TableRow sx={{ bgcolor: 'rgba(255,255,255,0.05)' }}>
                ...
                <TableCell sx={{ fontSize: { xs: '0.8rem', sm: '0.875rem', md: '0.85rem', lg: '0.88rem', xl: '1rem' }, py: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
                  <TableSortLabel
                    ...
                    sx={{ color: '#fff', '&:hover': { color: 'var(--role-accent, #5d76cb)' } }}
                  >
                    Navn
                  </TableSortLabel>
                </TableCell>
            ...
            <TableBody>
              {filteredAndSortedRoles.map((role) => (
                <TableRow
                  key={role.id}
                  sx={{
                    bgcolor: selectedIds.has(role.id) ? 'rgba(93, 118, 203,0.14)' : 'transparent',
                ...
                >
                  ...
                  <TableCell sx={{ py: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
                    <Chip label={role.candidateIds?.length || 0} size="small" sx={{ bgcolor: 'rgba(93, 118, 203,0.26)', color: 'var(--role-accent, #5d76cb)', fontSize: { xs: '0.7rem', sm: '0.75rem', md: '0.72rem', lg: '0.8rem', xl: '0.9rem' }, height: { xs: 22, sm: 24, md: 23, lg: 26, xl: 30 } }} />
                  </TableCell>
                  <TableCell sx={{ py: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
                    <Chip label={role.sceneIds?.length || 0} size="small" sx={{ bgcolor: 'rgba(75, 61, 143,0.24)', color: '#cfa77d', fontSize: { xs: '0.7rem', sm: '0.75rem', md: '0.72rem', lg: '0.8rem', xl: '0.9rem' }, height: { xs: 22, sm: 24, md: 23, lg: 26, xl: 30 } }} />
                  </TableCell>
                  <TableCell align="right" sx={{ py: { xs: 1, sm: 1.25, md: 1.125, lg: 1.25, xl: 1.5 } }}>
                    <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: { xs: 0.5, sm: 0.75, md: 0.625, lg: 0.75, xl: 1 } }}>
                      ...
                      <Tooltip title="Rediger">
                        <IconButton onClick={() => onEditRole(role)} sx={{ color: 'var(--role-accent, #5d76cb)', minWidth: TOUCH_TARGET_SIZE, minHeight: TOUCH_TARGET_SIZE }}>
            ...
            return (
              <Box key={role.id}>
                <Card
                  component="article"
                  sx={{
                    bgcolor: selectedIds.has(role.id) ? 'rgba(93, 118, 203,0.18)' : 'rgba(255,255,255,0.05)',
                    border: selectedIds.has(role.id) ? '2px solid #5d76cb' : '1px solid rgba(255,255,255,0.1)',
                    borderRadius: 2,
                    transition: 'all 0.2s ease',
                    height: '100%',
                    display: 'flex',
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: { xs: 1.5, sm: 2, md: 1.75, lg: 2, xl: 2.5 } }}>
                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                        <Checkbox
                          checked={selectedIds.has(role.id)}
                          onChange={() => handleToggleSelect(role.id)}
                          sx={{ p: 0.5, color: 'rgba(255,255,255,0.87)', '&.Mui-checked': { color: 'var(--role-accent, #5d76cb)' } }}
                        />
                        <Box sx={{ flex: 1 }}>
                          ...
                          <Box
                            sx={{
                              ...
                              p: { xs: 1.5, sm: 2, md: 1.75, lg: 2, xl: 2.5 },
                              borderRadius: 2.5,
                              background: 'linear-gradient(135deg, rgba(93, 118, 203,0.3) 0%, rgba(50, 18, 122,0.24) 100%)',
                              border: '2px solid rgba(93, 118, 203,0.42)',
                              boxShadow: '0 4px 12px rgba(93, 118, 203,0.24), inset 0 1px 0 rgba(255,255,255,0.1)',
                              overflow: 'hidden',
                              '&::before': {
                                content: '""',
                                position: 'absolute',
                                ...
                                right: 0,
                                height: '3px',
                                background: 'linear-gradient(90deg, #5d76cb 0%, #4b3d8f 50%, #5d76cb 100%)',
                              },
                            }}
                          >
                            {/* Role Icon */}
                            <Box
                              sx={{
                                ...
                                boxShadow: '0 4px 12px rgba(93, 118, 203,0.42)',
                              }}
                            >
                      ...
                      {role.requirements.age && (
                        <Box
                          sx={{
                            ...
                            border: '1px solid rgba(93, 118, 203,0.30)',
                          }}
                        >
                          <Box
                            sx={{
                              ...
                              borderRadius: 1.5,
                              bgcolor: 'rgba(93, 118, 203,0.30)',
                              display: 'flex',
                              alignItems: 'center',
                              justifyContent: 'center',
                            }}
                          >
                            <PersonIcon sx={{ fontSize: { xs: 22, sm: 26, md: 24, lg: 28, xl: 34 }, color: 'var(--role-accent, #5d76cb)' }} />
                          </Box>
                          <Box sx={{ flex: 1 }}>
                            <Typography
                              sx={{
                      ...
                      <Button
                        ...
                        sx={{
                          bgcolor: expandedCards.has(role.id)
                            ? 'rgba(93, 118, 203,0.30)'
                            : 'rgba(93, 118, 203,0.18)',
                          color: expandedCards.has(role.id) ? 'var(--role-accent, #5d76cb)' : '#fff',
                          fontSize: { xs: '0.8rem', sm: '0.875rem', md: '0.85rem', lg: '0.9rem', xl: '1rem' },
                          fontWeight: 600,
                          minHeight: TOUCH_TARGET_SIZE,
                          ...
                          border: expandedCards.has(role.id)
                            ? '2px solid rgba(93, 118, 203,0.52)'
                            : '2px solid rgba(93, 118, 203,0.34)',
                          borderRadius: 2,
                          textTransform: 'none',
                          boxShadow: expandedCards.has(role.id)
                            ? '0 4px 12px rgba(93, 118, 203,0.34)'
                            : '0 2px 8px rgba(93, 118, 203,0.24)',
                          transition: 'all 0.2s ease',
                          '&:hover': {
                            bgcolor: 'rgba(93, 118, 203,0.38)',
                            borderColor: 'rgba(93, 118, 203,0.62)',
                            transform: 'translateY(-1px)',
      ...
      <Snackbar
        ...
        action={
          <Button color="secondary" size="small" onClick={handleUndoDelete} sx={{ color: 'var(--role-accent, #5d76cb)', fontSize: isDesktop ? '1rem' : isTablet ? '0.875rem' : '0.8125rem' }}>
            Angre
          </Button>
        }

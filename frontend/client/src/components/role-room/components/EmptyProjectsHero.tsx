    ...
    >
      <Box
        sx={{
          ...
          textAlign: 'center',
          p: { xs: 3, sm: 5 },
          bgcolor: 'rgba(141, 128, 234,0.06)',
          border: '1px dashed rgba(141, 128, 234,0.32)',
          borderRadius: 3,
        }}
      >
        <Box
        ...
        >
          <SparkleIcon sx={{ fontSize: 36, color: 'var(--role-accent, #8d80ea)' }} />
        </Box>
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} justifyContent="center">
          <Button
            ...
            sx={{
              bgcolor: 'var(--role-accent, #8d80ea)',
              color: '#fff',
              fontWeight: 700,
              px: 3.5,
              py: 1.5,
              fontSize: '1rem',
              minHeight: 48,
              '&:hover': { bgcolor: '#7666e6', transform: 'translateY(-1px)' },
          ...
          {onOpenDemo && (
            <Button
              ...
              sx={{
                ...
                borderColor: 'rgba(141, 128, 234,0.5)',
                fontWeight: 600,
                px: 3.5,
                py: 1.5,
                fontSize: '0.95rem',

...
function DashboardPanelInner({
  ...
  const roleStages = useMemo(() => {
    ...
    return [
      { status: 'open',    label: 'Åpen',    color: '#93a4dc', tabIndex: 2 },
  ...
  const _quickLinks = [
    ...
    { title: 'Kalender', description: 'Produksjonsplan', color: '#32127a', icon: CalendarIcon, tabIndex: 6 },
  ];
    ...
    >
      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: { xs: 2, sm: 2.5, md: 2.25, lg: 2.5, xl: 3 }, flexWrap: 'wrap', gap: { xs: 1.5, sm: 2, md: 1.75, lg: 2, xl: 2.5 } }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1.5, sm: 2, md: 1.75, lg: 2, xl: 2.5 } }}>
          ...
          >
            <DashboardIcon sx={{ fontSize: { xs: 24, sm: 28, md: 26, lg: 30, xl: 36 }, color: 'var(--role-violet, #5d76cb)' }} />
          </Box>
        ...
        <Tooltip title="Åpne Dashboard-guide">
          <IconButton
            ...
            sx={{
              ...
              minWidth: TOUCH_TARGET_SIZE,
              minHeight: TOUCH_TARGET_SIZE,
              '&:hover': { color: 'var(--role-violet, #5d76cb)', borderColor: 'var(--role-violet, #5d76cb)', bgcolor: 'rgba(93, 118, 203,0.1)' },
              ...focusVisibleStyles,
            }}
      ...
      >
        <CardContent sx={{ p: { xs: 2, sm: 3, md: 2.5, lg: 3, xl: 3.5 } }}>
          ...
          >
            ...
            >
              <BoltIcon
                sx={{ color: 'var(--role-violet, #5d76cb)', fontSize: { xs: 20, sm: 24 } }}
              />
            </Box>
            <Typography

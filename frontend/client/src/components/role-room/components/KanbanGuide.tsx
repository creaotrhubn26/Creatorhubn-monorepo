...
const KANBAN_STATUSES: Record<string, { label: string; color: string; bg: string }> = {
  ...
  selected:  { label: 'Selected',  color: 'var(--role-violet, #756be7)', bg: 'rgba(117, 107, 231,0.15)'  },
          ...
          <>
            ...
            >
              ...
              {[
                ...
                { role: 'Admin', cols: 'All 5', add: '✓', move: '✓', bulk: '✓', event: '✓', color: 'var(--role-violet, #756be7)' },
                ...
                { role: 'Client', cols: 'Selected + Confirmed', add: '—', move: '—', bulk: '—', event: '—', color: '#9d97ee' },

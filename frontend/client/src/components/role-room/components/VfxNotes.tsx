...
import { Box, Typography, Paper, Button, IconButton, Chip, Stack, Card, CardContent, Grid, Dialog, DialogTitle, DialogContent, DialogActions, TextField, Select, MenuItem, FormControl, InputLabel, Checkbox, FormControlLabel, LinearProgress, Divider } from "@mui/material";
import { AutoFixHigh as VfxIcon, Add as AddIcon, Delete as DeleteIcon, Edit as EditIcon, CropFree as TrackingIcon, Gradient as GreenScreenIcon, Layers as CompositeIcon, Animation as AnimationIcon, ThreeDRotation as ThreeDIcon, Brush as PaintIcon, CheckCircle as CheckIcon, Schedule as ScheduleIcon } from "@mui/icons-material";

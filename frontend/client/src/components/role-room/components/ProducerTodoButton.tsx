...
export function ProducerTodoButton({
  ...
  const sections: TodoSection[] = [
    { key: 'client', title: 'Klient', icon: <ClientIcon sx={{ color: '#9d97ee' }} />, openCount: client.openCount, points: client.points },
    { key: 'content-logic', title: 'Content Logic', icon: <ContentLogicIcon sx={{ color: '#9d97ee' }} />, openCount: cl.openCount, points: cl.points },
    { key: 'access', title: 'Kontotilgang', icon: <AccessIcon sx={{ color: '#9d97ee' }} />, openCount: ac.openCount, points: ac.points },
  ];

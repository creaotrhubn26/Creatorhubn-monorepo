...
export function CastingSharingDialog({ open, projectId, onClose, onUpdate }: CastingSharingDialogProps) {
  ...
  const handleRemoveUser = (userRoleId: string) => {
    setConfirmRemoveUserId(userRoleId);
  };

  const executeRemoveUser = async () => {
    if (!confirmRemoveUserId) return;
    const userRoleId = confirmRemoveUserId;
                      ...
                      {roleTypes.map((role) => {
                        const getRoleIcon = (r: UserRoleType) => {
                          const icons: Record<UserRoleType, ReactElement> = {
                            ...
                            line_producer: <BusinessIcon sx={{ fontSize: '1rem' }} />,
                            ...
                            local_casting_director: <PeopleIcon sx={{ fontSize: '1rem' }} />,
                            extras_casting_director: <PeopleIcon sx={{ fontSize: '1rem' }} />,
                            production_manager: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            production_accountant: <BusinessIcon sx={{ fontSize: '1rem' }} />,
                            production_coordinator: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            production_secretary: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            office_production_assistant: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            ...
                            production_designer: <BusinessIcon sx={{ fontSize: '1rem' }} />,
                            production_sound_mixer: <VideocamIcon sx={{ fontSize: '1rem' }} />,
                            first_ad: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            second_ad: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            second_second_assistant_director: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            set_production_assistant: <SupervisorAccountIcon sx={{ fontSize: '1rem' }} />,
                            camera_team: <VideocamIcon sx={{ fontSize: '1rem' }} />,
                            agency: <BusinessIcon sx={{ fontSize: '1rem' }} />,
                            writer: <PersonIcon sx={{ fontSize: '1rem' }} />,
                            script_editor: <PersonIcon sx={{ fontSize: '1rem' }} />,
                            reader: <PersonIcon sx={{ fontSize: '1rem' }} />,
                          };

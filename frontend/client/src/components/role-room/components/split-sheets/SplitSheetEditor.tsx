      ...
      try {
        ...
        if (splitSheet?.id) {
          try {
            ...
            if (fetchErrMsg.includes('404') || fetchErrMsg.includes('API error: 404')) {
              response = await apiRequest('/api/split-sheets', {
                method: 'POST',
                body: JSON.stringify({
                  ...data,
        ...
        if (error instanceof Error) {
          const errWithResponse = error as Error & { response?: { data?: { error?: string } } };
          if (errWithResponse.response?.data) {
            throw new Error(errWithResponse.response.data.error || error.message);
          }
          throw error;
        }
        throw new Error(typeof error === 'string' ? error : 'Failed to save split sheet to database');
      }
    },
    onSuccess: (response) => {
              ...
              {showUnionSettings && (
                <Stack spacing={{ xs: 2, sm: 2.25, md: 2.5, lg: 2.75, xl: 3, '2xl': 3.25, '3xl': 3.5 }}>
                  ...
                  {(unionSettings.isFilmWorker || unionSettings.unionMembership === 'nff_member' || unionSettings.unionMembership === 'both') && (
                    <Box sx={{ p: { xs: 1.5, sm: 1.75, md: 2, lg: 2.25, xl: 2.5, '2xl': 2.75, '3xl': 3 }, bgcolor: 'rgba(93, 118, 203, 0.1)', borderRadius: { xs: 1.5, sm: 1.75, md: 2, lg: 2.25, xl: 2.5, '2xl': 2.75, '3xl': 3 }, border: '1px solid rgba(93, 118, 203, 0.3)' }}>
                      <Typography variant="subtitle2" sx={{ color: 'var(--role-cyan, #5d76cb)', fontWeight: 600, mb: { xs: 1.25, sm: 1.5, md: 1.75, lg: 2 }, display: 'flex', alignItems: 'center', gap: { xs: 0.75, sm: 1, md: 1.25, lg: 1.5 }, fontSize: { xs: '0.875rem', sm: '0.9rem', md: '0.925rem', lg: '0.95rem', xl: '1rem', '2xl': '1.025rem', '3xl': '1.05rem' } }}>
                  ...
                  <Box sx={{ p: { xs: 1.5, sm: 1.75, md: 2, lg: 2.25, xl: 2.5, '2xl': 2.75, '3xl': 3 }, bgcolor: 'rgba(63, 81, 181, 0.1)', borderRadius: { xs: 1.5, sm: 1.75, md: 2, lg: 2.25, xl: 2.5, '2xl': 2.75, '3xl': 3 }, border: '1px solid rgba(63, 81, 181, 0.3)' }}>
                    <Typography variant="subtitle2" sx={{ color: '#93a4dc', fontWeight: 600, mb: { xs: 1.25, sm: 1.5, md: 1.75, lg: 2 }, display: 'flex', alignItems: 'center', gap: { xs: 0.75, sm: 1, md: 1.25, lg: 1.5 }, fontSize: { xs: '0.875rem', sm: '0.9rem', md: '0.925rem', lg: '0.95rem', xl: '1rem', '2xl': '1.025rem', '3xl': '1.05rem' } }}>
                  ...
                  <Box sx={{ p: { xs: 1.5, sm: 1.75, md: 2, lg: 2.25, xl: 2.5, '2xl': 2.75, '3xl': 3 }, bgcolor: 'rgba(93, 118, 203, 0.1)', borderRadius: { xs: 1.5, sm: 1.75, md: 2, lg: 2.25, xl: 2.5, '2xl': 2.75, '3xl': 3 }, border: '1px solid rgba(93, 118, 203, 0.3)' }}>
                    <Typography variant="subtitle2" sx={{ color: 'var(--role-violet, #5d76cb)', fontWeight: 600, mb: { xs: 1.25, sm: 1.5, md: 1.75, lg: 2 }, display: 'flex', alignItems: 'center', gap: { xs: 0.75, sm: 1, md: 1.25, lg: 1.5 }, fontSize: { xs: '0.875rem', sm: '0.9rem', md: '0.925rem', lg: '0.95rem', xl: '1rem', '2xl': '1.025rem', '3xl': '1.05rem' } }}>
                  ...
                  <Card
                    ...
                    sx={{
                      ...
                      boxShadow: percentageError
                        ? '0 2px 8px rgba(244, 67, 54, 0.2)'
                        : percentageWarning
                        ? '0 2px 8px rgba(75, 61, 143, 0.2)'
                        : '0 2px 8px rgba(76, 175, 80, 0.15)',
                      border: percentageError
                        ? '2px solid rgba(244, 67, 54, 0.3)'
                        : percentageWarning
                        ? '2px solid rgba(75, 61, 143, 0.3)'
                        : '2px solid rgba(76, 175, 80, 0.3)',
            ...
            {saveMutation.error && typeof saveMutation.error === 'object' &&'details' in saveMutation.error && (
              <Box sx={{ mt: 1 }}>
                <Typography variant="caption">
                  {(saveMutation.error as Record<string, { message?: string }>).details?.message}
                </Typography>
              </Box>
            )}
          </Alert>

...
const templateTypeConfig: Record<string, { label: string; color: string; icon: ReactNode }> = {
  invitation: { label: 'Invitasjon', color: 'var(--role-cyan, #5d76cb)', icon: <EmailIcon /> },
  callback: { label: 'Callback', color: 'var(--role-violet, #5d76cb)', icon: <ScheduleIcon /> },
...
export default function AdminDashboard({ open, onClose, projectName = 'Mitt Prosjekt' }: AdminDashboardProps) {
  ...
  const inputStyles = {
    '& .MuiOutlinedInput-root': {
      ...
      '&.Mui-focused fieldset': { borderColor: 'var(--role-violet, #5d76cb)' },
    },
    ...
    <>
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: spacing }}>
            ...
            >
              <AdminPanelSettingsIcon sx={{ color: 'var(--role-violet, #5d76cb)', fontSize: iconSize + 4 }} />
            </Box>
            <Box>
        ...
        <Box sx={{ borderBottom: '1px solid rgba(255,255,255,0.08)', px: spacing, bgcolor: '#161b22' }}>
          <Tabs
            ...
            sx={{
              ...
              '& .MuiTabs-indicator': { bgcolor: 'var(--role-violet, #5d76cb)', height: 3 },
            }}
          >
            ...
            <Box sx={{ p: spacing, overflow: 'auto', flex: 1 }}>
              ...
              {loading ? (
                <Box sx={{ display: 'flex', justifyContent: 'center', py: 4 }}>
                  <CircularProgress sx={{ color: 'var(--role-violet, #5d76cb)' }} />
                </Box>
              ) : (
                <TableContainer
                  component={Paper}
                            ...
                            <TableCell align="right" sx={{ borderBottom: '1px solid rgba(255,255,255,0.05)', py: spacing }}>
                              <Tooltip title="Generer nytt passord">
                                <IconButton
                                  ...
                                  sx={{ color: 'var(--role-violet, #5d76cb)', '&:hover': { bgcolor: 'rgba(93, 118, 203,0.1)' }, minWidth: iconButtonSize, minHeight: iconButtonSize }}
                                >
                ...
                <Box sx={{ display: 'flex', flexDirection: { xs: 'column', lg: 'row' }, gap: spacing, alignItems: { lg: 'center' } }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                    <Button
                      ...
                      sx={{ bgcolor: 'var(--role-violet, #5d76cb)', '&:hover': { bgcolor: '#4b3d8f' }, minHeight: buttonMinHeight }}
                    >
                      Lagre
                    </Button>
                    <Button
      ...
      >
            ...
            <FormControl fullWidth size={isMobile ? 'medium' : 'small'}>
              ...
              <Select
                ...
                sx={{
                  ...
                  '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: 'var(--role-violet, #5d76cb)' },
        ...
        <DialogActions sx={{ p: spacing, borderTop: '1px solid rgba(255,255,255,0.08)', gap: 1 }}>
          ...
          <Button
            ...
            sx={{ bgcolor: 'var(--role-violet, #5d76cb)', '&:hover': { bgcolor: '#4b3d8f' }, minHeight: buttonMinHeight, fontSize: fontSize.button }}
          >
            Opprett
          </Button>
        </DialogActions>
      ...
      >
        ...
        <DialogContent sx={{ p: spacing }}>
          <Alert severity="info" sx={{ mb: spacing, bgcolor: 'rgba(93, 118, 203,0.1)', color: 'var(--role-cyan, #5d76cb)', fontSize: fontSize.body }}>
          ...
          >
            ...
            <IconButton
              ...
              sx={{ color: 'var(--role-violet, #5d76cb)', minWidth: iconButtonSize, minHeight: iconButtonSize }}
            >

...
const templateTypeConfig: Record<string, { label: string; color: string; icon: ReactNode }> = {
  ...
  callback: { label: 'Callback', color: 'var(--role-violet, #756be7)', icon: <ScheduleIcon /> },
      ...
      >
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: spacing }}>
            ...
            >
              <AdminPanelSettingsIcon sx={{ color: 'var(--role-violet, #756be7)', fontSize: iconSize + 4 }} />
            </Box>
            <Box>
          ...
          <Tabs
            ...
            sx={{
              ...
              '& .MuiTab-root': {
                ...
                gap: 1,
                px: spacing,
                '&.Mui-selected': { color: 'var(--role-violet, #756be7)' },
              },
              '& .MuiTabs-indicator': { bgcolor: 'var(--role-violet, #756be7)', height: 3 },
            }}
          >
                            ...
                            <TableCell align="right" sx={{ borderBottom: '1px solid rgba(255,255,255,0.05)', py: spacing }}>
                              <Tooltip title="Generer nytt passord">
                                <IconButton
                                  ...
                                  sx={{ color: 'var(--role-violet, #756be7)', '&:hover': { bgcolor: 'rgba(117, 107, 231,0.1)' }, minWidth: iconButtonSize, minHeight: iconButtonSize }}
                                >
                ...
                <Box sx={{ display: 'flex', flexDirection: { xs: 'column', lg: 'row' }, gap: spacing, alignItems: { lg: 'center' } }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                    <Button
                      ...
                      sx={{ bgcolor: 'var(--role-violet, #756be7)', '&:hover': { bgcolor: '#5446e1' }, minHeight: buttonMinHeight }}
                    >
                      Lagre
                    </Button>
                    <Button
      ...
      >
            ...
            <FormControl fullWidth size={isMobile ? 'medium' : 'small'}>
              ...
              <Select
                ...
                sx={{
                  ...
                  '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: 'var(--role-violet, #756be7)' },
        ...
        <DialogActions sx={{ p: spacing, borderTop: '1px solid rgba(255,255,255,0.08)', gap: 1 }}>
          ...
          <Button
            ...
            sx={{ bgcolor: 'var(--role-violet, #756be7)', '&:hover': { bgcolor: '#5446e1' }, minHeight: buttonMinHeight, fontSize: fontSize.button }}
          >
            Opprett
          </Button>
        </DialogActions>
        ...
        <DialogContent sx={{ p: spacing }}>
          ...
          >
            ...
            <IconButton
              ...
              sx={{ color: 'var(--role-violet, #756be7)', minWidth: iconButtonSize, minHeight: iconButtonSize }}
            >

        ...
        <>
          {suggesting && (
            <Stack direction="row" spacing={1} alignItems="center" sx={{ py: 3 }}>
              ...
              <Typography sx={{ fontSize: 12, color: '#c3cbe6' }}>
        ...
        {suggestMode
          ...
          <Box
            ...
            sx={{
              ...
              cursor: 'pointer',
              '&:hover': { borderColor: 'var(--role-violet, #5d76cb)' },
              '&:hover .archive-overlay': { opacity: 1 },
            }}
          >
            <Box
              ...
              <Stack direction="row" spacing={0.5} flexWrap="wrap" useFlexGap>
                {frame.claudeTags.shotType !== 'unknown' && (
                  <Chip
                    ...
                    sx={{ height: 16, fontSize: 9, bgcolor: 'rgba(93, 118, 203,0.3)', color: '#e5e7eb' }}
                  />
                )}
          ...
          <Stack spacing={2}>
            ...
            >
              ...
              {upload.previewUrl ? (
                ...
                <Stack spacing={1} alignItems="center">
                  <UploadIcon sx={{ fontSize: 32, color: 'var(--role-violet, #5d76cb)' }} />
            ...
            {upload.analyzing && (
              <Stack direction="row" spacing={1} alignItems="center">
                ...
                <Typography sx={{ fontSize: 12, color: '#93a4dc' }}>
                  CI tagger bildet…
                </Typography>
              </Stack>
            )}
            ...
            {upload.analyzedTags && (
              ...
              >
                <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 1 }}>
                  ...
                  <Typography sx={{ fontSize: 10, fontWeight: 700, color: '#93a4dc', letterSpacing: 1 }}>
                    AUTO-TAGS
                  </Typography>
                </Stack>

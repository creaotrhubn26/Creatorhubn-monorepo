  ...
  return (
    ...
    >
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          <Chip
            ...
            size="small"
            sx={{ ml: 1, bgcolor: 'rgba(84, 70, 225,0.2)', color: '#9d97ee' }}
          />
        </Box>
      ...
      {guideConfig.introBanner && (
        <Box sx={{ px: 2.5, py: 1, bgcolor: `${guideConfig.introBannerColor ?? '#5446e1'}20`, borderBottom: `1px solid ${guideConfig.introBannerColor ?? '#5446e1'}40` }}>
          <Typography variant="body2" sx={{ color: guideConfig.introBannerColor ?? '#9d97ee' }}>
            {guideConfig.introBanner}
          </Typography>
        </Box>
      )}
      ...
      >
                ...
                return (
                  <ListItemButton
                    ...
                    sx={{
                      ...
                      mx: 0.5,
                      '&.Mui-selected': {
                        bgcolor: 'rgba(84, 70, 225,0.15)',
                        '&:hover': { bgcolor: 'rgba(84, 70, 225,0.2)' },
                      },
                    }}
                  >
                    <Box sx={{ color: idx === activeStep ? '#9d97ee' : 'text.secondary', display: 'flex' }}>
                      {s.icon}
                    </Box>
                    <ListItemText
                      primary={
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5, flexWrap: 'wrap' }}>
                          ...
                          {ov.badge && (
                            <Chip label={ov.badge} size="small" sx={{ height: 16, fontSize: '0.6rem', bgcolor: 'rgba(84, 70, 225,0.3)', color: '#c4b5fd' }} />
                          )}
                        </Box>
                      }
                      primaryTypographyProps={{
                        ...
                        color: idx === activeStep ? '#dbd9f3' : 'text.secondary',
                      }}
                    />
                  </ListItemButton>
                );
        ...
        >
          ...
          {step.sections.map((section, idx) => (
            <Box key={idx} sx={{ mb: 4 }}>
              <Typography
                variant="subtitle1"
                fontWeight={600}
                sx={{ mb: 1.5, color: guideConfig.accentColorOverride ?? '#9d97ee' }}
              >
                {section.heading}
              </Typography>
          ...
          {stepOverride.adminNote && (
            <Box sx={{ mt: 3, p: 2, borderRadius: 2, border: `1px solid ${stepOverride.adminNoteColor ?? '#5446e1'}40`, bgcolor: `${stepOverride.adminNoteColor ?? '#5446e1'}15` }}>
              <Typography variant="caption" sx={{ color: stepOverride.adminNoteColor ?? '#9d97ee', fontWeight: 600, display: 'block', mb: 0.5 }}>
                Admin Note
              </Typography>
      ...
      >
        ...
        {isLast ? (
          <Button
            ...
            onClick={onClose}
            startIcon={<DoneIcon />}
            sx={{ minWidth: 90, bgcolor: '#5446e1', '&:hover': { bgcolor: '#3928d9' } }}
          >
            Done
          </Button>
        ) : (
          <Button
            ...
            size="small"
            onClick={handleNext}
            sx={{ minWidth: 80, bgcolor: '#5446e1', '&:hover': { bgcolor: '#3928d9' } }}
          >
            Next →
          </Button>
        )}

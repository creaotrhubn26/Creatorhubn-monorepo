    ...
    (printOptions: PrintOptions, stripsByDay: StripsByDay[], stats: StripboardStats) => {
      ...
      const daysHTML = stripsByDay.map(d => {
        ...
        return `<div class="day-group">
          <div class="day-header" style="background:${isUnassigned ? '#eef1fb' : '#4b3d8f'};color:${isUnassigned ? '#1a1a1a' : '#fff'};">
      ...
      pw.document.write(`<!DOCTYPE html><html><head><title>Stripboard - ${projectTitle}</title>
        <style>
          *{margin:0;padding:0;box-sizing:border-box}
          ...
          .header{text-align:center;margin-bottom:20px;padding-bottom:15px;border-bottom:3px solid #4b3d8f}
          .header h1{font-size:28px;font-weight:700} .header h2{font-size:14px;color:#4b3d8f;font-weight:600}
          .branding{font-size:10px;color:#666;margin-top:8px} .branding strong{color:#4b3d8f}
          ...
          .stat{text-align:center} .stat-value{font-size:20px;font-weight:700;color:#4b3d8f;display:block}
          ...
          .footer{margin-top:30px;padding-top:15px;border-top:1px solid #e5e7eb;text-align:center;font-size:9px;color:#4b3d8f}

    ...
    (printOptions: PrintOptions, stripsByDay: StripsByDay[], stats: StripboardStats) => {
      ...
      const daysHTML = stripsByDay.map(d => {
        ...
        return `<div class="day-group">
          <div class="day-header" style="background:${isUnassigned ? '#ebe7fd' : '#6249df'};color:${isUnassigned ? '#1a1a1a' : '#fff'};">
      ...
      pw.document.write(`<!DOCTYPE html><html><head><title>Stripboard - ${projectTitle}</title>
        <style>
          *{margin:0;padding:0;box-sizing:border-box}
          ...
          .header{text-align:center;margin-bottom:20px;padding-bottom:15px;border-bottom:3px solid #6249df}
          .header h1{font-size:28px;font-weight:700} .header h2{font-size:14px;color:#6249df;font-weight:600}
          .branding{font-size:10px;color:#666;margin-top:8px} .branding strong{color:#6249df}
          ...
          .stat{text-align:center} .stat-value{font-size:20px;font-weight:700;color:#6249df;display:block}
          ...
          .footer{margin-top:30px;padding-top:15px;border-top:1px solid #e5e7eb;text-align:center;font-size:9px;color:#6249df}

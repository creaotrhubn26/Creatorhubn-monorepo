...
export const DEMO_STRIPS: StripboardStrip[] = [
  ...
  { id: 'strip-2', sceneId: 'scene-2', sceneNumber: '2', shootingDayId: 'day-1', dayNumber: 1, sortOrder: 2, color: '#4227b0', location: 'HULEN - INNE I FJELLET', pages: 2.5, cast: ['ARBEIDER 1', 'ARBEIDER 2'],                          status: 'shot',          estimatedTime: 120 },

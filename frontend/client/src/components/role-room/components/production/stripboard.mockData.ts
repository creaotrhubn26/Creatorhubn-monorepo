...
export const DEMO_STRIPS: StripboardStrip[] = [
  { id: 'strip-1', sceneId: 'scene-1', sceneNumber: '1', shootingDayId: 'day-1', dayNumber: 1, sortOrder: 1, color: '#302a83', location: 'DOVRE - TUNNEL',          pages: 3,   cast: ['ARBEIDER 1', 'ARBEIDER 2', 'FORMANN'],               status: 'shot',          estimatedTime: 180 },
  { id: 'strip-2', sceneId: 'scene-2', sceneNumber: '2', shootingDayId: 'day-1', dayNumber: 1, sortOrder: 2, color: '#32127a', location: 'HULEN - INNE I FJELLET', pages: 2.5, cast: ['ARBEIDER 1', 'ARBEIDER 2'],                          status: 'shot',          estimatedTime: 120 },
  { id: 'strip-3', sceneId: 'scene-3', sceneNumber: '3', shootingDayId: 'day-2', dayNumber: 2, sortOrder: 1, color: '#302a83', location: 'DOVRE - FJELLET',          pages: 4,   cast: ['NORA TIDEMANN', 'ANDREAS'],                         status: 'shot',          estimatedTime: 240 },

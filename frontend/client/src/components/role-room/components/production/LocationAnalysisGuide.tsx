...
const DEFAULT_SECTION_ASSETS: Record<string, SectionAsset> = {
  'overview.0': {
    ...
    annotations: [
      ann('ao-title', 13, 6.1, 9.5, 3, 'Dialog', 'var(--role-cyan, #5d76cb)'),
      ann('ao-kpi-row', 12.4, 14.5, 75.7, 8.5, 'Analyse-KPI', '#5d76cb'),
  ...
  'overview.1': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ann('ao-presets', 14.2, 20.8, 12.2, 3.1, 'Preset-filter', 'var(--role-cyan, #5d76cb)'),
      ann('ao-ops-filter', 14.7, 23.6, 10.1, 3.1, 'Operasjonelt filter', '#5d76cb'),
  ...
  'score-filters.0': {
    ...
    annotations: [
      ...
      ann('sf-cost', 58.2, 14.8, 14.2, 6.8, 'Kost', 'var(--role-cyan, #5d76cb)'),
      ann('sf-actions', 73.4, 14.8, 14.2, 6.8, 'Tiltak', '#5d76cb'),
    ],
  },
  'score-filters.1': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ann('sf-op-filter-row', 14.6, 23.6, 15.2, 3.1, 'Klar / tiltak / risiko', 'var(--role-cyan, #5d76cb)'),
      ann('sf-tech-scout', 14.4, 20.9, 4.1, 2.5, 'Tech Scout', '#5d76cb'),
  ...
  'manual-edit.0': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ann('me-manual', 12.1, 31.8, 20.2, 3.3, 'Manuell kvalitetssikring', 'var(--role-cyan, #5d76cb)'),
  ...
  'manual-edit.1': {
    ...
    annotations: [
      ...
      ann('me-permit-section', 14.5, 42.2, 20.4, 3.1, 'Tillatelser og kontakter', '#5d76cb'),
    ],
  },
  'permits-contacts.0': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ann('pc-section', 14.5, 42.2, 20.4, 3.1, 'Kontaktmodul', 'var(--role-cyan, #5d76cb)'),
      ann('pc-dovre', 12.5, 60.5, 7.4, 2.1, 'Dovre kommune', '#34d399'),
      ann('pc-luftfart', 12.5, 79.9, 6.8, 2.1, 'Luftfartstilsynet', '#5d76cb'),
    ],
  },
  'permits-contacts.1': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ...
      ann('pc-status-select', 12.5, 69.7, 8.2, 3.1, 'Status', 'var(--role-cyan, #5d76cb)'),
      ann('pc-copy-template', 16.7, 73.1, 4.2, 2.5, 'Kopier mal', '#5d76cb'),
    ],
  },
  'permit-timeline.0': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ann('pt-planned-date', 12.7, 54, 5, 2, 'Planlagt opptaksdato', 'var(--role-cyan, #5d76cb)'),
      ann('pt-chip-public', 25, 54.8, 5.9, 2.8, 'Offentlig område', '#5d76cb'),
  ...
  'permit-timeline.1': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ann('pt-timeline', 57.2, 70.2, 30.4, 19.4, 'Fristlinje', 'var(--role-cyan, #5d76cb)'),
  ...
  'risk-fallback.1': {
    ...
    annotations: [
      ...
      ann('rf-permit-cards', 12.4, 0.2, 44.1, 42.4, 'Tillatelseskontakter', '#5d76cb'),
    ],
  },
  'technical-sections.0': {
    screenshotUrl: '/guide/location/analysis-technical.png',
    annotations: [
      ann('ts-photo', 15.1, 14.1, 7.1, 2.9, 'Fotografispotter', 'var(--role-cyan, #5d76cb)'),
  ...
  'technical-sections.1': {
    screenshotUrl: '/guide/location/analysis-technical.png',
    annotations: [
      ann('ts-max-height', 13, 55, 74, 4, 'Maks høyde', 'var(--role-cyan, #5d76cb)'),
      ann('ts-drone-allowed', 84.7, 43.5, 3.2, 2.3, 'Tillatt', '#34d399', 'top-right'),
      ann('ts-tech-card', 12.3, 39.8, 75.5, 20.6, 'Teknisk vurdering', '#5d76cb'),
    ],
  },
  'save-sync.0': {
    screenshotUrl: '/guide/location/analysis-top.png',
    annotations: [
      ...
      ann('ss-sync-pane', 14.5, 42.2, 73.4, 47.2, 'Data synkes tilbake til lokasjon', 'var(--role-cyan, #5d76cb)'),
    ],
  },
  'save-sync.1': {
    screenshotUrl: '/guide/location/analysis-technical.png',
    annotations: [
      ann('ss-close', 83.4, 89.2, 5.6, 4.2, 'Lukk / fullfør', '#5d76cb', 'top-right'),
      ann('ss-check', 12.3, 12.8, 75.6, 74.6, 'Kjør kvalitetssjekk før lagring', 'var(--role-cyan, #5d76cb)'),
    ],
  },
};

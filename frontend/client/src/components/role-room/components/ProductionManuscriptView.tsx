          ...
          <Box sx={{ flex: 1, overflow: 'auto', p: isMobile ? 1.5 : 4, '&::-webkit-scrollbar': { width: 8 }, '&::-webkit-scrollbar-thumb': { bgcolor: '#374151', borderRadius: 4 } }}>
            {selectedScene ? (
              <Box sx={{ 
                ...
                <Box sx={{
                  p: isMobile ? 2 : 3,
                  background: 'linear-gradient(135deg, rgba(59,130,246,0.15) 0%, rgba(93, 118, 203,0.1) 100%)',
                ...
                <Stack spacing={2} sx={{ px: 2, pb: 2.5, pt: 1 }}>
                  ...
                  <Box sx={{
                    ...
                    <Stack direction="row" spacing={2} alignItems="center" justifyContent="space-between">
                      <Typography sx={{ fontSize: 11, color: '#9ca3af' }}>
                        <span style={{ color: '#60a5fa', fontWeight: 600 }}>{shotProperties.camera}</span> + <span style={{ color: '#93a4dc' }}>{shotProperties.lens}</span>
                      </Typography>

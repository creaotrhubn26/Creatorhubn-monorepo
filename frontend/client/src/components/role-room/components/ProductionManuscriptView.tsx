...
export const ProductionManuscriptView: FC<ProductionManuscriptViewProps> = ({
  ...
  }, [projectId, workflowUI.view.tab, workflowUI.selectedDayId, workflowUI]);
  ...
  }, [readThroughMode, readThroughPlaying, readThroughCurrentLine, allDialogue, ttsEnabled, ttsVoice, ttsLanguage, ttsSpeed, ttsUseCharacterVoices, ttsCharacterVoices, readThroughAnalysis.lineHintsById, readThroughAnalysis.voiceCastingByCharacter, ttsPlayingRef, setReadThroughCurrentLine, setReadThroughPlaying, handleReadThroughNext]);
  ...
  }, [getSceneMetadata, selectedScene, selectedScene.id, selectedShot]); // Only run when scene ID changes
  ...
  }, [inspectorUI.dirty, selectedShotId, shotMetadata, shotProperties]);
  ...
  }, [handleManuscriptFullscreen, handleManuscriptZoomIn, handleManuscriptZoomOut, handleManuscriptZoomReset, isManuscriptFullscreen, projectId]);
  ...
  }, [onSceneUpdate, projectId, projectStoryboardLibraryItems, selectedShot, setShotLists, shotLists]);
  ...
  }, [selectedScene, setShotLists, debouncedPersistShotList, projectId]);
  ...
  }, [selectedScenes, onSceneDelete, scenes, setSelectedScenes, setBatchMode, pushPatch]);

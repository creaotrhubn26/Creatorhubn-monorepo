/**
 * B2ArchiveTab (Role Room) — Admin Room tab for The Role Room sin B2-bucket
 * (the-role-room-prod). Snakker mot /api/role-room/admin/b2-archive/*.
 *
 * NB: dette er The Role Room sin bucket, ikke Creatorhub AS' selskap-bucket.
 * Selskap-bucketen ligger i components/admin/B2ArchiveTab.tsx (Creatorhub
 * AdminDashboard). Begge er gated via produkteier-email-check + backend
 * requireAdminSession.
 */
    ...
    <Stack spacing={2}>
      ...
      <Stack direction="row" spacing={1.5} alignItems="center" sx={{ flexWrap: 'wrap' }}>
        <TextField
          size="small"
          label="Prefiks"
          placeholder="produksjon-XYZ/ eller la stå tom"
          value={prefix}
                ...
                <TableRow key={file.key}>
                  ...
                  <TableCell align="right">
                    <Tooltip title="Last ned">
                      <IconButton size="small" onClick={() => void handleDownload(file.key)} sx={{ color: '#9d97ee' }}>

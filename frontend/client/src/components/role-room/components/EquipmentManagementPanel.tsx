...
const ROLE_ROOM_DIALOG_ACCENTS: Record<RoleRoomDialogAccent, {
  ...
  primary: {
    headerGradient: 'linear-gradient(135deg, rgba(75, 61, 143,0.15) 0%, rgba(62, 49, 128,0.1) 100%)',
    iconGradient: 'linear-gradient(135deg, #4b3d8f 0%, #3e3180 100%)',
    iconBorder: '1px solid rgba(224, 219, 250,0.34)',
    iconShadow: '0 8px 20px rgba(75, 61, 143,0.3)',
  },
  info: {
  ...
  warning: {
    headerGradient: 'linear-gradient(135deg, rgba(75, 61, 143,0.15) 0%, rgba(245,124,0,0.1) 100%)',
    iconGradient: 'linear-gradient(135deg, #4b3d8f 0%, #3e3180 100%)',
  ...
  violet: {
    headerGradient: 'linear-gradient(135deg, rgba(50, 18, 122,0.15) 0%, rgba(50, 18, 122,0.1) 100%)',
    iconGradient: 'linear-gradient(135deg, #32127a 0%, #302a83 100%)',
    iconBorder: '1px solid rgba(224, 219, 250,0.32)',
    iconShadow: '0 8px 20px rgba(50, 18, 122,0.3)',
  },
  teal: {
...
export function EquipmentManagementPanel({
  ...
  return (
    <Box sx={{ p: containerPadding }}>
      {loading && <LinearProgress sx={{ mb: 2, bgcolor: 'rgba(75, 61, 143,0.1)', '& .MuiLinearProgress-bar': { bgcolor: '#4b3d8f' } }} />}
      ...
      <Box sx={{ 
        ...
        p: 2,
        borderRadius: 3,
        background: 'linear-gradient(135deg, rgba(75, 61, 143,0.15) 0%, rgba(62, 49, 128,0.1) 100%)',
        border: '1px solid rgba(75, 61, 143,0.2)',
      }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
          <Box sx={{
            ...
            height: 48,
            borderRadius: 2,
            background: 'linear-gradient(135deg, #4b3d8f 0%, #3e3180 100%)',
            display: 'flex',
            alignItems: 'center',
            justifyContent: 'center',
            boxShadow: '0 4px 12px rgba(75, 61, 143,0.3)',
          }}>
        ...
        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
          <Button
            ...
            sx={{
              ...
              bgcolor: workspaceView === 'standard' ? 'rgba(75, 61, 143,0.24)' : 'transparent',
              color: '#fff',
              borderColor: workspaceView === 'standard' ? '#93a4dc' : 'rgba(255,255,255,0.2)',
              '&:hover': {
                bgcolor: workspaceView === 'standard' ? 'rgba(75, 61, 143,0.3)' : 'rgba(255,255,255,0.08)',
                borderColor: '#93a4dc',
              },
              ...focusVisibleStyles,
            }}
          ...
          <Button
            ...
            sx={{
              minHeight: TOUCH_TARGET_SIZE,
              bgcolor: workspaceView === 'pro' ? 'rgba(75, 61, 143,0.24)' : 'transparent',
              color: '#fff',
              borderColor: workspaceView === 'pro' ? '#93a4dc' : 'rgba(255,255,255,0.2)',
              '&:hover': {
                bgcolor: workspaceView === 'pro' ? 'rgba(75, 61, 143,0.3)' : 'rgba(255,255,255,0.08)',
                borderColor: '#93a4dc',
              },
              ...focusVisibleStyles,
            }}
          ...
          <Tooltip title="Filtrer">
            <IconButton
              ...
              sx={{ 
                ...
                minWidth: TOUCH_TARGET_SIZE, 
                minHeight: TOUCH_TARGET_SIZE,
                bgcolor: filterOpen ? 'rgba(75, 61, 143,0.2)' : 'rgba(255,255,255,0.05)',
                '&:hover': { bgcolor: 'rgba(75, 61, 143,0.2)' },
              }}
            >
              <FilterIcon sx={{ color: filterOpen ? '#4b3d8f' : 'inherit' }} />
            </IconButton>
          </Tooltip>
          ...
          <Button
            ...
            sx={{
              ...
              boxShadow: '0 4px 12px rgba(75, 61, 143,0.3)',
              '&:hover': { 
                background: 'linear-gradient(135deg, #93a4dc 0%, #5d76cb 100%)',
          ...
          <Tooltip title="Bla i produsent-katalog og importer utstyr til prosjektet">
            <Button
              ...
              sx={{
                ...
                color: '#4b3d8f',
                minHeight: TOUCH_TARGET_SIZE,
                '&:hover': { borderColor: '#93a4dc', bgcolor: 'rgba(75, 61, 143,0.1)' },
                ...focusVisibleStyles,
              }}
            >
              Katalog
          ...
          <Tooltip title="Lagerstyring, reservasjoner og flyt mellom lagernoder">
            <Button
              ...
              sx={{
                borderColor: warehouseIssueCount > 0 ? '#ef5350' : '#93a4dc',
          ...
          <Tooltip title="Rapporter">
            <Button
              ...
              sx={{
                ...
                color: '#32127a',
                minHeight: TOUCH_TARGET_SIZE,
                '&:hover': { borderColor: '#4b3d8f', bgcolor: 'rgba(50, 18, 122,0.1)' },
                ...focusVisibleStyles,
              }}
            >
              Rapporter
          ...
          {offlineQueueCount > 0 && (
            <Tooltip title={isOnline ? `${offlineQueueCount} ventende operasjoner — klikk for å synkronisere` : `Offline — ${offlineQueueCount} operasjoner i kø`}>
              <Button
                ...
                sx={{
                  borderColor: isOnline ? '#4b3d8f' : '#f44336',
                  color: isOnline ? '#4b3d8f' : '#f44336',
                  minHeight: TOUCH_TARGET_SIZE,
                  ...
                  '&:hover': { bgcolor: isOnline ? 'rgba(75, 61, 143,0.1)' : 'rgba(244,67,54,0.1)' },
                  ...focusVisibleStyles,
                }}
              >
          ...
          <Tooltip title="Kjøp utstyr via foto.no">
            <Button
              ...
              sx={{
                ...
                color: '#93a4dc',
                minHeight: TOUCH_TARGET_SIZE,
                '&:hover': { borderColor: '#93a4dc', bgcolor: 'rgba(75, 61, 143,0.14)' },
                ...focusVisibleStyles,
              }}
            >
              Kjøp
        ...
        {selectedEquipmentIds.size > 0 && (
          <Box sx={{ 
            ...
            <Button
              ...
              sx={{ color: '#4b3d8f', '&:hover': { bgcolor: 'rgba(75, 61, 143,0.15)' } }}
            >
              Endre status
            </Button>
            <Button
                ...
                return (
                  <Button
                    ...
                    sx={{
                      minHeight: 32,
                      textTransform: 'none',
                      bgcolor: active ? 'rgba(75, 61, 143,0.3)' : 'transparent',
                      borderColor: active ? '#93a4dc' : 'rgba(148,163,184,0.35)',
                      color: '#fff',
                      '&:hover': {
                        bgcolor: active ? 'rgba(75, 61, 143,0.38)' : 'rgba(148,163,184,0.12)',
                        borderColor: '#93a4dc',
                      },
                    }}
                  >
          ...
          {showProOverview && (
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
              {[
                ...
                { label: 'Synlig nå', value: `${equipmentProInsights.visibleRatio}%`, color: '#93a4dc' },
                { label: 'Kamera-kategorier', value: equipmentProInsights.cameraCategoryCount, color: '#93a4dc' },
              ].map((item) => (
                <Box
                  key={item.label}
                  sx={{
            ...
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
              ...
              <Button
                ...
                sx={{
                  ...
                  justifyContent: 'space-between',
                  textTransform: 'none',
                  borderColor: equipmentProInsights.offlineQueue > 0 ? 'rgba(75, 61, 143,0.65)' : 'rgba(148,163,184,0.35)',
                  color: '#fff',
                  bgcolor: equipmentProInsights.offlineQueue > 0 ? 'rgba(75, 61, 143,0.12)' : 'rgba(148,163,184,0.08)',
                }}
              >
      ...
      {equipment.length > 0 && (() => {
        ...
        return (
          <Box sx={{ mb: 2, px: 1 }}>
            <RoleStatPillRow
              pills={[
                { icon: <Inventory2Icon />, count: totalItems, label: 'Totalt utstyr', color: '#93a4dc' },
        ...
        <Box sx={{
          ...
          <Tooltip title={sidebarOpen ? 'Skjul kategoriliste' : 'Vis kategoriliste'}>
            <IconButton
              ...
              sx={{
                color: sidebarOpen ? '#4b3d8f' : 'rgba(255,255,255,0.5)',
                bgcolor: sidebarOpen ? 'rgba(75, 61, 143,0.12)' : 'transparent',
                '&:hover': { bgcolor: 'rgba(75, 61, 143,0.15)' },
                borderRadius: 1,
                p: 0.5,
              }}
            >
          ...
          <Box sx={{
            ...
            <Box
              ...
              sx={{
                ...
                borderRadius: 1.5,
                cursor: 'pointer',
                bgcolor: categoryFilter === 'all' ? 'rgba(75, 61, 143,0.18)' : 'transparent',
                '&:hover': { bgcolor: 'rgba(75, 61, 143,0.1)' },
                transition: 'background 0.15s',
              }}
            >
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                <BuildIcon sx={{ fontSize: 15, color: categoryFilter === 'all' ? '#4b3d8f' : 'rgba(255,255,255,0.5)' }} />
                <Typography variant="body2" sx={{ color: categoryFilter === 'all' ? '#93a4dc' : 'rgba(255,255,255,0.8)', fontWeight: categoryFilter === 'all' ? 700 : 400, fontSize: '0.82rem' }}>
                  Alle
                </Typography>
              </Box>
                ...
                <Box key={cat}>
                  <Box
                    ...
                    sx={{
                      ...
                      borderRadius: 1.5,
                      cursor: 'pointer',
                      bgcolor: isActive ? 'rgba(75, 61, 143,0.18)' : 'transparent',
                      '&:hover': { bgcolor: 'rgba(75, 61, 143,0.1)' },
                      transition: 'background 0.15s',
                    }}
                  >
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      ...
                      <Typography variant="body2" sx={{ color: isActive ? '#93a4dc' : 'rgba(255,255,255,0.8)', fontWeight: isActive ? 700 : 400, fontSize: '0.82rem' }}>
                        {cat}
                      </Typography>
                    </Box>
                    <Typography variant="caption" sx={{ color: isActive ? '#93a4dc' : 'rgba(255,255,255,0.35)', fontSize: '0.72rem', fontWeight: isActive ? 700 : 400 }}>
                      {count}
                    </Typography>
                  </Box>
            ...
            >
              ...
              {locations.map((loc) => (
                <MenuItem key={loc.id} value={loc.id}>
                  <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                    <LocationIcon sx={{ fontSize: 14, color: 'rgba(75, 61, 143,0.7)' }} />
                    {loc.name}
                  </Box>
                </MenuItem>
              ))}
        ...
        <Box sx={{ display: 'flex', gap: 0.75, mb: 2, flexWrap: 'wrap', alignItems: 'center' }}>
          {searchQuery && (
            <Chip
              ...
              sx={{ bgcolor: 'rgba(75, 61, 143,0.15)', color: '#93a4dc', borderColor: 'rgba(75, 61, 143,0.3)', border: '1px solid' }}
            />
          )}
          {categoryFilter !== 'all' && (
            <Chip
          ...
          {statusFilter !== 'all' && (
            <Chip
              ...
              sx={{ bgcolor: `${STATUS_COLORS[statusFilter as keyof typeof STATUS_COLORS] ?? '#4b3d8f'}20`, color: STATUS_COLORS[statusFilter as keyof typeof STATUS_COLORS] ?? '#93a4dc', border: `1px solid ${STATUS_COLORS[statusFilter as keyof typeof STATUS_COLORS] ?? '#4b3d8f'}40` }}
            />
          )}
          <Chip
            label="Nullstill"
      ...
      {viewMode === 'grid' ? (
          ...
          {filteredEquipment.length === 0 ? (
            ...
            pagedEquipment.map((eq, index) => {
              ...
              <Card sx={{
                ...
                position: 'relative',
                '&:hover': {
                  borderColor: selectedEquipmentIds.has(eq.id) ? '#93a4dc' : 'rgba(75, 61, 143,0.5)',
                  transform: 'translateY(-4px)',
                  boxShadow: '0 12px 40px rgba(0,0,0,0.4), 0 0 0 1px rgba(75, 61, 143,0.2)',
                },
              }}>
                {/* Selection checkbox */}
                <Box sx={{
                  ...
                  <IconButton
                    ...
                    sx={{
                      bgcolor: selectedEquipmentIds.has(eq.id) ? '#4b3d8f' : 'rgba(0,0,0,0.5)',
                      backdropFilter: 'blur(4px)',
                      '&:hover': { bgcolor: selectedEquipmentIds.has(eq.id) ? '#93a4dc' : 'rgba(0,0,0,0.7)' },
                    }}
                  >
                    ...
                    <Tooltip title="Bookinger">
                      <IconButton
                        ...
                        sx={{ 
                          ...focusVisibleStyles, 
                          color: 'rgba(255,255,255,0.87)',
                          '&:hover': { color: '#4b3d8f', bgcolor: 'rgba(75, 61, 143,0.1)' },
                        }}
                      >
                    ...
                    <Tooltip title="QR-kode">
                      <IconButton
                        ...
                        sx={{ 
                          ...focusVisibleStyles, 
                          color: 'rgba(255,255,255,0.87)',
                          '&:hover': { color: '#32127a', bgcolor: 'rgba(50, 18, 122,0.1)' },
                        }}
                      >
                    ...
                    <Tooltip title="Historikk">
                      <IconButton
                        ...
                        sx={{ 
                          ...focusVisibleStyles, 
                          color: 'rgba(255,255,255,0.87)',
                          '&:hover': { color: '#3e3180', bgcolor: 'rgba(62, 49, 128,0.1)' },
                        }}
                      >
        ...
        <TableContainer component={Paper} sx={{ 
          ...
          <Table>
            <TableHead>
              <TableRow sx={{ 
                background: 'linear-gradient(135deg, rgba(75, 61, 143,0.1) 0%, rgba(62, 49, 128,0.05) 100%)',
              }}>
                <TableCell sx={{ color: '#fff', fontWeight: 700, borderBottom: '1px solid rgba(148,163,184,0.22)' }}>
                  <TableSortLabel
                    ...
                    sx={{ color: '#fff', '&.Mui-active': { color: '#4b3d8f' }, '& .MuiTableSortLabel-icon': { color: '#4b3d8f !important' } }}
                  >
                    Navn
                  </TableSortLabel>
                </TableCell>
            ...
            <TableBody>
              {pagedEquipment.map((eq) => {
                ...
                <TableRow 
                  ...
                  sx={{ 
                    transition: 'all 0.2s',
                    '&:hover': { bgcolor: 'rgba(75, 61, 143,0.05)' },
                  ...
                  p === 'ellipsis' ? (
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        height: 32,
                        px: 1,
                        bgcolor: safePage === p ? '#4b3d8f' : 'transparent',
                        color: safePage === p ? '#fff' : 'rgba(255,255,255,0.7)',
                        fontWeight: safePage === p ? 700 : 500,
                        '&:hover': { bgcolor: safePage === p ? '#5d76cb' : 'rgba(75, 61, 143,0.18)' },
                      }}
                    >
                      {p}
                    </Button>
          ...
          >
            ...
            >
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 1.25 }}>
                ...
                >
                  <BuildIcon sx={{ color: '#93a4dc', fontSize: 24 }} />
                </Box>
            ...
            <Button
              ...
              sx={{
                ...
                minHeight: 170,
                borderRadius: 2.5,
                borderColor: 'rgba(147, 164, 220,0.35)',
                color: '#fff',
                textTransform: 'none',
                alignItems: 'flex-start',
                justifyContent: 'flex-start',
            ...
            >
              <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-start', gap: 1.25 }}>
                ...
                >
                  <PropsIcon sx={{ color: '#93a4dc', fontSize: 24 }} />
                </Box>
                <Typography sx={{ fontWeight: 700, fontSize: '1rem', color: '#fff' }}>
                  Rekvisitter
                </Typography>
          ...
          >
              ...
              <TextField
                ...
                sx={{ 
                  '& .MuiOutlinedInput-root': { 
                    ...
                    '&:hover fieldset': { borderColor: formErrors.name ? '#f44336' : 'rgba(75, 61, 143,0.3)' },
                    '&.Mui-focused fieldset': { borderColor: formErrors.name ? '#f44336' : '#4b3d8f' },
                  },
            ...
            {isCameraCategorySelected && cameraSuggestionMatches.length > 0 && (
              <Box sx={{ gridColumn: '1 / -1' }}>
                ...
                >
                  <Typography variant="subtitle2" sx={{ color: '#dfe4f3', fontWeight: 700, mb: 1 }}>
              ...
              <TextField
                ...
                sx={{ 
                  '& .MuiOutlinedInput-root': { 
                    ...
                    '&:hover fieldset': { borderColor: formErrors.serialNumber ? '#f44336' : 'rgba(75, 61, 143,0.3)' },
                    '&.Mui-focused fieldset': { borderColor: formErrors.serialNumber ? '#f44336' : '#4b3d8f' },
                  },
            ...
            <Box sx={{ gridColumn: '1 / -1' }}>
              <Box 
                ...
                sx={{ 
                  p: 2, 
                  borderRadius: 2, 
                  bgcolor: isDragging ? 'rgba(75, 61, 143,0.1)' : 'rgba(0,0,0,0.2)',
                  border: isDragging ? '2px dashed #4b3d8f' : '1px solid rgba(255,255,255,0.08)',
                  transition: 'all 0.2s',
                }}
              >
                <Typography variant="subtitle2" sx={{ color: 'rgba(255,255,255,0.8)', mb: 1.5, fontWeight: 600, display: 'flex', alignItems: 'center', gap: 1 }}>
                  Utstyrsbilde
                  {isDragging && <Chip label="Slipp bildet her!" size="small" sx={{ bgcolor: '#4b3d8f', color: '#fff', fontSize: '0.7rem' }} />}
                </Typography>
                <Box
                  sx={{
                    display: 'grid',
                ...
                >
                  ...
                  <Box sx={{
                    ...
                    borderRadius: 2,
                    border: isDragging ? '2px solid #4b3d8f' : '2px dashed rgba(255,255,255,0.15)',
                    display: 'flex',
                    alignItems: 'center',
                    justifyContent: 'center',
                    overflow: 'hidden',
                    ...
                    transition: 'all 0.2s',
                    '&:hover': {
                      borderColor: 'rgba(75, 61, 143,0.3)',
                    },
                  }}>
                    {formData.imageUrl ? (
                      <img
                  ...
                  >
                    <Button
                      ...
                      sx={{ 
                        ...
                        justifyContent: 'flex-start',
                        minHeight: TOUCH_TARGET_SIZE,
                        '&:hover': { borderColor: '#4b3d8f', bgcolor: 'rgba(75, 61, 143,0.1)' },
                      }}
                    >
                      Søk bilder
                    </Button>
                          ...
                          <Tooltip key={img.id} title={img.description} placement="top">
                            <Box
                              ...
                              sx={{
                                ...
                                cursor: 'pointer',
                                flexShrink: 0,
                                border: formData.imageUrl === img.url ? '2px solid #4b3d8f' : '1px solid rgba(255,255,255,0.15)',
                              }}
                            />
                          </Tooltip>
                        ))}
        ...
        <DialogActions sx={{ 
          ...
          <Button
            ...
            sx={{
              ...
              borderRadius: 2,
              px: 4,
              boxShadow: '0 4px 14px rgba(75, 61, 143,0.3)',
              '&:hover': { 
                background: 'linear-gradient(135deg, #93a4dc 0%, #4b3d8f 100%)',
                boxShadow: '0 6px 20px rgba(75, 61, 143,0.4)',
              },
              ...focusVisibleStyles,
            }}
          >
          ...
          {bookings.length === 0 && availability.length === 0 ? (
            ...
            <Stack spacing={2}>
                ...
                <Box key={booking.id} sx={{ 
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Chip
                      ...
                      size="small"
                      sx={{ 
                        bgcolor: booking.status === 'confirmed' ? '#4caf50' : '#4b3d8f',
                        color: '#fff',
                        fontWeight: 600,
                        borderRadius: 1.5,
                      }}
              ...
              {availability.map(avail => (
                <Box key={avail.id} sx={{ 
                  p: 2.5, 
                  bgcolor: avail.status === 'service' ? 'rgba(75, 61, 143, 0.08)' : 'rgba(244, 67, 54, 0.08)', 
                  borderRadius: 2,
                  border: `1px solid ${avail.status === 'service' ? 'rgba(75, 61, 143, 0.2)' : 'rgba(244, 67, 54, 0.2)'}`,
                  transition: 'all 0.2s',
                  '&:hover': { 
                    bgcolor: avail.status === 'service' ? 'rgba(75, 61, 143, 0.12)' : 'rgba(244, 67, 54, 0.12)',
                  },
                }}>
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                      {avail.status === 'service' ? (
                        <WarningIcon sx={{ color: '#4b3d8f' }} />
                      ) : (
                    ...
                    <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 1 }}>
                      <Box>
                        <Typography variant="h6" sx={{ color: '#fff', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 1 }}>
                          ...
                          {template.name}
                          {template.is_default && (
                            <StarIcon sx={{ color: '#4b3d8f', fontSize: 18 }} />
                          )}
                        </Typography>
      ...
      >
        ...
        <DialogContent sx={{ mt: 2, px: 3 }}>
          <Box sx={{ 
            textAlign: 'center', 
            py: 5,
            background: 'linear-gradient(135deg, rgba(75, 61, 143,0.08) 0%, rgba(75, 61, 143,0.03) 100%)',
            borderRadius: 2,
            border: '1px solid rgba(75, 61, 143,0.15)',
          }}>
            <Box sx={{
              width: 80,
              height: 80,
              ...
              <ShoppingCartIcon sx={{ fontSize: 40, color: '#4b3d8f' }} />
            </Box>
          ...
          {effectiveVendorCategories.length > 0 && (
            <Box sx={{ mt: 3, display: 'flex', gap: 1, flexWrap: 'wrap' }}>
              <Chip
                ...
                sx={{
                  bgcolor: selectedVendorCategory === 'all' ? '#4b3d8f' : 'rgba(75, 61, 143,0.12)',
                  color: selectedVendorCategory === 'all' ? '#fff' : '#4b3d8f',
                  fontWeight: selectedVendorCategory === 'all' ? 700 : 400,
                  cursor: 'pointer',
                  '&:hover': { bgcolor: selectedVendorCategory === 'all' ? '#3e3180' : 'rgba(75, 61, 143,0.25)' },
                }}
              />
              {effectiveVendorCategories.map(vc => (
                <Chip
                  ...
                  sx={{
                    bgcolor: selectedVendorCategory === vc.category ? '#4b3d8f' : 'rgba(75, 61, 143,0.12)',
                    color: selectedVendorCategory === vc.category ? '#fff' : '#4b3d8f',
                    fontWeight: selectedVendorCategory === vc.category ? 700 : 400,
                    cursor: 'pointer',
                    '&:hover': { bgcolor: selectedVendorCategory === vc.category ? '#3e3180' : 'rgba(75, 61, 143,0.25)' },
                  }}
                />
              ))}
            </Box>
                      ...
                      >
                        <CardContent>
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 1 }}>
                            <Chip label={link.category} size="small" sx={{ bgcolor: 'rgba(75, 61, 143,0.2)', color: '#4b3d8f' }} />
                            <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)' }}>
                              {link.vendor_name}
                            </Typography>
          ...
          <Tabs
            ...
            sx={{
              ...
              '& .MuiTab-root.Mui-selected': {
                color: '#dfe4f3',
                borderColor: 'rgba(147, 164, 220,0.42)',
          ...
          <Box sx={{ p: 2 }}>
            ...
            {imagePickerTab === 2 && (
              <Stack spacing={2} sx={{ mt: 1 }}>
                ...
                <Button
                  ...
                  sx={{ bgcolor: '#4b3d8f', color: '#fff', '&:hover': { bgcolor: '#3e3180' }, alignSelf: 'flex-start' }}
                >
                  Bruk bilde
                </Button>
              </Stack>
            ...
            {imageSearchLoading ? (
              <Box sx={{ display: 'flex', justifyContent: 'center', py: 4, flexDirection: 'column', alignItems: 'center', gap: 2 }}>
                <CircularProgress sx={{ color: '#4b3d8f' }} />
                <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.87)' }}>
                ...
                <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 1.5 }}>
                  ...
                  <Box sx={{ display: 'flex', gap: 0.5, flexWrap: 'wrap' }}>
                    {[
                      ...
                      { name: 'openverse', color: '#32127a', label: 'Openverse' },
                      { name: 'wikimedia', color: '#3e85ba', label: 'Wikimedia' },
                      { name: 'shotcafe', color: '#4b3d8f', label: 'shot.cafe' },
                          ...
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                            <Typography variant="caption" sx={{ 
                              ...
                              bgcolor: 
                                ...
                                img.source === 'openverse' ? 'rgba(50, 18, 122,0.4)' :
                                img.source === 'wikimedia' ? 'rgba(62,133,186,0.4)' :
                                img.source === 'shotcafe' ? 'rgba(75, 61, 143,0.4)' :
      ...
      >
        ...
        <DialogActions sx={{ borderTop: '1px solid rgba(148,163,184,0.22)', p: 2.5, gap: 1 }}>
          ...
          <Button
            ...
            variant="contained"
            sx={{ 
              bgcolor: bulkActionType === 'delete' ? '#f44336' : '#4b3d8f',
              '&:hover': { bgcolor: bulkActionType === 'delete' ? '#d32f2f' : '#3e3180' },
            }}
          >
            Bekreft
          </Button>
          ...
          <Stack spacing={3}>
            ...
            {!conflictChecking && bookingConflicts.length > 0 && (
              <Box sx={{
                ...
                <WarningIcon sx={{ color: '#4b3d8f', mt: 0.25, flexShrink: 0 }} />
                <Box>
                  <Typography variant="body2" sx={{ color: '#93a4dc', fontWeight: 600 }}>
        ...
        <DialogContent sx={{ pt: 2 }}>
          <Stack spacing={2.5}>
            ...
            <TextField label="Formål" value={checkoutForm.purpose} onChange={(e) => setCheckoutForm(f => ({ ...f, purpose: e.target.value }))} fullWidth
              sx={{ '& .MuiOutlinedInput-root': { bgcolor: 'rgba(255,255,255,0.05)', '& fieldset': { borderColor: 'rgba(255,255,255,0.2)' } }, '& .MuiInputLabel-root': { color: 'rgba(255,255,255,0.87)' } }} />
            {!isOnline && (
              <Box sx={{ p: 1.5, borderRadius: 2, bgcolor: 'rgba(75, 61, 143,0.1)', border: '1px solid rgba(75, 61, 143,0.3)', display: 'flex', gap: 1, alignItems: 'center' }}>
                <OfflineIcon sx={{ color: '#4b3d8f', fontSize: 18 }} />
                <Typography variant="caption" sx={{ color: '#93a4dc' }}>Du er offline — operasjonen lagres i kø og synkroniseres automatisk</Typography>
              </Box>
            )}
          </Stack>
        </DialogContent>
      ...
      >
          ...
          <Tabs
            ...
            sx={{
              ...
              '& .MuiTab-root': {
                ...
                '&.Mui-selected': {
                  color: '#dfe4f3',
                  borderColor: 'rgba(147, 164, 220,0.48)',
                  bgcolor: 'rgba(75, 61, 143,0.24)',
                  boxShadow: '0 8px 22px rgba(75, 61, 143,0.24)',
                },
              },
            }}
          >
        ...
        <DialogActions sx={{ px: { xs: 2, sm: 3 }, py: 2.25, borderTop: '1px solid rgba(148,163,184,0.2)', gap: 1 }}>
          <Button onClick={() => setReportsDialogOpen(false)} variant="outlined" sx={{ borderColor: 'rgba(148,163,184,0.46)', color: 'rgba(226,232,240,0.88)', '&:hover': { borderColor: 'rgba(147, 164, 220,0.62)', bgcolor: 'rgba(75, 61, 143,0.12)' } }}>Lukk</Button>
          <Button
            ...
            <Box sx={{ maxHeight: 300, overflowY: 'auto' }}>
              {offlineQueue.map(e => (
                <Box key={e.id} sx={{ display: 'flex', alignItems: 'center', gap: 2, py: 1.5, borderBottom: '1px solid rgba(148,163,184,0.16)' }}>
                  ...
                  <Chip label="Venter" size="small" sx={{ bgcolor: 'rgba(75, 61, 143,0.15)', color: '#93a4dc' }} />
                </Box>
              ))}
            </Box>
          )}
      ...
      >
          ...
          <Tabs
            ...
            sx={{
              ...
              '& .MuiTab-root.Mui-selected': {
                ...
                borderColor: 'rgba(147, 164, 220,0.48)',
                bgcolor: 'rgba(75, 61, 143,0.24)',
                boxShadow: '0 8px 20px rgba(75, 61, 143,0.22)',
              },
            }}
          >
        ...
        <DialogContent sx={{ p: 0, overflow: 'auto', bgcolor: 'transparent' }}>
                      ...
                      <Card sx={CATALOG_BRIDGE_CARD_SX}>
                        <CardContent sx={{ flexGrow: 1 }}>
                          <Box sx={{ display: 'flex', gap: 0.5, mb: 1.5, flexWrap: 'wrap' }}>
                            {article.category && <Chip label={article.category} size="small" sx={{ bgcolor: 'rgba(75, 61, 143,0.2)', color: '#93a4dc', fontSize: '0.7rem' }} />}
                          ...
                          {article.rating !== undefined && (
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, mt: 1 }}>
                              <Rating value={article.rating / 2} precision={0.5} size="small" readOnly sx={{ '& .MuiRating-iconFilled': { color: '#4b3d8f' } }} />
                        ...
                        <Box sx={{ p: 1.5, pt: 0, display: 'flex', justifyContent: 'flex-end' }}>
                          {article.url && (
                            <IconButton size="small" href={article.url} target="_blank" rel="noopener noreferrer" aria-label={`Åpne artikkel ${article.title ?? article.url}`} sx={{ color: '#4b3d8f' }}>
              ...
              {marketPricesLoading ? (
                ...
                <>
                  ...
                  <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: CATALOG_BRIDGE_CARD_GAP, mb: 3 }}>
                    ...
                    <Box sx={{ width: { xs: '100%', sm: 'calc(33.333% - 11px)' }, minWidth: 0 }}>
                      <Paper sx={{ ...CATALOG_BRIDGE_SURFACE_SX, borderColor: 'rgba(75, 61, 143,0.35)' }}>
                        <AttachMoneyIcon sx={{ color: '#4b3d8f', mb: 1 }} />
                        ...
                        <Card sx={CATALOG_BRIDGE_CARD_SX}>
                          ...
                          <Box sx={{ p: 1.5, pt: 0, display: 'flex', gap: 1 }}>
                            ...
                            <Button size="small" variant="outlined" startIcon={<AddIcon />} onClick={() => handleImportFromMarket(item)}
                              sx={{ ml: 'auto', borderColor: '#4b3d8f', color: '#4b3d8f', fontSize: '0.75rem', '&:hover': { bgcolor: 'rgba(75, 61, 143,0.1)' } }}>
                              Importer
                            </Button>
                          </Box>
                        </Card>
          ...
          {catalogDialogTab === 3 && (
            <Box sx={CATALOG_BRIDGE_TAB_PANEL_SX}>
              <Typography variant="h5" sx={{ fontWeight: 700, color: '#fff', mb: 3, display: 'flex', alignItems: 'center', gap: 1 }}>
                <PhotoLibraryIcon sx={{ color: '#4b3d8f' }} />
                Objektiv Database
              </Typography>
              {lensDbLoading ? (
                <Box sx={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: 2, py: 6 }}>
                      ...
                      <Card sx={CATALOG_BRIDGE_CARD_SX}>
                        <CardContent sx={{ flexGrow: 1 }}>
                          ...
                          <Box sx={{ display: 'flex', gap: 0.5, mb: 1.5, flexWrap: 'wrap' }}>
                            {lens.focalLength && lens.aperture && (
                              <Chip label={`${lens.focalLength} ${lens.aperture}`} size="small" sx={{ bgcolor: 'rgba(75, 61, 143,0.2)', color: '#93a4dc', fontWeight: 600, fontSize: '0.72rem' }} />
                            )}
                          ...
                          <Stack spacing={0.75}>
                            ...
                            {lens.currentPrice && (
                              <Box sx={{ display: 'flex', justifyContent: 'space-between' }}>
                                <Typography variant="caption" sx={{ color: 'rgba(255,255,255,0.5)' }}>Pris:</Typography>
                                <Typography variant="body2" sx={{ fontWeight: 700, color: '#4b3d8f' }}>
                        ...
                        <Box sx={{ p: 1.5, pt: 0 }}>
                          <Button size="small" fullWidth variant="outlined" startIcon={<AddIcon />} onClick={() => handleImportFromLens(lens)}
                            sx={{ borderColor: '#4b3d8f', color: '#4b3d8f', fontSize: '0.75rem', '&:hover': { bgcolor: 'rgba(75, 61, 143,0.1)' } }}>
                            Legg til i prosjekt
                          </Button>
                        </Box>
                      </Card>
            ...
            <Box sx={CATALOG_BRIDGE_TAB_PANEL_SX}>
              <Box sx={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: 1.5, mb: 2.5 }}>
                <Typography variant="h5" sx={{ fontWeight: 700, color: '#fff', display: 'flex', alignItems: 'center', gap: 1 }}>
                  <Inventory2Icon sx={{ color: '#93a4dc' }} />
                  Kamera + Minnekort
                </Typography>
                <Button
                  variant="outlined"
                  onClick={handleSyncCameraDiscovery}
                  startIcon={cameraSyncing ? <CircularProgress size={14} sx={{ color: '#93a4dc' }} /> : <SyncIcon />}
                  disabled={cameraSyncing}
                  sx={{
                    borderColor: '#93a4dc',
                    color: '#93a4dc',
                    '&:hover': { borderColor: '#c3cbe6', bgcolor: 'rgba(195, 203, 230,0.08)' },
                  }}
                >
                  Kjør discovery sync
                </Button>
                        ...
                        >
                          <Card
                            ...
                            sx={{
                              ...
                              position: 'relative',
                              overflow: 'hidden',
                              border: selectedCameraId === camera.id ? '1px solid #93a4dc' : '1px solid rgba(255,255,255,0.08)',
                              background: selectedCameraId === camera.id
                                ? 'linear-gradient(150deg, rgba(147, 164, 220,0.2) 0%, rgba(30,41,59,0.85) 100%)'
                            ...
                            <CardContent>
                              <Box sx={{ display: 'flex', justifyContent: 'space-between', gap: 1, mb: 1 }}>
                                ...
                                <Stack direction="row" spacing={0.75} sx={{ alignItems: 'center' }}>
                                  <Chip
                                    ...
                                    sx={{
                                      bgcolor: camera.type === 'photo' ? 'rgba(33,150,243,0.2)' : 'rgba(50, 18, 122,0.25)',
                                      color: camera.type === 'photo' ? '#90caf9' : '#c3cbe6',
                                    }}
                                  />
                                  {camera.isNetflixCertified && renderNetflixBadge('Netflix', true)}
                                </Stack>
                              ...
                              <Button
                                ...
                                sx={{
                                  borderColor: '#93a4dc',
                                  color: '#93a4dc',
                                  '&:hover': { bgcolor: 'rgba(147, 164, 220,0.1)', borderColor: '#c3cbe6' },
                                }}
                              >
                                Importer kamera
                              </Button>
            ...
            <Stack spacing={1.5}>
              ...
              <Stack direction="row" spacing={1} flexWrap="wrap">
                <Chip
                  ...
                  sx={{ bgcolor: 'rgba(75, 61, 143,0.15)', color: '#93a4dc', maxWidth: '100%' }}
                />
                <Chip
      ...
      >
          ...
          <TextField
            ...
            sx={{
              '& .MuiOutlinedInput-root': {
                ...
                borderRadius: 2,
                '& fieldset': { borderColor: 'rgba(255,255,255,0.1)' },
                '&:hover fieldset': { borderColor: 'rgba(147, 164, 220,0.45)' },
                '&.Mui-focused fieldset': { borderColor: '#93a4dc' },
              },
            }}
          />
          {qrScanError && (
        ...
        <DialogActions sx={{ borderTop: '1px solid rgba(148,163,184,0.22)', p: 2, gap: 1 }}>
          ...
          <Button
            ...
            sx={{ borderColor: '#93a4dc', color: '#93a4dc' }}
          >
            Lim inn
          </Button>
          <Button
            ...
            sx={{
              ...
              color: '#fff',
              fontWeight: 700,
              '&:hover': { background: 'linear-gradient(135deg, #93a4dc, #4b3d8f)' },
            }}
          >
            Tolk QR
          </Button>

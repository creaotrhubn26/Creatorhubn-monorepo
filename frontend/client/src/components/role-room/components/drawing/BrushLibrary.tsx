...
const DEFAULT_PRESETS: BrushPreset[] = [
  ...
  },
  {
    id: 'airbrush',
    name: 'Airbrush',
    config: { ...DEFAULT_BRUSH_CONFIG, type: 'brush', size: 40, color: 'var(--role-violet, #756be7)', hardness: 0.1, flow: 0.3, opacity: 0.2 },
    favorite: false,
    category: 'Painting',
    icon: '🌫️',
    createdAt: Date.now(),
  ...
  {
    // Sprint A.7: Bruker den ekte charcoal-rendereren nå (var 'pencil' før).
  ...
  {
    // Sprint A.7: Bruker den ekte graphite-rendereren nå (var 'pencil' før).
    id: 'graphite-shading',
  ...
  // Sprint A.7: 3 nye storyboard-bransje-brushes — graphite stick for
  // value-studies, charcoal for atmosfære, conté for figur-arbeid.
  {
    id: 'graphite-stick-wide',
    name: 'Graphite Stick',
    config: {
      ...DEFAULT_BRUSH_CONFIG,
      type: 'graphite',

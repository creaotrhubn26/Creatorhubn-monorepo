  ...
  return (
    <Box sx={{ mt: .8, maxWidth: 420 }}>
      {reference.kind === 'photo'
        ? <Box component="img" src={signedUrl} alt={reference.label || 'Kontinuitetsreferanse'} sx={{ display: 'block', width: '100%', maxHeight: 280, objectFit: 'contain', borderRadius: 1.5, bgcolor: '#1b122c' }} />
        : reference.kind === 'video'
          ? <Box component="video" src={signedUrl} controls preload="metadata" sx={{ display: 'block', width: '100%', maxHeight: 280, borderRadius: 1.5, bgcolor: '#1b122c' }} />
          : null}

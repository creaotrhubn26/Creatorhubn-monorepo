...
export function ProductionDayView({ projectId, onUpdate, profession }: ProductionDayViewProps) {
  ...
  useEffect(() => {
    ...
    loadData();
  }, [projectId, normalizeProductionDay]);
  ...
  }, [isOnline, offlineQueue, normalizeProductionDay, productionDays, projectId]);
  ...
  }, [projectId, locations, normalizeProductionDay, productionDays]);
  ...
  const filteredAndSortedDays = useMemo(() => {
    ...
    return result;
  }, [productionDays, searchQuery, statusFilter, sortField, sortDirection, favorites, getLocationName]);
  ...
  }, [selectedDraft, selectedProDay, extractMentions]);

...
export function ProductionDayView({ projectId, onUpdate, profession }: ProductionDayViewProps) {
  ...
  const generateProductionDaysHTML = (
    ...
    const productionIconSVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#32127a" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-bottom: 5px solid #32127a; padding: 30px 35px; margin: -50px -60px 40px -60px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); }
    .title { font-size: 36px; font-weight: 800; color: #32127a; margin-bottom: 10px; letter-spacing: -1px; line-height: 1.2; display: flex; align-items: center; gap: 12px; }
    .title svg { flex-shrink: 0; }
    .subtitle { color: #64748b; font-size: 15px; font-weight: 500; margin-top: 5px; }
    .summary { background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-left: 6px solid #32127a; padding: 30px; margin-bottom: 45px; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); }
    .summary-title { font-size: 20px; font-weight: 700; color: #32127a; margin-bottom: 25px; letter-spacing: -0.3px; display: flex; align-items: center; gap: 12px; }
    ...
    .summary-number { font-size: 36px; font-weight: 800; color: #32127a; display: block; margin-bottom: 8px; line-height: 1; }
    ...
    .progress-fill { height: 100%; background: linear-gradient(90deg, #32127a 0%, #302a83 100%); border-radius: 10px; }
    ...
    th { background: linear-gradient(135deg, #32127a 0%, #302a83 100%); color: white; font-weight: 700; padding: 18px 20px; text-align: left; font-size: 12px; text-transform: uppercase; letter-spacing: 0.8px; border: none; }
    ...
    >
        ...
        >
          <Box
            sx={{
              ...
              background: 'linear-gradient(135deg, rgba(50, 18, 122, 0.25) 0%, rgba(50, 18, 122, 0.15) 100%)',
              ...
              '&:hover': {
                ...
                boxShadow: '0 6px 16px rgba(50, 18, 122, 0.3)',
              },
            }}
          >
            <CalendarMonthIcon
          ...
          <Box>
            <Typography
              ...
              sx={{
                ...
                background: 'linear-gradient(135deg, #fff 0%, #5d76cb 100%)',
          ...
          <Tooltip title={filtersExpanded ? 'Skjul avanserte filtre' : 'Vis avanserte filtre'}>
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                color: filtersExpanded ? '#32127a' : 'rgba(255,255,255,0.7)',
                borderColor: filtersExpanded ? '#32127a' : 'rgba(255,255,255,0.2)',
                px: { xs: 1, sm: 2 },
                ...focusVisibleStyles,
              }}
            >
          ...
          <Tooltip title="Vis/skjul statistikk">
            <Button
              ...
              sx={{
                minHeight: TOUCH_TARGET_SIZE,
                minWidth: TOUCH_TARGET_SIZE,
                color: showStats ? '#32127a' : 'rgba(255,255,255,0.7)',
                borderColor: showStats ? '#32127a' : 'rgba(255,255,255,0.2)',
                px: { xs: 1, sm: 2 },
                ...focusVisibleStyles,
              }}
            >
            ...
            <span>
              <Button
                ...
                sx={{
                  ...
                  minHeight: TOUCH_TARGET_SIZE,
                  ...focusVisibleStyles,
                  '&:hover': { borderColor: '#5d76cb', bgcolor: 'rgba(93, 118, 203,0.12)' },
                }}
              >
                <AutoGenerateIcon />
      ...
      <Dialog open={schedulerOpen} onClose={() => !generatingDays && setSchedulerOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <AutoGenerateIcon sx={{ color: '#5d76cb' }} />
        ...
        <DialogActions>
          ...
          <Button
            ...
            sx={{ bgcolor: '#32127a', '&:hover': { bgcolor: '#32127a' } }}
          >
        ...
        >
          <Box sx={{ textAlign: 'center' }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 0.5, mb: 0.5 }}>
              <CalendarMonthIcon sx={{ fontSize: { xs: 16, sm: 18, md: 17, lg: 19, xl: 22 }, color: '#32127a' }} />
            </Box>
            <Typography variant="h4" sx={{ color: '#32127a', fontWeight: 700, fontSize: { xs: '1.5rem', sm: '2rem' } }}>
              {stats.totalDays}
            </Typography>
        ...
        <TextField
          ...
          sx={{
            ...
            '& .MuiOutlinedInput-root': {
              ...
              '&.Mui-focused fieldset': { borderColor: '#32127a' },
            },
          }}
        />
      </Box>
            ...
            <Tooltip title="Kortvisning">
              <Button
                ...
                sx={{
                  minHeight: TOUCH_TARGET_SIZE,
                  minWidth: TOUCH_TARGET_SIZE,
                  bgcolor: viewMode === 'grid' ? 'rgba(50, 18, 122,0.2)' : 'transparent',
                  color: viewMode === 'grid' ? '#32127a' : 'rgba(255,255,255,0.7)',
                  borderColor: viewMode === 'grid' ? '#32127a' : 'rgba(255,255,255,0.2)',
                  ...focusVisibleStyles,
                }}
              >
                <GridViewIcon />
            ...
            <Tooltip title="Tabellvisning">
              <Button
                ...
                sx={{
                  minHeight: TOUCH_TARGET_SIZE,
                  minWidth: TOUCH_TARGET_SIZE,
                  bgcolor: viewMode === 'table' ? 'rgba(50, 18, 122,0.2)' : 'transparent',
                  color: viewMode === 'table' ? '#32127a' : 'rgba(255,255,255,0.7)',
                  borderColor: viewMode === 'table' ? '#32127a' : 'rgba(255,255,255,0.2)',
                  ...focusVisibleStyles,
                }}
              >
                <TableViewIcon />
        ...
        >
          ...
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', alignItems: 'center' }}>
            <FormControlLabel
              ...
              label={<Typography sx={{ color: '#dfe4f3', fontSize: '0.8rem' }}>Pro</Typography>}
            />
            <FormControlLabel
              sx={{ m: 0 }}
              control={
          ...
          <Box sx={{ mt: 2, display: 'flex', flexDirection: 'column', gap: 2 }}>
            <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', alignItems: 'center' }}>
              ...
              <Button
                ...
                sx={{
                  minHeight: TOUCH_TARGET_SIZE,
                  color: selectedIds.size > 0 ? '#dfe4f3' : 'rgba(255,255,255,0.45)',
                  borderColor: selectedIds.size > 0 ? 'rgba(75, 61, 143,0.5)' : 'rgba(255,255,255,0.2)',
                }}
              >
              ...
              <Box sx={{ p: 1.5, borderRadius: 2, bgcolor: 'rgba(27, 18, 44,0.55)', border: '1px solid rgba(255,255,255,0.12)' }}>
                ...
                <Box sx={{ mt: 1.5, display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 1.25 }}>
                  <Box sx={{ p: 1.2, borderRadius: 1.5, bgcolor: 'rgba(15,23,42,0.55)', border: '1px solid rgba(255,255,255,0.1)' }}>
                    <Typography sx={{ color: '#c3cbe6', fontWeight: 600, fontSize: '0.82rem', mb: 0.75 }}>
                      Avhengigheter
                    </Typography>
              ...
              <Box sx={{ p: 1.5, borderRadius: 2, bgcolor: 'rgba(27, 18, 44,0.55)', border: '1px solid rgba(255,255,255,0.12)' }}>
                ...
                <Box sx={{ display: 'flex', flexWrap: 'wrap', gap: 1, mb: 1.25 }}>
                  ...
                  <Button
                    ...
                    sx={{ color: '#dfe4f3', borderColor: 'rgba(75, 61, 143,0.45)' }}
                  >
                    Synk status
                  </Button>
                </Box>
                  ...
                  <Box>
                      ...
                      <Box sx={{ mt: 1, display: 'flex', flexWrap: 'wrap', gap: 0.75 }}>
                        {selectedDraftMentions.map((tag) => (
                          <Chip
                            ...
                            sx={{ bgcolor: 'rgba(75, 61, 143,0.25)', color: '#dfe4f3' }}
                          />
                        ))}
                      </Box>
                    )}
                    <Box sx={{ mt: 1, display: 'flex', gap: 1 }}>
                      <Button
                        ...
                        sx={{ bgcolor: '#4b3d8f', '&:hover': { bgcolor: '#3e3180' } }}
                      >
                        Legg til kommentar
                      </Button>
                      <Button
                        ...
                        {[...selectedTeamFlow].reverse().slice(0, 8).map((entry) => (
                          <Box key={entry.id} sx={{ p: 0.75, borderRadius: 1.25, bgcolor: 'rgba(27, 18, 44,0.6)', border: '1px solid rgba(148,163,184,0.2)' }}>
                            ...
                            {!!entry.mentions.length && (
                              <Typography sx={{ color: '#c3cbe6', fontSize: '0.72rem', mt: 0.25 }}>
              ...
              <TableRow sx={{ bgcolor: 'rgba(255,255,255,0.05)' }}>
                <TableCell padding="checkbox">
                  <Checkbox
                    ...
                    sx={{ color: 'rgba(255,255,255,0.87)', '&.Mui-checked': { color: '#32127a' } }}
                  />
                </TableCell>
                <TableCell>
                  <TableSortLabel
                    ...
                    sx={{ color: '#fff', '&:hover': { color: '#32127a' } }}
                  >
                    Dato
                  </TableSortLabel>
                </TableCell>
            ...
            <TableBody>
              {filteredAndSortedDays.map((day) => (
                <TableRow
                  key={day.id}
                  sx={{
                    bgcolor: selectedIds.has(day.id) ? 'rgba(50, 18, 122,0.1)' : 'transparent',
                ...
                >
                  ...
                  <TableCell>
                    <Chip label={day.scenes.length} size="small" sx={{ bgcolor: 'rgba(50, 18, 122,0.2)', color: '#32127a' }} />
                  </TableCell>
                      ...
                      <Card
                        ...
                        sx={{
                          ...
                          '&:hover': { 
                            ...
                            borderColor: '#32127a',
                            boxShadow: '0 8px 24px rgba(50, 18, 122,0.2)',
                          ...
                          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: { xs: 1.5, sm: 2 } }}>
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                              <Checkbox
                                checked={selectedIds.has(day.id)}
                                onChange={() => handleToggleSelect(day.id)}
                                sx={{ p: 0.5, color: 'rgba(255,255,255,0.6)', '&.Mui-checked': { color: '#32127a' } }}
                              />
                              <Box sx={{ flex: 1 }}>
                                ...
                                <Box 
                                  sx={{ 
                                    ...
                                    background: 'linear-gradient(135deg, rgba(50, 18, 122,0.25) 0%, rgba(50, 18, 122,0.15) 100%)',
                                    border: '2px solid rgba(50, 18, 122,0.4)',
                                    boxShadow: '0 4px 12px rgba(50, 18, 122,0.2), inset 0 1px 0 rgba(255,255,255,0.1)',
                                    overflow: 'hidden',
                                    '&::before': {
                                      content: '""',
                                      position: 'absolute',
                                      ...
                                      right: 0,
                                      height: '3px',
                                      background: 'linear-gradient(90deg, #32127a 0%, #32127a 50%, #302a83 100%)',
                                    },
                                  }}
                                >
                                  ...
                                  <Box
                                    sx={{
                                      ...
                                      borderRadius: 3,
                                      background: 'linear-gradient(135deg, #32127a 0%, #302a83 100%)',
                                      border: '3px solid rgba(255,255,255,0.3)',
                                      boxShadow: '0 4px 16px rgba(50, 18, 122,0.4), inset 0 1px 0 rgba(255,255,255,0.2)',
                                      overflow: 'hidden',
                                    }}
                                  >
                          ...
                          {day.lastModifiedBy && (
                            <Box
                              sx={{
                                ...
                                borderRadius: 1.5,
                                border: '1px solid rgba(50, 18, 122,0.15)',
                              }}
                            >
                          ...
                          <Stack spacing={2} sx={{ mb: { xs: 2, sm: 2.5 } }}>
                            ...
                            <Box
                              sx={{
                                ...
                                p: { xs: 1.5, sm: 2 },
                                borderRadius: 2.5,
                                bgcolor: 'rgba(50, 18, 122,0.12)',
                                border: '1px solid rgba(50, 18, 122,0.25)',
                              }}
                            >
                              <Box
                                sx={{
                                  ...
                                  height: { xs: 44, sm: 52 },
                                  borderRadius: 2,
                                  bgcolor: 'rgba(50, 18, 122,0.25)',
                                  display: 'flex',
                                  alignItems: 'center',
                                  justifyContent: 'center',
                                }}
                              >
                                <TimeIcon sx={{ fontSize: { xs: 24, sm: 28 }, color: '#5d76cb' }} />
                              </Box>
                              <Box sx={{ flex: 1 }}>
                                <Typography
                                  sx={{
                          ...
                          <Collapse in={expandedCards.has(day.id)}>
                            <Box
                              sx={{
                                mt: 2.5,
                                pt: 2.5,
                                borderTop: '2px solid rgba(50, 18, 122,0.3)',
                                      ...
                                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
                                        ...
                                        >
                                          {dayScenes.some((scene) => typeof scene.thumbnail === 'string' && scene.thumbnail.trim().length > 0) ? (
                                            <ImageIcon sx={{ fontSize: { xs: 20, sm: 22 }, color: '#5d76cb' }} />
                                          ) : (
                                            <MovieIcon sx={{ fontSize: { xs: 20, sm: 22 }, color: '#5d76cb' }} />
                                          )}
                                        </Box>
                                        <Box sx={{ flex: 1 }}>
                                          <Typography sx={{ color: '#5d76cb', fontWeight: 700, fontSize: { xs: '0.9rem', sm: '1rem' } }}>
                                            Scener
                                          </Typography>
                                        ...
                                        {dayScenes.map((scene) => (
                                          <Chip
                                            ...
                                            sx={{
                                              ...
                                              transition: 'all 0.2s',
                                              '&:hover': {
                                                bgcolor: 'rgba(50, 18, 122,0.45)',
                                                transform: 'translateY(-2px)',
                                                boxShadow: '0 4px 12px rgba(50, 18, 122,0.3)',
                                              },
                                            }}
                                          />
                                        ))}
                                  ...
                                  <Grid item xs={12} sm={isLandscape ? 6 : 12} md={6}>
                                    ...
                                    >
                                      <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 2 }}>
                                        ...
                                        >
                                          <InventoryIcon sx={{ fontSize: { xs: 20, sm: 22 }, color: '#93a4dc' }} />
                                        </Box>
                                        <Box sx={{ flex: 1 }}>
                                          <Typography sx={{ color: '#93a4dc', fontWeight: 700, fontSize: { xs: '0.9rem', sm: '1rem' } }}>
                                            Utstyr
                                          </Typography>
                                          <Typography sx={{ color: 'rgba(255,255,255,0.87)', fontSize: { xs: '0.75rem', sm: '0.8rem' } }}>
                                        ...
                                        >
                                          <Box
                                            sx={{
                                              ...
                                              height: 8,
                                              borderRadius: '50%',
                                              bgcolor: log.action === 'created' ? '#10b981' : log.action === 'status_changed' ? '#4b3d8f' : '#32127a',
                                              mt: 0.75,
                                              flexShrink: 0,
                                            }}
                                          />
                            ...
                            <Button
                              ...
                              sx={{
                                bgcolor: expandedCards.has(day.id)
                                  ? 'rgba(50, 18, 122,0.25)'
                                  : 'rgba(50, 18, 122,0.15)',
                                color: expandedCards.has(day.id) ? '#5d76cb' : '#fff',
                                fontSize: { xs: '0.875rem', sm: '0.9375rem' },
                                fontWeight: 600,
                                minHeight: TOUCH_TARGET_SIZE,
                                px: { xs: 2, sm: 2.5 },
                                border: expandedCards.has(day.id)
                                  ? '2px solid rgba(50, 18, 122,0.5)'
                                  : '2px solid rgba(50, 18, 122,0.3)',
                                borderRadius: 2,
                                textTransform: 'none',
                                boxShadow: expandedCards.has(day.id)
                                  ? '0 4px 12px rgba(50, 18, 122,0.3)'
                                  : '0 2px 8px rgba(50, 18, 122,0.2)',
                                transition: 'all 0.2s ease',
                                '&:hover': {
                                  bgcolor: 'rgba(50, 18, 122,0.35)',
                                  borderColor: 'rgba(50, 18, 122,0.6)',
                                  transform: 'translateY(-1px)',
                                  boxShadow: '0 6px 16px rgba(50, 18, 122,0.4)',
                                },
                                ...focusVisibleStyles,
                              }}
                            >
                              ...
                              <Tooltip title="Rediger">
                                <IconButton
                                  ...
                                  sx={{ 
                                    ...
                                    minHeight: TOUCH_TARGET_SIZE, 
                                    color: '#32127a',
                                    '&:hover': { bgcolor: 'rgba(50, 18, 122,0.1)' },
                                    ...focusVisibleStyles,
                                  }}
                                >
      ...
      <Snackbar
        ...
        action={
          <Button color="secondary" size="small" onClick={handleUndoDelete} sx={{ color: '#32127a' }}>
            Angre
          </Button>
        }
        ...
        slotProps={{
          paper: {
            sx: {
              ...
              border: { xs: 'none', sm: '1px solid rgba(50, 18, 122,0.2)' },
      ...
      >
        ...
        <DialogTitle
          ...
          sx={{
            color: '#fff',
            borderBottom: '2px solid rgba(50, 18, 122,0.3)',
            background: 'linear-gradient(135deg, rgba(50, 18, 122,0.1) 0%, rgba(0,0,0,0.2) 100%)',
        ...
        >
          <Box sx={{ display: 'flex', alignItems: 'center', gap: { xs: 1.5, sm: 2 } }}>
            ...
            >
              {editingDay ? (
                <EditIcon sx={{ color: '#5d76cb', fontSize: { xs: 22, sm: 26, md: 28 } }} />
              ) : (
                <AddIcon sx={{ color: '#5d76cb', fontSize: { xs: 22, sm: 26, md: 28 } }} />
              )}
            </Box>
            <Box>
              <Typography
        ...
        >
          ...
          >
            <CalendarMonthIcon sx={{ color: '#5d76cb', fontSize: { xs: 20, sm: 24 } }} />
            <Typography
              sx={{
                color: 'rgba(255,255,255,0.87)',
      ...
      >
        <DialogTitle
          sx={{
            ...
            gap: 2,
            bgcolor: 'rgba(75, 61, 143,0.1)',
            borderBottom: '1px solid rgba(75, 61, 143,0.2)',
          }}
        >
          <Box
            sx={{
          ...
          <Box>
            <Typography variant="h6" sx={{ fontWeight: 700, color: '#4b3d8f' }}>
              Informer teamet?
            </Typography>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.5 }}>
            {changedFields.map((field, index) => (
              ...
              >
                ...
                >
                  {field === 'Dato' && <CalendarIcon sx={{ color: '#4b3d8f', fontSize: 20 }} />}
                  {field === 'Arbeidstid' && <TimeIcon sx={{ color: '#4b3d8f', fontSize: 20 }} />}
                  {field === 'Lokasjon' && <LocationIcon sx={{ color: '#4b3d8f', fontSize: 20 }} />}
                  {field === 'Notater' && <NotesIcon sx={{ color: '#4b3d8f', fontSize: 20 }} />}
                </Box>
      ...
      <Dialog
        ...
        PaperProps={{
          sx: {
            ...
            color: '#fff',
            borderRadius: 3,
            border: '1px solid rgba(50, 18, 122,0.28)',
          },
        }}
      >
        <DialogTitle
        ...
        <DialogActions sx={{ borderTop: '1px solid rgba(255,255,255,0.08)', p: 2 }}>
          <Button onClick={() => setScenePreview(null)} variant="contained" sx={{ bgcolor: '#32127a', '&:hover': { bgcolor: '#32127a' } }}>
            Lukk
          </Button>
        </DialogActions>
      </Dialog>

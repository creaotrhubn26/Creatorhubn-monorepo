            ...
            <Tooltip title={tooltipTitle} placement="bottom" arrow>
              <Box
                ...
                sx={{
                  ...
                  py: 0.6,
                  border: 'none',
                  background: isActive ? 'rgba(141, 128, 234,0.14)' : 'transparent',
                  borderRadius: 1.5,
                  cursor: 'pointer',
                  color: stateColor,
                  fontFamily: 'inherit',
                  ...
                  '&:hover': {
                    background: isActive ? 'rgba(141, 128, 234,0.2)' : 'rgba(255,255,255,0.05)',
                    color: isActive ? '#fff' : 'rgba(255,255,255,0.85)',
                  },
                  '&:focus-visible': {
                    outline: '2px solid rgba(141, 128, 234,0.6)',
                    outlineOffset: 2,
                  },
                }}
              >

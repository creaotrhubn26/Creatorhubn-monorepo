      ...
      {result.coaching.length > 0 && (
        <Box sx={{ mt: 1.5 }}>
          <Button
            ...
            sx={{ color: '#9d97ee', textTransform: 'none', fontSize: '0.75rem' }}
          >
          ...
          <Collapse in={showCoaching}>
            <Box
              sx={{
                ...
                borderRadius: 1.5,
                border: '1px solid rgba(117, 107, 231, 0.15)',
              }}
            >
              {result.coaching.map((tip, idx) => (
                <Box key={idx} sx={{ mb: idx < result.coaching.length - 1 ? 2 : 0 }}>
                  <Typography variant="caption" sx={{ color: '#9e93ed', fontWeight: 600 }}>
                    Eksempel:
                  </Typography>
                  ...
                  <Typography variant="caption" sx={{ color: '#9d97ee', fontWeight: 600 }}>
                    Pass på:
                  </Typography>

...
function AuditionSchedulePanelInner({
  ...
  const generateAuditionsHTML = (project: any, schedules: any[]): string => {
    ...
    const scheduleIconSVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#5d76cb" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .progress-fill { height: 100%; background: linear-gradient(90deg, #5d76cb 0%, #4b3d8f 100%); border-radius: 10px; }
    ...
    th { background: linear-gradient(135deg, #5d76cb 0%, #4b3d8f 100%); color: white; font-weight: 700; padding: 18px 20px; text-align: left; font-size: 12px; text-transform: uppercase; letter-spacing: 0.8px; border: none; }
    ...
    >
      ...
      >
        ...
        <Button
          ...
          sx={{
            ...
            '&:hover': { bgcolor: poolMode === 'project' ? 'rgba(93, 118, 203,0.28)' : 'rgba(255,255,255,0.05)' },
            ...focusVisibleStyles,
          }}
        >
          Prosjekt
        ...
        <Button
          ...
          sx={{
            ...
            '&:hover': { bgcolor: poolMode === 'pool' ? 'rgba(93, 118, 203,0.28)' : 'rgba(255,255,255,0.05)' },
            ...focusVisibleStyles,
          }}
        >
          Maler
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} useFlexGap flexWrap="wrap">
          <Button
            ...
            sx={{
              minHeight: 38,
              borderColor: roleBorder,
              color: proViewMode === 'pipeline' ? '#2a3152' : roleText,
          ...
          <Button
            ...
            sx={{
              minHeight: 38,
              borderColor: roleBorder,
              color: proViewMode === 'timeline' ? '#2a3152' : roleText,
                      ...
                      {column.schedules.map((schedule) => {
                        ...
                        return (
                          <Card
                            ...
                            sx={{
                              cursor: 'pointer',
                              bgcolor: isFocused ? 'rgba(93, 118, 203,0.18)' : roleSurface,
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.25 }}>
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} sx={{ alignItems: { sm: 'center' } }}>
                <Button
                  ...
                  sx={{ minHeight: 34, borderColor: roleBorder, color: proTimelineMode === 'day' ? '#2a3152' : roleText, bgcolor: proTimelineMode === 'day' ? roleTabAccent : 'transparent' }}
                >
                  Dag
                </Button>
                <Button
                  ...
                  sx={{ minHeight: 34, borderColor: roleBorder, color: proTimelineMode === 'week' ? '#2a3152' : roleText, bgcolor: proTimelineMode === 'week' ? roleTabAccent : 'transparent' }}
                >
                  Uke
                </Button>
                <TextField
                        ...
                        {bucket.items.map((schedule) => (
                          <Box
                            ...
                            sx={{
                              ...
                              bgcolor: selectedProSchedule?.id === schedule.id ? 'rgba(93, 118, 203,0.14)' : roleSurface,
                              cursor: 'pointer',
                            }}
                          >
        ...
        >
          ...
          {selectedProSchedule ? (
            <>
              ...
              <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
                <Button size="small" variant="contained" onClick={() => onEditSchedule(selectedProSchedule)} sx={{ bgcolor: roleTabAccent, color: '#2a3152', fontWeight: 700, '&:hover': { bgcolor: roleTabAccentHover } }}>
                  Rediger
                </Button>
                ...
                <Button
                  ...
                  sx={{
                    color: proCompareIds.has(selectedProSchedule.id) ? '#2a3152' : roleText,
        ...
        <TextField
          ...
          sx={{
            ...
            '& .MuiOutlinedInput-root': {
              ...
              '& fieldset': { borderColor: dateFilter ? 'rgba(93, 118, 203,0.5)' : 'rgba(255,255,255,0.15)' },
              '&.Mui-focused fieldset': { borderColor: roleTabAccent },
            },
          }}
        />
          ...
          <FormControl size="small" sx={{ minWidth: 160, display: { xs: 'none', md: 'flex' } }}>
            <Select
              ...
              sx={{
                ...
                minHeight: TOUCH_TARGET_SIZE,
                '& .MuiOutlinedInput-notchedOutline': { borderColor: candidateFilter !== 'all' ? 'rgba(93, 118, 203,0.5)' : 'rgba(255,255,255,0.15)' },
                '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: roleTabAccent },
            ...
            <Tooltip key={mode} title={label}>
              <IconButton
                ...
                sx={{
                  ...
                  bgcolor: viewMode === mode ? 'rgba(93, 118, 203,0.12)' : 'transparent',
                  border: '1px solid',
                  borderColor: viewMode === mode ? 'rgba(93, 118, 203,0.4)' : 'rgba(255,255,255,0.12)',
                  '&:hover': { bgcolor: 'rgba(93, 118, 203,0.08)', borderColor: 'rgba(93, 118, 203,0.3)' },
                  ...focusVisibleStyles,
                }}
              >
                {icon}
          ...
          <Tooltip title={auditionGroupedView ? 'Vis individuelle kandidater' : 'Grupper som auditions'}>
            <IconButton
              ...
              sx={{
                ...
                bgcolor: auditionGroupedView ? 'rgba(93, 118, 203,0.12)' : 'transparent',
                border: '1px solid',
                borderColor: auditionGroupedView ? 'rgba(93, 118, 203,0.4)' : 'rgba(255,255,255,0.12)',
                '&:hover': { bgcolor: 'rgba(93, 118, 203,0.08)', borderColor: 'rgba(93, 118, 203,0.3)' },
                ...focusVisibleStyles,
              }}
            >
      ...
      >
        ...
        <Chip
          ...
          sx={{
            cursor: 'pointer',
            bgcolor: favoritesOnly ? 'rgba(93, 118, 203,0.2)' : 'transparent',
            color: favoritesOnly ? roleTabAccent : 'rgba(255,255,255,0.6)',
            borderColor: favoritesOnly ? 'rgba(93, 118, 203,0.5)' : 'rgba(255,255,255,0.15)',
            '&:hover': { bgcolor: 'rgba(93, 118, 203,0.15)', borderColor: 'rgba(93, 118, 203,0.4)' },
          }}
        />
        ...
        {searchQuery && (
          <Chip size="small" label={`"${searchQuery}"`}
            ...
            sx={{ bgcolor: 'rgba(93, 118, 203,0.15)', color: roleTabAccent, borderColor: 'rgba(93, 118, 203,0.3)', '& .MuiChip-deleteIcon': { color: roleTabAccent } }} />
        )}
        {dateFilter && (
          <Chip size="small" label={`📅 ${dateFilter}`}
            onDelete={() => setDateFilter('')}
            sx={{ bgcolor: 'rgba(93, 118, 203,0.12)', color: roleTabAccent, '& .MuiChip-deleteIcon': { color: roleTabAccent } }} />
        )}
        {candidateFilter !== 'all' && (
            ...
            <Box sx={{ mt: 3, display: 'flex', justifyContent: 'center' }}>
              <Button
                ...
                sx={{
                  ...
                  py: 1.5,
                  minHeight: TOUCH_TARGET_SIZE,
                  '&:hover': { borderColor: roleTabAccent, bgcolor: 'rgba(93, 118, 203,0.1)' },
                  ...focusVisibleStyles,
                }}
              >
        ...
        <>
          <TableContainer component={Paper} sx={{ bgcolor: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 1.5, overflow: 'hidden' }}>
                      ...
                      return (
                        <TableRow
                          ...
                          sx={{
                            height: 56,
                            cursor: 'pointer',
                            bgcolor: isSelected ? 'rgba(93, 118, 203,0.07)' : 'transparent',
                            '&:hover': { bgcolor: isSelected ? 'rgba(93, 118, 203,0.11)' : 'rgba(255,255,255,0.03)' },
                            '&:focus-within': { outline: '2px solid rgba(93, 118, 203,0.4)', outlineOffset: -1 },
              ...
              <Menu
                ...
                PaperProps={{ sx: { bgcolor: '#3c4e6d', border: '1px solid rgba(255,255,255,0.12)', color: '#fff', minWidth: 180 } }}
              >
                ...
                <MenuItem onClick={() => { if (rowMenuAnchor) handleSaveToPool(rowMenuAnchor.schedule); setRowMenuAnchor(null); }} sx={{ gap: 1.5, fontSize: 14 }}>
                  <InventoryIcon sx={{ fontSize: 16, color: '#32127a' }} /> Lagre til pool
                </MenuItem>
                <Divider sx={{ borderColor: 'rgba(255,255,255,0.1)' }} />
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  '&:hover': { bgcolor: isSelected ? 'rgba(93, 118, 203,0.1)' : 'rgba(255,255,255,0.03)' },
              ...
              <Box key={schedule.id}>
                <Card
                  ...
                  sx={{
                    ...
                    display: 'flex',
                    flexDirection: 'column',
                    bgcolor: selectedIds.has(schedule.id) ? 'rgba(93, 118, 203,0.15)' : 'rgba(255,255,255,0.05)',
                      ...
                      <Box sx={{ mt: { xs: 1.5, md: 2 } }}>
                        <Button
                          ...
                          sx={{
                            ...
                            '&:hover': { color: roleTabAccentHover, bgcolor: 'rgba(93, 118, 203,0.1)' },
                            '@keyframes writing': {
                        ...
                        <Collapse in={isExpanded}>
                          <Box
                            sx={{
                              ...
                              boxShadow: '0 4px 16px rgba(93, 118, 203,0.1)',
                              position: 'relative',
                              overflow: 'hidden',
                              '&::before': {
                                content: '""',
                  ...
                  p === 'ellipsis' ? (
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        height: 32,
                        px: 1,
                        bgcolor: safePage === p ? 'var(--role-accent, #5d76cb)' : 'transparent',
                        color: safePage === p ? '#fff' : 'rgba(255,255,255,0.7)',
                        fontWeight: safePage === p ? 700 : 500,
                        '&:hover': { bgcolor: safePage === p ? '#5d76cb' : 'rgba(93, 118, 203,0.18)' },
                      }}
                    >
                      {p}
                    </Button>
          ...
          <FormControl size="small" sx={{ minWidth: 120 }}>
            <Select
              ...
              sx={{
                ...
                '&:hover fieldset': { borderColor: 'rgba(93, 118, 203,0.3)' },
      ...
      <Snackbar
        ...
        sx={{ '& .MuiSnackbarContent-root': { bgcolor: '#3c4e6d' } }}
      />

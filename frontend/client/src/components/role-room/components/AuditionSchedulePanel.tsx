...
function AuditionSchedulePanelInner({
  ...
  const getStatusColor = (status?: string) => {
    switch (status) {
      ...
      case 'awaiting_callback': return '#7666e6';  // purple
  ...
  const generateAuditionsHTML = (project: any, schedules: any[]): string => {
    ...
    const scheduleIconSVG = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#756be7" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
...
<head>
  ...
  <style>
    ...
    * { margin: 0; padding: 0; box-sizing: border-box; }
    ...
    .header { background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-bottom: 5px solid #756be7; padding: 30px 35px; margin: -50px -60px 40px -60px; box-shadow: 0 2px 8px rgba(0,0,0,0.05); }
    .title { font-size: 36px; font-weight: 800; color: #756be7; margin-bottom: 10px; letter-spacing: -1px; line-height: 1.2; display: flex; align-items: center; gap: 12px; }
    .title svg { flex-shrink: 0; }
    .subtitle { color: #64748b; font-size: 15px; font-weight: 500; margin-top: 5px; }
    .summary { background: linear-gradient(135deg, #f8fafc 0%, #f1f5f9 100%); border-left: 6px solid #756be7; padding: 30px; margin-bottom: 45px; border-radius: 12px; box-shadow: 0 2px 12px rgba(0,0,0,0.08); }
    .summary-title { font-size: 20px; font-weight: 700; color: #756be7; margin-bottom: 25px; letter-spacing: -0.3px; display: flex; align-items: center; gap: 12px; }
    ...
    .summary-number { font-size: 36px; font-weight: 800; color: #756be7; display: block; margin-bottom: 8px; line-height: 1; }
    ...
    .progress-fill { height: 100%; background: linear-gradient(90deg, #756be7 0%, #5446e1 100%); border-radius: 10px; }
    ...
    th { background: linear-gradient(135deg, #756be7 0%, #5446e1 100%); color: white; font-weight: 700; padding: 18px 20px; text-align: left; font-size: 12px; text-transform: uppercase; letter-spacing: 0.8px; border: none; }
    ...
    >
          ...
          <Tooltip title="Vis statistikk">
            <Button
              ...
              sx={{
                ...
                color: showStats ? '#0d0a24' : roleText,
          ...
          <Tooltip title="Ny avtale (F)">
            <Button
              ...
              sx={{
                ...
                '&:disabled': { bgcolor: 'rgba(141, 128, 234,0.3)', color: 'rgba(13, 10, 36,0.75)' },
                ...focusVisibleStyles,
              }}
            >
              {isMobile ? '' : 'Ny avtale'}
      ...
      >
        ...
        <Button
          ...
          sx={{
            ...
            '&:hover': { bgcolor: poolMode === 'project' ? 'rgba(141, 128, 234,0.28)' : 'rgba(255,255,255,0.05)' },
            ...focusVisibleStyles,
          }}
        >
          Prosjekt
        ...
        <Button
          ...
          sx={{
            ...
            '&:hover': { bgcolor: poolMode === 'pool' ? 'rgba(141, 128, 234,0.28)' : 'rgba(255,255,255,0.05)' },
            ...focusVisibleStyles,
          }}
        >
          Maler
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} useFlexGap flexWrap="wrap">
          <Button
            ...
            sx={{
              minHeight: 38,
              borderColor: roleBorder,
              color: proViewMode === 'pipeline' ? '#0d0a24' : roleText,
          ...
          <Button
            ...
            sx={{
              minHeight: 38,
              borderColor: roleBorder,
              color: proViewMode === 'timeline' ? '#0d0a24' : roleText,
                      ...
                      {column.schedules.map((schedule) => {
                        ...
                        return (
                          <Card
                            ...
                            sx={{
                              cursor: 'pointer',
                              bgcolor: isFocused ? 'rgba(141, 128, 234,0.18)' : roleSurface,
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1.25 }}>
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1} sx={{ alignItems: { sm: 'center' } }}>
                <Button
                  ...
                  sx={{ minHeight: 34, borderColor: roleBorder, color: proTimelineMode === 'day' ? '#0d0a24' : roleText, bgcolor: proTimelineMode === 'day' ? roleTabAccent : 'transparent' }}
                >
                  Dag
                </Button>
                <Button
                  ...
                  sx={{ minHeight: 34, borderColor: roleBorder, color: proTimelineMode === 'week' ? '#0d0a24' : roleText, bgcolor: proTimelineMode === 'week' ? roleTabAccent : 'transparent' }}
                >
                  Uke
                </Button>
                <TextField
                        ...
                        {bucket.items.map((schedule) => (
                          <Box
                            ...
                            sx={{
                              ...
                              bgcolor: selectedProSchedule?.id === schedule.id ? 'rgba(141, 128, 234,0.14)' : roleSurface,
                              cursor: 'pointer',
                            }}
                          >
        ...
        >
          ...
          {selectedProSchedule ? (
            <>
              ...
              <Stack direction="row" spacing={1} useFlexGap flexWrap="wrap">
                <Button size="small" variant="contained" onClick={() => onEditSchedule(selectedProSchedule)} sx={{ bgcolor: roleTabAccent, color: '#0d0a24', fontWeight: 700, '&:hover': { bgcolor: roleTabAccentHover } }}>
                  Rediger
                </Button>
                ...
                <Button
                  ...
                  sx={{
                    color: proCompareIds.has(selectedProSchedule.id) ? '#0d0a24' : roleText,
        ...
        <TextField
          ...
          sx={{
            ...
            '& .MuiOutlinedInput-root': {
              ...
              '& fieldset': { borderColor: dateFilter ? 'rgba(141, 128, 234,0.5)' : 'rgba(255,255,255,0.15)' },
              '&.Mui-focused fieldset': { borderColor: roleTabAccent },
            },
          }}
        />
          ...
          <FormControl size="small" sx={{ minWidth: 160, display: { xs: 'none', md: 'flex' } }}>
            <Select
              ...
              sx={{
                ...
                minHeight: TOUCH_TARGET_SIZE,
                '& .MuiOutlinedInput-notchedOutline': { borderColor: candidateFilter !== 'all' ? 'rgba(141, 128, 234,0.5)' : 'rgba(255,255,255,0.15)' },
                '&.Mui-focused .MuiOutlinedInput-notchedOutline': { borderColor: roleTabAccent },
            ...
            <Tooltip key={mode} title={label}>
              <IconButton
                ...
                sx={{
                  ...
                  bgcolor: viewMode === mode ? 'rgba(141, 128, 234,0.12)' : 'transparent',
                  border: '1px solid',
                  borderColor: viewMode === mode ? 'rgba(141, 128, 234,0.4)' : 'rgba(255,255,255,0.12)',
                  '&:hover': { bgcolor: 'rgba(141, 128, 234,0.08)', borderColor: 'rgba(141, 128, 234,0.3)' },
                  ...focusVisibleStyles,
                }}
              >
                {icon}
          ...
          <Tooltip title={auditionGroupedView ? 'Vis individuelle kandidater' : 'Grupper som auditions'}>
            <IconButton
              ...
              sx={{
                ...
                bgcolor: auditionGroupedView ? 'rgba(141, 128, 234,0.12)' : 'transparent',
                border: '1px solid',
                borderColor: auditionGroupedView ? 'rgba(141, 128, 234,0.4)' : 'rgba(255,255,255,0.12)',
                '&:hover': { bgcolor: 'rgba(141, 128, 234,0.08)', borderColor: 'rgba(141, 128, 234,0.3)' },
                ...focusVisibleStyles,
              }}
            >
      ...
      >
        ...
        <Chip
          ...
          sx={{
            cursor: 'pointer',
            bgcolor: favoritesOnly ? 'rgba(141, 128, 234,0.2)' : 'transparent',
            color: favoritesOnly ? roleTabAccent : 'rgba(255,255,255,0.6)',
            borderColor: favoritesOnly ? 'rgba(141, 128, 234,0.5)' : 'rgba(255,255,255,0.15)',
            '&:hover': { bgcolor: 'rgba(141, 128, 234,0.15)', borderColor: 'rgba(141, 128, 234,0.4)' },
          }}
        />
        ...
        {searchQuery && (
          <Chip size="small" label={`"${searchQuery}"`}
            ...
            sx={{ bgcolor: 'rgba(141, 128, 234,0.15)', color: roleTabAccent, borderColor: 'rgba(141, 128, 234,0.3)', '& .MuiChip-deleteIcon': { color: roleTabAccent } }} />
        )}
        {dateFilter && (
          <Chip size="small" label={`📅 ${dateFilter}`}
            onDelete={() => setDateFilter('')}
            sx={{ bgcolor: 'rgba(141, 128, 234,0.12)', color: roleTabAccent, '& .MuiChip-deleteIcon': { color: roleTabAccent } }} />
        )}
        {candidateFilter !== 'all' && (
            ...
            <Box sx={{ mt: 3, display: 'flex', justifyContent: 'center' }}>
              <Button
                ...
                sx={{
                  ...
                  py: 1.5,
                  minHeight: TOUCH_TARGET_SIZE,
                  '&:hover': { borderColor: roleTabAccent, bgcolor: 'rgba(141, 128, 234,0.1)' },
                  ...focusVisibleStyles,
                }}
              >
          ...
          <TableContainer component={Paper} sx={{ bgcolor: 'rgba(255,255,255,0.02)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 1.5, overflow: 'hidden' }}>
                      ...
                      return (
                        <TableRow
                          ...
                          sx={{
                            height: 56,
                            cursor: 'pointer',
                            bgcolor: isSelected ? 'rgba(141, 128, 234,0.07)' : 'transparent',
                            '&:hover': { bgcolor: isSelected ? 'rgba(141, 128, 234,0.11)' : 'rgba(255,255,255,0.03)' },
                            '&:focus-within': { outline: '2px solid rgba(141, 128, 234,0.4)', outlineOffset: -1 },
              ...
              >
                ...
                <MenuItem onClick={() => { if (rowMenuAnchor) handleSaveToPool(rowMenuAnchor.schedule); setRowMenuAnchor(null); }} sx={{ gap: 1.5, fontSize: 14 }}>
                  <InventoryIcon sx={{ fontSize: 16, color: '#4227b0' }} /> Lagre til pool
                </MenuItem>
                <Divider sx={{ borderColor: 'rgba(255,255,255,0.1)' }} />
            ...
            return (
              <Box
                ...
                sx={{
                  ...
                  '&:hover': { bgcolor: isSelected ? 'rgba(141, 128, 234,0.1)' : 'rgba(255,255,255,0.03)' },
              ...
              <Box key={schedule.id}>
                <Card
                  ...
                  sx={{
                    ...
                    display: 'flex',
                    flexDirection: 'column',
                    bgcolor: selectedIds.has(schedule.id) ? 'rgba(141, 128, 234,0.15)' : 'rgba(255,255,255,0.05)',
                      ...
                      <Box sx={{ mt: { xs: 1.5, md: 2 } }}>
                        <Button
                          ...
                          sx={{
                            ...
                            '&:hover': { color: roleTabAccentHover, bgcolor: 'rgba(141, 128, 234,0.1)' },
                            '@keyframes writing': {
                        ...
                        <Collapse in={isExpanded}>
                          <Box
                            sx={{
                              ...
                              p: { xs: 2, md: 2.5 },
                              borderRadius: 2,
                              bgcolor: 'rgba(141, 128, 234,0.08)',
                              border: '2px solid rgba(141, 128, 234,0.3)',
                              boxShadow: '0 4px 16px rgba(141, 128, 234,0.1)',
                              position: 'relative',
                              overflow: 'hidden',
                              '&::before': {
                                content: '""',
                            ...
                            <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5, mb: 1.5, pl: 1 }}>
                              <Box
                                sx={{
                                  ...
                                  border: '2px solid rgba(141, 128, 234,0.4)',
                                  display: 'flex',
                                  alignItems: 'center',
                                  justifyContent: 'center',
                                  '@keyframes writing': {
                              ...
                              >
                                <NoteIcon
                                  sx={{
                                    ...
                                    color: roleTabAccent,
                                    animation: 'writing 2.5s ease-in-out infinite',
                                    filter: 'drop-shadow(0 2px 4px rgba(141, 128, 234,0.3))',
                                  }}
                                />
                              </Box>
                              <Typography
                    ...
                    >
                      ...
                      <Button
                        ...
                        sx={{
                          ...
                          minHeight: { xs: TOUCH_TARGET_SIZE, md: 48 },
                          px: { xs: 1, md: 2 },
                          '&:hover': { bgcolor: 'rgba(141, 128, 234,0.1)' },
                          ...focusVisibleStyles,
                        }}
                      >
                        Åpne detaljer
      ...
      {poolMode === 'pool' && (
        <Box>
          ...
          >
            <Typography variant="subtitle1" sx={{ color: '#4227b0', fontWeight: 600, mb: 1, display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          {poolLoading ? (
            ...
            <Box
              ...
              sx={{
                ...
                py: { xs: 4, sm: 8 },
                px: 4,
                bgcolor: 'rgba(66, 39, 176, 0.03)',
                borderRadius: 3,
                border: '2px dashed rgba(66, 39, 176, 0.2)',
              }}
            >
              <Box
                sx={{
              ...
              >
                <InventoryIcon sx={{ fontSize: { xs: 30, sm: 40 }, color: '#4227b0' }} />
              </Box>
              ...
              {poolAuditions.map((poolAudition) => (
                <Grid item xs={12} sm={6} md={4} lg={3} key={poolAudition.id}>
                  <Card
                    sx={{
                      bgcolor: 'rgba(66, 39, 176, 0.08)',
                      border: '1px solid rgba(66, 39, 176, 0.3)',
                      borderRadius: 2,
                      transition: 'all 0.2s',
                      '&:hover': {
                        borderColor: '#4227b0',
                  ...
                  p === 'ellipsis' ? (
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        height: 32,
                        px: 1,
                        bgcolor: safePage === p ? 'var(--role-accent, #8d80ea)' : 'transparent',
                        color: safePage === p ? '#fff' : 'rgba(255,255,255,0.7)',
                        fontWeight: safePage === p ? 700 : 500,
                        '&:hover': { bgcolor: safePage === p ? '#7666e6' : 'rgba(141, 128, 234,0.18)' },
                      }}
                    >
                      {p}
                    </Button>
          ...
          <FormControl size="small" sx={{ minWidth: 120 }}>
            <Select
              ...
              sx={{
                ...
                '&:hover fieldset': { borderColor: 'rgba(141, 128, 234,0.3)' },
      ...
      <Snackbar
        ...
        sx={{ '& .MuiSnackbarContent-root': { bgcolor: '#1f1d37' } }}
      />

      ...
      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 3 }}>
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          <Typography variant="h6" sx={{ color: '#fff', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 1 }}>
            <LocalOfferIcon sx={{ color: 'var(--role-violet, #756be7)' }} />
        ...
        {!readOnly ? (
          <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap', justifyContent: 'flex-end' }}>
            <Button
              ...
              sx={{ borderColor: 'var(--role-violet, #756be7)', color: 'var(--role-violet, #756be7)' }}
            >
              Nytt tilbud
            </Button>
            <Button
                  ...
                  <Card sx={{ bgcolor: 'rgba(255,255,255,0.05)', border: '1px solid rgba(255,255,255,0.1)', borderRadius: 2 }}>
                    <CardContent>
                      <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', mb: 2 }}>
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                          <Avatar sx={{ bgcolor: 'rgba(117, 107, 231,0.2)', width: 40, height: 40 }}>
                            <PersonIcon sx={{ color: 'var(--role-violet, #756be7)' }} />
                          </Avatar>
                          <Box>

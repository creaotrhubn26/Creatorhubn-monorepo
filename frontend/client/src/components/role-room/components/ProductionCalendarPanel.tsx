...
const EVENT_TYPES = [
  ...
  { value: 'rehearsal', label: 'Prøve', icon: <GroupsIcon />, color: 'var(--role-violet, #756be7)' },
...
const modalFieldSx = {
  ...
  '& .MuiOutlinedInput-root': {
    ...
    '&:hover fieldset': {
      borderColor: 'rgba(158, 147, 237,0.58)',
    },
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2.5 }}>
      <Box
        sx={{
          ...
          background: 'linear-gradient(120deg, rgba(84, 70, 225,0.16) 0%, rgba(56,189,248,0.1) 52%, rgba(15,23,42,0.24) 100%)',
        }}
      >
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.25 }}>
          <Box
            sx={{
              ...
              boxShadow: '0 8px 20px rgba(82, 62, 224,0.3)',
            }}
          >
      ...
      <Box sx={{ display: 'flex', justifyContent: 'flex-end', gap: 1 }}>
        <Box
          ...
          sx={{
            ...
            py: 0.75,
            borderRadius: 1.5,
            border: viewMode === 'crew' ? '1px solid rgba(117, 107, 231,0.5)' : '1px solid rgba(255,255,255,0.15)',
            bgcolor: viewMode === 'crew' ? 'rgba(117, 107, 231,0.22)' : 'transparent',
            ...
            '&:hover': { bgcolor: viewMode === 'crew' ? 'rgba(117, 107, 231,0.32)' : 'rgba(255,255,255,0.05)' },
          }}
        >
        ...
        <Box>
          ...
          <CrewCalendarView
            ...
            eventTypeConfig={{
              ...
              rehearsal: { label: 'Prøve', color: 'var(--role-violet, #756be7)', icon: <GroupsIcon /> },
                    ...
                    >
                      ...
                      >
                        ...
                        {eventCandidates.length > 0 && (
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 0.5 }}>
                            <PersonIcon sx={{ fontSize: 14, color: 'var(--role-violet, #756be7)' }} />
                            <Typography variant="body2" sx={{ color: 'rgba(255,255,255,0.87)' }}>
        ...
        slotProps={{
          paper: {
            sx: {
              ...
              boxShadow:
                '0 28px 90px rgba(0,0,0,0.6), 0 0 0 1px rgba(34,211,238,0.14) inset, 0 0 32px rgba(118, 102, 230,0.25)',
              overflow: 'hidden',
            },
          },
        }}
      >
        <DialogTitle
          sx={{
            ...
            alignItems: 'center',
            gap: 1.25,
            borderBottom: '1px solid rgba(118, 102, 230,0.35)',
            background: 'linear-gradient(120deg, rgba(84, 70, 225,0.42) 0%, rgba(15,23,42,0.9) 55%, rgba(34,211,238,0.24) 100%)',
          }}
        >
          <Box sx={{ color: eventTypeConfig.color, display: 'inline-flex', alignItems: 'center' }}>
            {eventTypeConfig.icon}
          </Box>
          <CalendarMonthIcon sx={{ color: '#9e93ed' }} />
        ...
        <DialogActions
          sx={{
            borderTop: '1px solid rgba(118, 102, 230,0.25)',
        ...
        >
          <Button
            ...
            sx={{
              ...
              '&:hover': { bgcolor: 'rgba(30,41,59,0.88)', borderColor: 'rgba(118, 102, 230,0.5)' },
            }}
          >
            Avbryt
          </Button>

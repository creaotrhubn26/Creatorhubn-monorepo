    ...
    <Stack spacing={1.2} sx={CARD_SX}>
      <Stack direction="row" alignItems="center" spacing={1}>
        ...
        <Button
          ...
          startIcon={<AddIcon />}
          onClick={openCreate}
          sx={{ textTransform: 'none', color: '#c6bdf4', fontWeight: 700 }}
        >
          Ny kampanje
        </Button>
      </Stack>
        ...
        <Stack spacing={1} sx={{ p: 1.2, borderRadius: 1.5, bgcolor: 'rgba(148,163,184,0.06)', border: '1px solid rgba(148,163,184,0.16)' }}>
          {accountError ? (
            ...
            <>
              ...
              <Stack spacing={0.9} sx={{ mt: 0.5, p: 1, borderRadius: 1.5, bgcolor: 'rgba(198, 189, 244,0.06)', border: '1px solid rgba(198, 189, 244,0.22)' }}>
                <Stack direction="row" alignItems="center" spacing={0.8}>
                  <AutoAwesomeIcon sx={{ fontSize: 17, color: '#c6bdf4' }} />
                  <Typography sx={{ color: '#c6bdf4', fontWeight: 700, fontSize: '0.82rem' }}>AI-annonsetekst</Typography>
                </Stack>
                ...
                <Button size="small" variant="outlined" startIcon={generating ? <CircularProgress size={14} /> : <AutoAwesomeIcon />}
                  disabled={generating}
                  onClick={runGenerate}
                  sx={{ textTransform: 'none', fontWeight: 700, color: '#c6bdf4', borderColor: 'rgba(198, 189, 244,0.4)', alignSelf: 'flex-start' }}>
                      ...
                      return (
                        <Box key={i} onClick={() => setSelectedVariant(i)}
                          sx={{
                            ...
                            bgcolor: selected ? 'rgba(198, 189, 244,0.12)' : 'rgba(148,163,184,0.06)',
                            border: `1px solid ${selected ? 'rgba(198, 189, 244,0.6)' : 'rgba(148,163,184,0.18)'}`,
                          }}>
                          ...
                          <Stack direction="row" spacing={0.6} sx={{ mt: 0.4, flexWrap: 'wrap', gap: 0.4 }}>
                            {v.callToAction && <Chip size="small" label={v.callToAction} sx={{ height: 18, fontSize: '0.66rem', color: '#c6bdf4', bgcolor: 'rgba(198, 189, 244,0.1)' }} />}
        ...
        <Stack spacing={1.2} sx={{ pt: 0.5 }}>
          ...
          <Stack direction="row" alignItems="center" justifyContent="space-between">
            ...
            <Button
              ...
              sx={{ textTransform: 'none', color: '#c6bdf4', fontSize: '0.74rem' }}
            >

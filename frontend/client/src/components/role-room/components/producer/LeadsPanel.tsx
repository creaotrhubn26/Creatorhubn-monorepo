...
const STAGES: { key: Stage; label: string; color: string }[] = [
  ...
  { key: 'booket', label: 'Booket møte', color: '#9d97ee' },
              ...
              {!formId ? (
                ...
                <Stack spacing={1}>
                  <Stack direction="row" alignItems="center" justifyContent="space-between" flexWrap="wrap" useFlexGap>
                    ...
                    <Stack direction="row" spacing={1} alignItems="center">
                      <Button
                        ...
                        sx={{ bgcolor: 'rgba(118, 102, 230,0.9)', '&:hover': { bgcolor: 'rgb(82, 62, 224)' } }}
                      >
                  ...
                  {autoSegment.data && autoSegment.data.success === false ? (
                    ...
                    <Typography sx={{ fontSize: '0.78rem', color: '#c4bef4' }}>
                  ...
                  {activeSegment ? (
                    <Box sx={{ bgcolor: `${activeSegment.color}14`, color: '#e2e8f0', border: `1px solid ${activeSegment.color}40`, borderRadius: 1.5, p: 1.4 }}>
                      ...
                      <Button
                        ...
                        sx={{ mt: 1, bgcolor: 'rgba(118, 102, 230,0.9)', '&:hover': { bgcolor: 'rgb(82, 62, 224)' } }}
                      >
                          ...
                          {(retargetingCopy.data.variants || []).map((v, i) => (
                            <Box key={i} sx={{ bgcolor: 'rgba(2,6,23,0.4)', border: '1px solid rgba(148,163,184,0.18)', borderRadius: 1.5, p: 1.2 }}>
                              ...
                              <Stack direction="row" spacing={1} alignItems="center" sx={{ mt: 0.6 }}>
                                <Chip size="small" label={v.cta} sx={{ height: 20, fontSize: '0.66rem', bgcolor: 'rgba(118, 102, 230,0.2)', color: '#c4bef4' }} />
                                <Button size="small" sx={{ minWidth: 0, fontSize: '0.72rem', textTransform: 'none', color: '#9e93ed' }}
                  ...
                  <Box sx={{ border: '1px solid rgba(34,197,94,0.35)', bgcolor: 'rgba(34,197,94,0.07)', borderRadius: 2, p: 1.6 }}>
                    ...
                    <Box sx={{ display: 'grid', gridTemplateColumns: { xs: 'repeat(2,1fr)', sm: 'repeat(4,1fr)', md: 'repeat(7,1fr)' }, gap: 1 }}>
                      {[
                        ...
                        { label: 'Booket møte', value: String(summary?.booked ?? 0), color: '#9d97ee' },
                      ...
                      <Box sx={{ px: 1.4, pb: 1.6 }}>
                        ...
                        {cfg ? (
                          <Stack spacing={1.4}>
                            ...
                            <Box sx={{ border: '1px solid rgba(118, 102, 230,0.3)', bgcolor: 'rgba(118, 102, 230,0.06)', borderRadius: 1.5, px: 1.4, py: 0.6 }}>
                              <FormControlLabel
                                ...
                                label={
                                  <Box>
                                    <Typography sx={{ fontSize: '0.86rem', color: '#f8fafc', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 0.5 }}>
                                      <AiIcon sx={{ fontSize: 16, color: '#9e93ed' }} /> La AI skrive en personlig melding til hver lead
                                    </Typography>
                                ...
                                <Stack direction="row" spacing={0.3} alignItems="center">
                                  ...
                                  {l.segmentReason ? (
                                    <Tooltip title={`AI: ${l.segmentReason}`} arrow>
                                      <AiIcon sx={{ fontSize: 14, color: '#9e93ed', flexShrink: 0 }} />
                                    </Tooltip>
                                  ) : null}
                                </Stack>
                              </TableCell>

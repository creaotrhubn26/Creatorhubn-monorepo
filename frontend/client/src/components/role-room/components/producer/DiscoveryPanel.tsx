          ...
          <Stack direction="row" spacing={0.6} flexWrap="wrap" useFlexGap>
            {MODES.map((m) => (
              <Chip
                ...
                sx={{ fontWeight: 700, bgcolor: mode === m.key ? 'rgba(93, 118, 203,0.18)' : 'transparent', color: mode === m.key ? 'var(--role-cyan, #5d76cb)' : 'rgba(226,232,240,0.7)' }}
              />
            ))}
          </Stack>
            ...
            <Box>
              <Stack direction="row" spacing={1} alignItems="center" sx={{ mb: 0.5 }}>
                ...
                {data.page.verified === 'blue_verified' || data.page.verified === 'gray_verified' ? (
                  <Chip size="small" label="Verifisert" sx={{ height: 18, fontSize: '0.66rem', bgcolor: 'rgba(93, 118, 203,0.2)', color: 'var(--role-cyan, #93a4dc)' }} />
                ) : null}
              </Stack>

...
import ClientAdsDiagnosticsPanel from './ClientAdsDiagnosticsPanel';
    ...
    <Box sx={{ color: palette.textPrimary }}>
            ...
            <Stack spacing={2}>
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:disabled': { background: 'rgba(118, 102, 230,0.32)', color: 'rgba(255,255,255,0.5)' },
                }}
              >
            ...
            <CardContent>
              ...
              <Stack direction="row" spacing={1.2} sx={{ flexWrap: 'wrap', gap: 1, mb: 1.4 }}>
                <Chip
                  ...
                  sx={{ bgcolor: 'rgba(118, 102, 230,0.18)', color: palette.accent, fontWeight: 700, fontSize: '0.78rem' }}
                />
                <Chip
                  label={discoveryResult.business_subcategory}
                  sx={{ bgcolor: 'rgba(118, 102, 230,0.08)', color: palette.textSecondary, fontSize: '0.78rem' }}
                />
              ...
              <Stack direction="row" spacing={1.4}>
                <Button
                  ...
                  sx={{
                    ...
                    px: 3,
                    '&:hover': { background: 'linear-gradient(135deg, #523ee0 0%, #4926d3 100%)' },
                    '&:disabled': { background: 'rgba(118, 102, 230,0.32)' },
                  }}
                >
      ...
      {stage === 'saved' && savedConfigId && discoveryResult ? (
        <Stack spacing={2}>
          ...
          {/* N2-B6 — Monitoring + Diagnostics (live event-tracking) */}
          <ClientAdsDiagnosticsPanel configId={savedConfigId} />
...
function tabBtnSx(active: boolean) {
  return {
    ...
    py: 0.6,
    borderRadius: 999,
    bgcolor: active ? 'rgba(118, 102, 230,0.18)' : 'transparent',
    color: active ? palette.accent : palette.textMuted,
    border: `1px solid ${active ? palette.borderStrong : palette.borderSubtle}`,
    '&:hover': { bgcolor: 'rgba(118, 102, 230,0.10)', color: palette.textPrimary },
  };
}
          ...
          <Box sx={{ flex: 1 }}>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 0.4, flexWrap: 'wrap', gap: 0.4 }}>
              ...
              <Chip
                ...
                size="small"
                sx={{ bgcolor: 'rgba(118, 102, 230,0.14)', color: palette.accent, fontSize: '0.7rem', height: 18 }}
              />
              <Chip

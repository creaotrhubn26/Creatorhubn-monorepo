            ...
            <Stack spacing={2}>
              ...
              <Button
                ...
                sx={{
                  ...
                  '&:disabled': { background: 'rgba(93, 118, 203,0.32)', color: 'rgba(255,255,255,0.5)' },
                }}
              >
            ...
            <CardContent>
              ...
              <Stack direction="row" spacing={1.2} sx={{ flexWrap: 'wrap', gap: 1, mb: 1.4 }}>
                <Chip
                  ...
                  sx={{ bgcolor: 'rgba(93, 118, 203,0.18)', color: palette.accent, fontWeight: 700, fontSize: '0.78rem' }}
                />
                <Chip
                  label={discoveryResult.business_subcategory}
                  sx={{ bgcolor: 'rgba(93, 118, 203,0.08)', color: palette.textSecondary, fontSize: '0.78rem' }}
                />
              ...
              <Stack direction="row" spacing={1.4}>
                <Button
                  ...
                  sx={{
                    ...
                    px: 3,
                    '&:hover': { background: 'linear-gradient(135deg, #4b3d8f 0%, #3e3180 100%)' },
                    '&:disabled': { background: 'rgba(93, 118, 203,0.32)' },
                  }}
                >
          ...
          <Box sx={{ flex: 1 }}>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 0.4, flexWrap: 'wrap', gap: 0.4 }}>
              ...
              <Chip
                ...
                size="small"
                sx={{ bgcolor: 'rgba(93, 118, 203,0.14)', color: palette.accent, fontSize: '0.7rem', height: 18 }}
              />
              <Chip

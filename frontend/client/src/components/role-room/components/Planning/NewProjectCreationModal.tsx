...
const TROLL_AREA_CONFIG: Record<string, { Icon: any; color: string; label: string }> = {
  project: { Icon: DashboardIcon, color: 'var(--role-violet, #756be7)', label: 'Prosjekt' },
  ...
  equipment: { Icon: PropIcon, color: '#523ee0', label: 'Utstyr' },
  production_days: { Icon: CalendarIcon, color: '#4227b0', label: 'Prod.dager' },
  ...
  contracts: { Icon: ContractsIcon, color: '#5446e1', label: 'Kontrakter' },
  ...
  const renderStep0 = () => (
    <Box sx={{ mt: { xs: 1, sm: 2 } }}>
      ...
      {!initialData?.id && isCastingPlanner && (
        <Card sx={{ mb: { xs: 2, sm: 2.5, md: 3 }, borderRadius: 2, bgcolor: 'rgba(66, 39, 176, 0.08)', border: '1px solid rgba(66, 39, 176, 0.3)' }}>
          <CardContent sx={{ p: 2 }}>
            <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: 1.5 }}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
                <MovieFilterIcon sx={{ color: '#a193d8', fontSize: 28 }} />
                <Box>
                  <Typography variant="subtitle2" sx={{ color: '#a193d8', fontWeight: 600 }}>
                    {demoProjectTitle}
                  </Typography>
              ...
              <Button
                ...
                sx={{
                  borderColor: trollInitStatus === 'complete' ? '#4caf50' : '#4227b0',
                  color: trollInitStatus === 'complete' ? '#81c784' : '#a193d8',
                  '&:hover': { 
                    borderColor: trollInitStatus === 'complete' ? '#66bb6a' : '#7b68c8', 
                    bgcolor: trollInitStatus === 'complete' ? 'rgba(76, 175, 80, 0.1)' : 'rgba(66, 39, 176, 0.1)' 
                  },
                  minWidth: 160,
                }}
              >
            ...
            {(trollInitStatus === 'loading' || trollInitStatus === 'complete') && Object.keys(trollInitAreas).length > 0 && (
              <Box sx={{ mt: 2, pt: 2, borderTop: '1px solid rgba(66, 39, 176, 0.2)' }}>
        ...
        <CardContent sx={{ p: { xs: 2, sm: 2.5, md: 3, lg: 3.5, xl: 4 } }}>
          <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: { xs: 1, sm: 1.25, md: 1.5, lg: 1.75, xl: 2 }, mb: { xs: 1, sm: 1.25, md: 1.5, lg: 1.75, xl: 2 } }}>
            <Typography variant="h6" gutterBottom={false} sx={{ fontWeight: 700, fontSize: { xs: '1rem', sm: '1.063rem', md: '1.125rem', lg: '1.188rem', xl: '1.25rem' }, display: 'flex', alignItems: 'center', gap: { xs: 0.75, sm: 1, md: 1.25, lg: 1.5, xl: 1.75 } }}>
              <SplitSheetIcon sx={{ color: '#847be9', fontSize: { xs: '1.25rem', sm: '1.375rem', md: '1.5rem', lg: '1.625rem', xl: '1.75rem' } }} />
            ...
            <Stack direction={{ xs: 'column', md: 'row' }} spacing={1.5} flexWrap="wrap">
              ...
              {projectData.splitSheetData?.contributors?.length ? (
                <Chip
                  ...
                  sx={{ alignSelf: 'flex-start', bgcolor: 'rgba(118, 102, 230,0.16)', color: '#c4bef4' }}
                />
              ) : null}
            </Stack>
            <Button
    ...
    <>
              ...
              <Stack spacing={2}>
                ...
                >
                  ...
                  <Stack direction="row" spacing={0.75} flexWrap="wrap" useFlexGap>
                    ...
                    <Chip size="small" label="3. Oppsummering" sx={{ bgcolor: 'rgba(118, 102, 230,0.16)', color: '#dedbf9' }} />
                  </Stack>
                </Stack>
                <Stack
                  direction={{ xs: 'column', sm: 'row' }}
      ...
      >
        ...
        >
          ...
          {/* Tilgjengelighet Card - synced with CrewManagementPanel, uses Kalender tab colors (#4227b0) */}
          <Card sx={{ 
            mb: 0, 
            borderRadius: 3, 
            boxShadow: '0 2px 8px rgba(0,0,0,0.3)',
            ...
            <CardContent sx={{ p: 3 }}>
              <Typography variant="h6" gutterBottom sx={{ 
                ...
                <CalendarIcon sx={{ color: '#4227b0' }} />
                Tilgjengelighet
              </Typography>
              <Divider sx={{ mb: 2, mt: 1, borderColor: 'rgba(66, 39, 176,0.3)' }} />
                ...
                <TextField
                  ...
                  sx={{
                    '& .MuiOutlinedInput-root': {
                      color: '#fff',
                      minHeight: TOUCH_TARGET_SIZE,
                      '& fieldset': { borderColor: 'rgba(66, 39, 176,0.4)' },
                      '&:hover fieldset': { borderColor: 'rgba(66, 39, 176,0.6)' },
                      '&.Mui-focused fieldset': { borderColor: '#4227b0', borderWidth: 2 },
                    },
                    '& .MuiInputLabel-root': { color: 'rgba(255,255,255,0.87)' },
                  ...
                  <Stack spacing={{ xs: 1.25, sm: 1.5, md: 1.75, lg: 2, xl: 2.25 }}>
                    {projectData.collaborators.map((collab) => {
                      ...
                      const getRoleColor = (role?: ContributorRole) => {
                        ...
                        if (['video_editor', 'cinematographer', 'colorist'].includes(role)) return '#756be7';
      ...
      <Dialog open={trollInitDialogOpen} onClose={() => setTrollInitDialogOpen(false)} maxWidth="sm" fullWidth>
        <DialogTitle sx={{ fontWeight: 700, display: 'flex', alignItems: 'center', gap: 1 }}>
          <SvgIcon sx={{ color: '#4227b0' }}><InterpreterModeIcon /></SvgIcon>

        ...
        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1.5 }}>
          ...
          <Box>
            ...
            <Typography sx={{ color: roleTextMuted, fontSize: 12 }}>
              <BadgeIcon sx={{ fontSize: 13, verticalAlign: 'middle', mr: 0.5, color: 'rgba(224, 219, 250,0.6)' }} />
        ...
        >
          ...
          <Button
            ...
            sx={{
              ...
              ...focusVisibleStyles,
              boxShadow: '0 10px 24px rgba(48, 31, 132,0.35)',
              '&:hover': { bgcolor: roleTabAccentHover, boxShadow: '0 12px 28px rgba(48, 31, 132,0.45)' },
            }}
          >
            Lagre
          </Button>

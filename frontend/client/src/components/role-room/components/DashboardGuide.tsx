          ...
          <>
            ...
            >
              {[
                ...
                { color: 'var(--role-violet, #756be7)', label: 'Valgt', desc: 'Selected by the team, pending confirmation.' },
          ...
          <>
            ...
            >
              {[
                ...
                { label: 'Ny timeplan', color: 'var(--role-violet, #756be7)', desc: 'Opens the audition scheduler. Requires at least one role and one candidate to be created first.' },
              ].map(a => (

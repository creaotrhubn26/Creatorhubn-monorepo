...
export function ConsentManagementPanel({ projectId, candidateId, onUpdate }: ConsentManagementPanelProps) {
  ...
  const consentDialogAccentColor = 'var(--role-accent, #8d80ea)';
              ...
              >
                <CardContent>
                  ...
                  {consent.accessCode && !consent.signed && (
                    <Typography variant="caption" sx={{ color: '#4227b0', display: 'block', mb: 1 }}>
              ...
              <TextField
                ...
                sx={{
                  '& .MuiOutlinedInput-root': {
                    ...
                    '&:hover fieldset': { borderColor: '#a193d8' },
                  },
                  '& .MuiInputLabel-root': { color: 'rgba(255,255,255,0.87)' },
              ...
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  sx={{
                    ...
                    '&:hover .MuiOutlinedInput-notchedOutline': { borderColor: '#a193d8' },
                  }}
                >
                ...
                <Box sx={{ 
                  ...
                  <Stack direction="row" spacing={2}>
                    <Button
                      ...
                      sx={{ 
                        color: copySuccess ? '#10b981' : '#a193d8', 
                        borderColor: copySuccess ? '#10b981' : '#a193d8',
                      }}
                    >
                    ...
                    <Button
                      ...
                      sx={{ color: '#a193d8', borderColor: '#a193d8' }}
                    >
                      Åpne portal
                    </Button>
                  </Stack>

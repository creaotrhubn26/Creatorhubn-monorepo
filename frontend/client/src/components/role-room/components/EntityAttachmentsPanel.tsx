        ...
        <Stack direction="row" alignItems="center" spacing={1}>
          ...
          <Typography sx={{ fontWeight: 700, fontSize: '0.86rem', color: palette.textPrimary }}>
            Vedlegg {files.length > 0 && <Chip
              label={files.length}
              size="small"
              sx={{ ml: 0.6, height: 18, fontSize: '0.68rem', bgcolor: 'rgba(118, 102, 230,0.18)', color: palette.accent, fontWeight: 700 }}
            />}
          </Typography>
        </Stack>
        <input

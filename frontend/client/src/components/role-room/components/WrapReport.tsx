      ...
      <Box sx={{ flex: 1, overflow: 'auto', bgcolor: '#fff', borderRadius: 2, p: 3 }} ref={printRef}>
        ...
        <Box className="section" sx={{ mb: 3 }}>
          ...
          <Stack direction="row" spacing={2} sx={{ p: 2 }}>
            ...
            <Paper variant="outlined" sx={{ p: 2, flex: 1, textAlign: 'center', bgcolor: '#eef1fb' }}>
              <Typography variant="h3" sx={{ color: 'var(--role-violet, #5d76cb)' }}>{report.printTakes}</Typography>

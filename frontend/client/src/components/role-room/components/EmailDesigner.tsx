...
<head>
  ...
  <style>
    ...
    .variable-highlight {
      background-color: rgba(83, 59, 202, 0.1);
      color: ${theme.brandLabelColor};
      padding: 2px 6px;
      border-radius: 4px;
                  ...
                  return (
                    <Paper
                      ...
                      sx={{
                        p: 2,
                        cursor: 'pointer',
                        bgcolor: isSelected ? 'rgba(117, 107, 231, 0.15)' : '#161b22',
                        border: isSelected 
                        ...
                        '&:hover': {
                          bgcolor: isSelected ? 'rgba(117, 107, 231, 0.2)' : 'rgba(255,255,255,0.05)',

      ...
      <CardContent>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          <Typography variant="h6" sx={{ color: '#fff', fontWeight: 600, display: 'flex', alignItems: 'center', gap: 1 }}>
            <CarIcon sx={{ color: 'var(--role-cyan, #5d76cb)' }} />
            Reisekostnader
          </Typography>
          <Chip
                    ...
                    <ListItemText
                      primary={
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 1, justifyContent: 'space-between' }}>
                          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
                            <MoneyIcon sx={{ fontSize: 16, color: 'var(--role-cyan, #5d76cb)' }} />
                            <Typography variant="body1" sx={{ color: 'var(--role-cyan, #5d76cb)', fontWeight: 600 }}>

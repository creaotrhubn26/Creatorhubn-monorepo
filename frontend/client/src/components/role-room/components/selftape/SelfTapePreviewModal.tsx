                  ...
                  <Stack direction="row" alignItems="center" spacing={1} sx={{ flex: 1 }}>
                    <TextField
                      ...
                      sx={{
                        ...
                        '& .MuiOutlinedInput-notchedOutline': { borderColor: 'rgba(136, 117, 235,0.32)' },
                    ...
                    <Button
                      ...
                      sx={{
                        ...
                        fontSize: '0.78rem',
                        px: 1.4,
                        '&.Mui-disabled': { background: 'rgba(136, 117, 235,0.32)', color: 'rgba(255,255,255,0.5)' },
                      }}
                    >
              ...
              <Box>
                ...
                <TextField
                  ...
                  sx={{
                    ...
                    '& .MuiOutlinedInput-notchedOutline': { borderColor: 'rgba(136, 117, 235,0.24)' },
                    '&:hover .MuiOutlinedInput-notchedOutline': { borderColor: palette.accentBright },
                  }}
                />

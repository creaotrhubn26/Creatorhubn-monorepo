...
export default function AuditPage({ demoMode }: AuditPageProps) {
  ...
  return (
    <Box sx={{ p: 3, maxWidth: 980, mx: 'auto' }}>
      ...
      {demoMode ? (
        <Alert severity="info" sx={{ mb: 3, bgcolor: 'rgba(75, 61, 143,0.12)', color: palette.textPrimary, '& .MuiAlert-icon': { color: palette.accentBright } }}>
      ...
      {rows.length === 0 && !demoMode ? (
        ...
        <Stack spacing={1}>
          {rows.map((row, i) => (
            ...
            >
              <Avatar sx={{ width: 40, height: 40, bgcolor: 'rgba(75, 61, 143,0.18)', color: palette.accentBright }}>
              ...
              <Chip
                ...
                size="small"
                sx={{ bgcolor: 'rgba(75, 61, 143,0.12)', color: palette.accentBright, fontWeight: 600 }}
              />
            </Box>
          ))}
        </Stack>

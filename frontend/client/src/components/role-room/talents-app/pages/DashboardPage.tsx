  ...
  return (
    <Box sx={{ p: 3, maxWidth: 1280, mx: 'auto' }}>
      ...
      {demoMode ? (
        <Alert
          severity="info"
          sx={{ mb: 3, bgcolor: 'rgba(75, 61, 143,0.12)', color: palette.textPrimary, '& .MuiAlert-icon': { color: palette.accentBright } }}
        >
        ...
        {recentViews.length === 0 ? (
          ...
          <Stack spacing={1.2}>
            {recentViews.map((view) => (
              ...
              >
                <Avatar sx={{ width: 32, height: 32, bgcolor: 'rgba(75, 61, 143,0.18)', color: palette.accentBright }}>
  ...
  return (
    ...
    >
      <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
        ...
        <Box sx={{ width: 36, height: 36, borderRadius: radius.sm, bgcolor: 'rgba(75, 61, 143, 0.14)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>

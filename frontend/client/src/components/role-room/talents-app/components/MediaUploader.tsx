...
export default function MediaUploader({
      ...
      <Box sx={{ p: 2, borderRadius: radius.md, border: `1px solid ${palette.border}`, bgcolor: palette.bgCardElevated }}>
        <Stack direction="row" spacing={2} alignItems="center">
          {previewable === 'image' ? (
            ...
            <Box sx={{ width: 72, height: 72, borderRadius: radius.sm, bgcolor: 'rgba(75, 61, 143,0.18)', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
  ...
  if (uploading) {
    return (
      <Box sx={{ p: 2.4, borderRadius: radius.md, border: `1px solid ${palette.borderStrong}`, bgcolor: 'rgba(75, 61, 143,0.08)' }}>
        <Stack spacing={1.4}>
    ...
    <Box>
      <Box
        ...
        sx={{
          ...
          bgcolor: dragActive ? 'rgba(75, 61, 143,0.12)' : 'rgba(75, 61, 143,0.04)',
          cursor: 'pointer',
          transition: 'all 0.12s',
          textAlign: 'center',
          '&:hover': { borderColor: palette.accent, bgcolor: 'rgba(75, 61, 143,0.08)' },
        }}
      >

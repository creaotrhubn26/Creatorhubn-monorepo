    ...
    <Box sx={{ minWidth: 0, flex: 1 }}>
      ...
      <Box
        ...
        sx={{
          ...
          appearance: 'none',
          cursor: 'pointer',
          '&:focus': { outline: 'none', borderColor: 'var(--role-violet, #5d76cb)' },
        }}
      >
        {options.map((opt) => (
    ...
    return (
      <svg viewBox="0 0 200 100" width="100%" height="100%" style={{ display: 'block' }}>
        ...
        {Array.from({ length: 60 }).map((_, i) => {
          ...
          return <circle key={i} cx={x} cy={y} r="0.7" fill="rgba(93, 118, 203,0.6)" />;
        })}
      </svg>
    );
  }
        ...
        <Stack direction="row" spacing={0.5} sx={{ mb: 1 }}>
          {cameras.map((cam) => (
            <Box
              ...
              sx={{
                bgcolor: cam.id === activeCameraId ? 'rgba(93, 118, 203,0.15)' : 'transparent',
                color: cam.id === activeCameraId ? '#c3cbe6' : 'rgba(255,255,255,0.5)',
                px: 1.5,
                py: 0.5,
                borderRadius: 0.5,
                cursor: 'pointer',
                ...
                '&:hover': { bgcolor: cam.id === activeCameraId ? 'rgba(93, 118, 203,0.2)' : 'rgba(255,255,255,0.04)' },
              }}
            >
          ...
          <Box sx={{ minWidth: 0, flex: 1 }}>
            ...
            <ToggleButtonGroup
              ...
              sx={{
                ...
                '& .Mui-selected': { bgcolor: 'rgba(93, 118, 203,0.2) !important', color: '#c3cbe6 !important' },
              }}
            >
        ...
        <Stack direction="row" spacing={1} sx={{ mb: 0.5 }}>
          <Box
            ...
            sx={{
              ...
              borderBottom: scopeMode === 'waveform' ? '2px solid #5d76cb' : '2px solid transparent',
              pb: 0.25,
            }}
          >
            WAVEFORM
          ...
          <Box
            ...
            sx={{
              ...
              borderBottom: scopeMode === 'vectorscope' ? '2px solid #5d76cb' : '2px solid transparent',
              pb: 0.25,
            }}
          >
            VECTORSCOPE

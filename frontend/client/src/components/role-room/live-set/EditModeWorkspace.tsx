          ...
          return (
            ...
            >
              ...
              <rect
                ...
                stroke={isPlayhead ? '#9d97ee' : color}
  ...
  return (
    <Box sx={{ bgcolor: '#0a0a0a', borderTop: '1px solid rgba(255,255,255,0.08)' }}>
      ...
      <Stack direction="row" spacing={1} justifyContent="center" sx={{ py: 1, borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        ...
        <IconButton sx={{ color: '#fff', bgcolor: 'rgba(117, 107, 231,0.3)', '&:hover': { bgcolor: 'rgba(117, 107, 231,0.5)' } }}>
          <PlayArrowIcon />
        </IconButton>
        <IconButton size="small" sx={{ color: 'rgba(255,255,255,0.6)' }}>
        ...
        <Stack spacing={0.5}>
          {suggestions.slice(0, 3).map((sug, idx) => (
            <Box
              ...
              sx={{
                p: 0.75,
                bgcolor: idx === 0 ? 'rgba(117, 107, 231,0.1)' : 'rgba(255,255,255,0.02)',
                border: '1px solid',
                borderColor: idx === 0 ? 'rgba(117, 107, 231,0.3)' : 'rgba(255,255,255,0.05)',
                borderRadius: 1,
                cursor: 'pointer',
              }}
            >

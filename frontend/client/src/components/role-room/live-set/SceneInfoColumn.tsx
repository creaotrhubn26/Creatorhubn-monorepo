    ...
    >
      ...
      <Tabs
        ...
        sx={{
          ...
          '& .MuiTabs-indicator': { backgroundColor: 'var(--role-violet, #756be7)' },
        }}
      >
            ...
            {scene.characters && scene.characters.length > 0 && (
              <Box>
                ...
                <Stack direction="row" spacing={0.5} flexWrap="wrap" useFlexGap>
                  <Chip label="Dialog" size="small" sx={{ bgcolor: 'rgba(117, 107, 231,0.18)', color: '#9d97ee', fontSize: 10, height: 18 }} />
                  <Chip label="Reaksjon" size="small" sx={{ bgcolor: 'rgba(117, 107, 231,0.18)', color: '#9d97ee', fontSize: 10, height: 18 }} />
                  {scene.characters.length === 2 && (
                    <Chip label="To personer" size="small" sx={{ bgcolor: 'rgba(117, 107, 231,0.18)', color: '#9d97ee', fontSize: 10, height: 18 }} />
                  )}

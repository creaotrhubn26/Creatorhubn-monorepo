...
export const DEFAULT_TABS_BY_ROLE: Record<UserRoleType, SubTabValue[]> = {
  ...
  executive_producer: [
    'economy', 'approval', 'brief', 'schedule',
    'roles', 'candidates', 'crew', 'planner',
  ],
  line_producer: [
    'schedule', 'crew', 'economy', 'shooting',
    'mannskap', 'approval', 'roles', 'planner',
  ],
  production_manager: [
    'roles', 'schedule', 'crew', 'approval',
  ...
  production_accountant: ['economy', 'approval', 'schedule', 'crew', 'planner'],
  ...
  location_manager: ['schedule', 'crew', 'shooting', 'planner', 'mannskap'],
  location_scout: ['schedule', 'crew', 'planner'],
  location_security: ['schedule', 'crew', 'shooting'],
  script_supervisor: [
    'shooting', 'schedule', 'brief', 'shotlist',
    'crew', 'roles', 'planner',
  ],
  first_ad: [
  ...
  set_production_assistant: ['shooting', 'schedule', 'crew', 'brief'],
  camera_team: [

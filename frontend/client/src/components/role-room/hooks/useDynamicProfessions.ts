...
const DEFAULT_PROFESSIONS: DynamicProfession[] = [
  ...
  { id: 'videographer', name: 'Videograf', icon: 'video', color: '#756be7', description: 'Profesjonell videograf', isActive: true },
...
const PROFESSION_CONFIGS: Record<string, ProfessionConfig> = {
  ...
  videographer: { id: 'videographer', name: 'Videograf', icon: 'videocam', color: '#756be7', features: ['timeline', 'color', 'audio'], defaultProjectType: 'video' },

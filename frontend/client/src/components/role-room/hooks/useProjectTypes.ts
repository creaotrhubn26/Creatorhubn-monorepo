...
const DEFAULT_PROJECT_TYPES: ProjectType[] = [
  ...
  { id: 'portrait', name: 'Portrett', icon: 'portrait', color: '#4227b0', description: 'Portrettfotografering', isCustom: false },
  { id: 'event', name: 'Event', icon: 'event', color: '#2196f3', description: 'Eventfotografering', isCustom: false },
  { id: 'commercial', name: 'Kommersiell', icon: 'business', color: '#523ee0', description: 'Kommersiell fotografering', isCustom: false },

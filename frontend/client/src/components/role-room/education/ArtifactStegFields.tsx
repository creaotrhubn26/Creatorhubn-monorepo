...
export function ArtifactStegFields({
  ...
  const ringSx = { '& .MuiOutlinedInput-notchedOutline': { transition: 'border-color 160ms ease-out', borderColor: showSteg ? 'rgba(93, 118, 203,0.35)' : undefined } };
  ...
  return (
    <Box
      sx={{
        ...
        borderRadius: 2,
        p: showSteg ? 0.5 : 0,
        bgcolor: showSteg ? 'rgba(93, 118, 203,0.05)' : 'transparent',

...
const ComingSoonCard: React.FC<PlaceholderProps> = ({ title, body, feature }) => (
  <Box sx={{ p: { xs: 2, md: 3 }, bgcolor: danceFlowColors.bgBase, minHeight: '100%' }}>
    <Card sx={{ maxWidth: 720, mx: 'auto', bgcolor: danceFlowColors.bgCard, border: '1px solid rgba(117, 107, 231,0.25)', color: danceFlowColors.textSecondary }}>
      <CardContent>
        <Stack direction="row" spacing={2} alignItems="center" sx={{ mb: 2 }}>
          <Box sx={{ width: 48, height: 48, borderRadius: 2, bgcolor: 'rgba(117, 107, 231,0.18)', color: danceFlowColors.lavender, display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
            <ConstructionIcon />
          </Box>
          <Box>
        ...
        {shareMessage ? (
          <Box
            ...
            sx={{
              ...
              border: '1px solid #9d97ee', borderRadius: 1,
    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', bgcolor: '#050505' }}>
      ...
      <Box
        sx={{
          ...
          borderBottom: '1px solid rgba(117, 107, 231,0.18)',
        }}
      >

 ...
 *
 * Design-konvensjon: følger samme dark-theme + #5d76cb-accent som
      ...
      >
        ...
        <Stack direction="row" spacing={1}>
          <Button
            ...
            size="small"
            sx={{ textTransform: 'none', color: danceFlowColors.lavenderLight, borderColor: 'rgba(93, 118, 203,0.4)' }}
            variant="outlined"
                    ...
                    <Stack direction="row" justifyContent="space-between" alignItems="flex-start">
                      ...
                      <Chip
                        ...
                        sx={{
                          height: 20,
                          fontSize: 10,
                          bgcolor: a.applied ? 'rgba(52,211,153,0.18)' : 'rgba(93, 118, 203,0.18)',
                          color: a.applied ? danceFlowColors.successPrimary : danceFlowColors.lavenderLight,
                          border: `1px solid ${a.applied ? 'rgba(52,211,153,0.4)' : 'rgba(93, 118, 203,0.4)'}`,
                        }}
                      />
                    </Stack>
                  </Box>
...
const SectionCard: React.FC<SectionCardProps> = ({ title, icon, actionLabel, actionTabId, tinted, children, testId }) => (
  <Card
    data-testid={testId}
    sx={{
      bgcolor: tinted ? 'rgba(93, 118, 203,0.06)' : danceFlowColors.bgPanel,
      border: `1px solid ${tinted ? 'rgba(93, 118, 203,0.25)' : danceFlowColors.borderStrong}`,
      borderRadius: 2,
      boxShadow: 'none',
    }}
  >

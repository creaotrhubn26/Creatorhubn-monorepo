...
export const KIND_META: Record<CalendarEventKind, { label: string; color: string; bg: string }> = {
  rehearsal:    { label: 'Prøver',          color: danceFlowColors.lavender, bg: 'rgba(147, 164, 220,0.18)' },
  ...
  audition:     { label: 'Auditions',       color: danceFlowColors.infoLight, bg: 'rgba(147, 164, 220,0.18)' },

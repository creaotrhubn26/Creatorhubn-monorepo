          ...
          >
            ...
            <Box
              ...
              sx={{
                ...
                bgcolor: 'transparent',
                border: '1px solid #9d97ee',
                borderRadius: 0.5,
                px: 1,
                py: 0.4,
                cursor: 'pointer',
                font: 'inherit',
                '&:hover': { bgcolor: 'rgba(157, 151, 238,0.12)' },
              }}
            >
              Gå til Dancers →
            </Box>
          ...
          <ToggleButtonGroup
            ...
            sx={{
              '& .MuiToggleButton-root': {
                ...
                fontSize: 11,
                px: 1,
                '&.Mui-selected': { color: '#fff', bgcolor: 'rgba(157, 151, 238,0.18)' },
              },
            }}
          >
          ...
          <Tooltip title="Symmetri — speile partner-danser over senter-aksen">
            <ToggleButton
              ...
              sx={{
                ...
                borderColor: danceFlowColors.borderSoft,
                bgcolor: symmetry ? 'rgba(157, 151, 238,0.18)' : 'transparent',
                fontSize: 11,
                px: 1,
              }}
            ...
            return (
              ...
              <Box
                ...
                sx={{
                  ...
                  bgcolor: isActive ? 'rgba(157, 151, 238,0.1)' : 'transparent',
                }}
              >
        ...
        {(['2d', '3d'] as const).map((m) => (
          <Box
            ...
            sx={{
              ...
              bgcolor: stageMode === m ? 'rgba(157, 151, 238,0.22)' : 'transparent',

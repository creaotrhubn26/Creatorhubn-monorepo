      ...
      <DialogContent sx={{ p: { xs: 3, md: 5 }, position: 'relative' }}>
        ...
        <Stack spacing={3} alignItems="center" sx={{ textAlign: 'center', mb: 4 }}>
          <Chip
            ...
            size="small"
            sx={{ bgcolor: 'rgba(93, 118, 203,0.18)', color: PURPLE_LIGHT, fontWeight: 600 }}
          />
        ...
        <Box sx={{ display: 'grid', gridTemplateColumns: { xs: '1fr', md: '1fr 1fr' }, gap: 2 }}>
          ...
          <Box
            sx={{
              p: { xs: 2.5, md: 3 },
              borderRadius: 2.5,
              background: `linear-gradient(135deg, rgba(93, 118, 203,0.10), rgba(48, 31, 132,0.06))`,
          ...
          >
            ...
            <Button
              ...
              sx={{
                ...
                '&:hover': { borderColor: PURPLE_LIGHT, bgcolor: 'rgba(93, 118, 203,0.06)' },
                textTransform: 'none',
                fontWeight: 600,
                py: 1.25,
              }}

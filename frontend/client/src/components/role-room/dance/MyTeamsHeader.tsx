    ...
    return (
      <Stack direction="row" spacing={1} alignItems="center" sx={{ color: TEXT_DIM }}>
        ...
        <Chip
          ...
          size="small"
          sx={{ bgcolor: 'rgba(93, 118, 203,0.18)', color: PURPLE_LIGHT, fontWeight: 600, height: 20, fontSize: 11 }}
        />
      </Stack>
    );
  }
      ...
      >
        <Stack direction="row" spacing={1} alignItems="center">
          ...
          <Chip
            ...
            size="small"
            sx={{ bgcolor: 'rgba(147, 164, 220,0.18)', color: PURPLE_LIGHT, fontWeight: 700, height: 18, fontSize: 10 }}
          />
        </Stack>
      </Button>
      <Menu
        ...
        PaperProps={{ sx: { bgcolor: '#2a3152', border: '1px solid rgba(147, 164, 220,0.18)', minWidth: 240 } }}
      >
        <Box sx={{ px: 2, py: 1, borderBottom: '1px solid rgba(147, 164, 220,0.10)' }}>

  ...
  return (
    <Box
      ...
      sx={{
        ...
        backgroundColor: 'rgba(117, 107, 231,0.03)',
      }}
    >
            ...
            <Box
              ...
              sx={{
                ...
                backgroundColor: cell.inMonth
                  ? `rgba(117, 107, 231,${0.04 + intensity * 0.18})`
                  : 'rgba(0,0,0,0.02)',
                color: cell.inMonth ? 'text.primary' : 'text.disabled',
                cursor: 'pointer',
                transition: 'background-color 120ms ease, transform 80ms ease',
                '&:hover': { backgroundColor: 'rgba(117, 107, 231,0.16)' },
                '&:focus-visible': {
                ...
                {selectedCell.available.map((d) => (
                  <Box
                    ...
                    sx={{
                      ...
                      borderRadius: 1,
                      border: `1px solid ${PURPLE_SOFT}`,
                      backgroundColor: 'rgba(117, 107, 231,0.04)',
                    }}
                  >

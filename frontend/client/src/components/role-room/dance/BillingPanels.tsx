      ...
      <Stack spacing={1} alignItems="center" sx={{ mb: 4, textAlign: 'center' }}>
        ...
        {subscription ? (
          <Chip
            ...
            sx={{
              mt: 1,
              bgcolor: subscription.status === 'active' ? 'rgba(16,185,129,0.18)' : 'rgba(147, 164, 220,0.18)',
          ...
          {(['monthly', 'yearly'] as const).map((p) => (
            <Button
              ...
              sx={{
                ...
                '&:hover': { bgcolor: billingPeriod === p ? danceFlowColors.lavenderDeep : 'rgba(93, 118, 203,0.08)' },
              }}
            >
            ...
            >
              ...
              <Button
                ...
                sx={{
                  ...
                  borderColor: PURPLE,
                  '&:hover': { bgcolor: plan.isFeatured ? danceFlowColors.lavenderDeep : 'rgba(93, 118, 203,0.08)' },
                }}
              >
                {isCurrent ? 'Aktiv' :
            ...
            <Stack direction="row" spacing={1} alignItems="center">
              <Box sx={{ flex: 1 }}>
                <Stack direction="row" spacing={1} alignItems="center">
                  ...
                  {plan.isFeatured ? <Chip size="small" label="Anbefalt" sx={{ height: 18, fontSize: 10, bgcolor: 'rgba(93, 118, 203,0.18)', color: PURPLE_LIGHT }} /> : null}
              ...
              <Stack direction="row" spacing={1} alignItems="center">
                <Box sx={{ flex: 1, minWidth: 0 }}>
                  <Stack direction="row" spacing={1} alignItems="center">
                    ...
                    <Chip size="small" label={inv.planSlug} sx={{ height: 18, fontSize: 10, bgcolor: 'rgba(93, 118, 203,0.18)', color: PURPLE_LIGHT }} />
...
export function TrialBanner(): React.ReactElement | null {
  ...
  return (
    <Box
      ...
      sx={{
        bgcolor: isComp ? 'rgba(93, 118, 203,0.18)' : 'rgba(251,191,36,0.18)',

      ...
      <Stack direction="row" justifyContent="space-between" alignItems="center" sx={{ mb: 1 }}>
        <Stack direction="row" spacing={1.5} alignItems="center">
          ...
          <Chip
            ...
            sx={{ height: 18, fontSize: 9, bgcolor: 'rgba(117, 107, 231,0.12)', color: danceFlowColors.lavenderLight, border: '1px solid rgba(117, 107, 231,0.3)' }}
          />
        </Stack>
            ...
            <React.Fragment key={row.absoluteCount}>
              ...
              <Box
                ...
                sx={{
                  ...
                  '&:hover': onSeekToCount ? { bgcolor: 'rgba(157, 151, 238,0.1)' } : undefined,
                }}
              >
                <Box
                  sx={{

    ...
    >
      <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 2 }}>
        ...
        <Chip
          ...
          sx={{ ml: 1, height: 22, fontSize: 11, bgcolor: 'rgba(157, 151, 238,0.18)', color: danceFlowColors.lavenderLight }}
        />
      </Stack>
      ...
      >
        ...
        <Card data-testid="analysis-annotations-by-category" sx={{ bgcolor: danceFlowColors.bgPanel, border: '1px solid rgba(117, 107, 231,0.18)' }}>
          <CardContent>
        ...
        {/* ─── Rehearsal-outcomes ─────────────────────────────────── */}
        <Card data-testid="analysis-rehearsal-outcomes" sx={{ bgcolor: danceFlowColors.bgPanel, border: '1px solid rgba(117, 107, 231,0.18)' }}>
          <CardContent>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1.5 }}>
        ...
        {/* ─── Top-5 dansere ──────────────────────────────────────── */}
        <Card data-testid="analysis-top-dancers" sx={{ bgcolor: danceFlowColors.bgPanel, border: '1px solid rgba(117, 107, 231,0.18)' }}>
          <CardContent>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1.5 }}>
        ...
        {/* ─── Formasjons-tagger ──────────────────────────────────── */}
        <Card data-testid="analysis-formation-tags" sx={{ bgcolor: danceFlowColors.bgPanel, border: '1px solid rgba(117, 107, 231,0.18)' }}>
          <CardContent>
            <Stack direction="row" alignItems="center" spacing={1} sx={{ mb: 1.5 }}>
              <Typography sx={{ fontSize: 11, letterSpacing: 1.5, color: danceFlowColors.lavender, fontWeight: 700 }}>
                ...
                {Array.from(data.formationsByTag.entries())
                  ...
                  .map(([tag, count]) => (
                    <Chip
                      ...
                      size="small"
                      label={`${tag} · ${count}`}
                      sx={{ height: 20, fontSize: 10.5, bgcolor: 'rgba(157, 151, 238,0.18)', color: danceFlowColors.lavenderLight }}
                    />
                  ))}
              </Stack>
            )}

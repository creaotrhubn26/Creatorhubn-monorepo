                    ...
                    >
                      <Box
                        ...
                        sx={{
                          ...
                          bgcolor: isActive ? 'rgba(158, 140, 248,0.32)' : 'rgba(158, 140, 248,0.14)',
                          border: `${isActive ? 2 : 1}px solid ${isActive ? danceFlowColors.lavenderLight : 'rgba(158, 140, 248,0.45)'}`,
                          borderRadius: 0.5, cursor: 'pointer', color: danceFlowColors.textPrimary,
                          fontSize: 10, fontWeight: 600, px: 0.5,
                          display: 'flex', alignItems: 'center', overflow: 'hidden',
                          whiteSpace: 'nowrap', textOverflow: 'ellipsis',
                          '&:hover': { bgcolor: 'rgba(158, 140, 248,0.28)' },

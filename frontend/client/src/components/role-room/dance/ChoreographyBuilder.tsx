          ...
          <Tooltip title={audioUrl ? labels.choreographyBuilderPlayLabel : 'Last opp musikkfil først'}>
            <span>
              <IconButton
                ...
                sx={{
                  bgcolor: isPlaying ? 'rgba(52,211,153,0.15)' : 'rgba(93, 118, 203,0.12)',
                  color: isPlaying ? danceFlowColors.successPrimary : danceFlowColors.lavenderLight,
                  border: `1px solid ${isPlaying ? 'rgba(52,211,153,0.4)' : 'rgba(93, 118, 203,0.4)'}`,
                  '&:hover': { bgcolor: isPlaying ? 'rgba(52,211,153,0.22)' : 'rgba(93, 118, 203,0.2)' },
      ...
      >
        ...
        <Box
          ...
          sx={{
            ...
            p: 2,
            outline: 'none',
            '&:focus-visible': { boxShadow: 'inset 0 0 0 2px rgba(147, 164, 220,0.4)' },
          }}
        >
        ...
        return (
          <Box
            ...
            sx={{
              ...
              bgcolor: isAccent ? 'rgba(147, 164, 220,0.7)' : 'rgba(93, 118, 203,0.35)',
            }}
          />
        );
      })}
    ...
    <Stack spacing={1.5}>
      ...
      <Stack direction="row" spacing={1} alignItems="center">
        ...
        <Chip
          ...
          sx={{ height: 18, fontSize: 9, bgcolor: 'rgba(93, 118, 203,0.15)', color: danceFlowColors.lavenderLight }}
        />
      </Stack>
      ...
      {/* AI-handling */}
      <Card sx={{ bgcolor: 'rgba(93, 118, 203,0.08)', border: '1px solid rgba(93, 118, 203,0.3)', boxShadow: 'none' }}>
        <CardContent sx={{ p: 1.25, '&:last-child': { pb: 1.25 } }}>
          ...
          <Button
            ...
            sx={{ textTransform: 'none', fontSize: 11, color: danceFlowColors.lavenderLight, borderColor: 'rgba(93, 118, 203,0.4)' }}
          >
            Foreslå bevegelser
          </Button>
        </CardContent>
...
const MetaPill: React.FC<{ label: string; icon?: React.ReactNode; accent?: boolean }> = ({ label, icon, accent }) => (
  <Box
    sx={{
      ...
      py: 0.5,
      borderRadius: 12,
      bgcolor: accent ? 'rgba(93, 118, 203,0.15)' : danceFlowColors.borderStrong,
      color: accent ? danceFlowColors.lavenderLight : danceFlowColors.grayLight,
      border: `1px solid ${accent ? 'rgba(93, 118, 203,0.4)' : danceFlowColors.borderSoft}`,
      fontSize: 10,
      fontWeight: 600,
      display: 'flex',
      alignItems: 'center',
      ...
      <Tooltip title={tooltip}>
        <span>
          <IconButton
            ...
            disabled={uploading}
            sx={{
              bgcolor: hasAudio ? 'rgba(147, 164, 220,0.18)' : danceFlowColors.borderStrong,
              color: hasAudio ? danceFlowColors.lavender : danceFlowColors.textMuted,
              border: `1px solid ${hasAudio ? 'rgba(147, 164, 220,0.4)' : danceFlowColors.borderSoft}`,
...
const AutosaveBadge: React.FC<{ status: 'idle' | 'saving' | 'saved' | 'error' }> = ({ status }) => {
  ...
  const cfg = {
    saving: { label: 'Lagrer…', color: danceFlowColors.lavender, bg: 'rgba(147, 164, 220,0.12)' },

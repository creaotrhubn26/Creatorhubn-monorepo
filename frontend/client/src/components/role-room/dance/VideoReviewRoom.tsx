...
const AUTHOR_PALETTE = [danceFlowColors.info, danceFlowColors.amber, danceFlowColors.successDark, '#756be7', danceFlowColors.pinkAccent, '#06b6d4', '#f97316'];
    ...
    >
      ...
      <Box sx={{ p: 2, display: 'flex', flexDirection: 'column', gap: 1.5, minWidth: 0 }}>
        <Stack direction="row" alignItems="center" spacing={1}>
          ...
          <Chip label={clip.kind} size="small" sx={{ bgcolor: 'rgba(117, 107, 231,0.18)', color: PURPLE_LIGHT, fontWeight: 600 }} />
          {onDeleteClip ? (
            ...
            {PLAYBACK_RATES.map((r) => (
              <Button
                ...
                sx={{
                  ...
                  bgcolor: playbackRate === r ? 'rgba(117, 107, 231,0.25)' : 'transparent',
                }}
        ...
        >
          <Box
            sx={{
              ...
              border: '1px solid rgba(117, 107, 231,0.12)',
              display: 'grid',
        ...
        <Box sx={{ borderTop: `1px solid ${BORDER}`, p: 1.5, bgcolor: CARD }}>
          {replyTo ? (
            <Chip
              ...
              sx={{ mb: 1, bgcolor: 'rgba(117, 107, 231,0.18)', color: PURPLE_LIGHT }}
            />
          ) : (
              ...
              {Array.from(mentionedDancerIds).map((id) => {
                ...
                return (
                  <Chip
                    ...
                    sx={{ bgcolor: 'rgba(157, 151, 238,0.18)', color: PURPLE_LIGHT, height: 22 }}
                  />
                );
              })}
            </Stack>
          ...
          >
            ...
            <Chip
              ...
              sx={{
                ...
                bgcolor: 'transparent',
                color: PURPLE_LIGHT,
                border: '1px dashed rgba(157, 151, 238,0.45)',
              }}
            />
          </Stack>
          {composerCategory ? (
            ...
            >
              ...
              <input
                ...
                style={{
                  ...
                  border: '1px solid rgba(157, 151, 238,0.25)',
              ...
              {[...commonLabelsFor(composerCategory), ...(customLabelsByCat[composerCategory] ?? [])]
                ...
                <Chip
                  ...
                  sx={{
                    ...
                    color: '#c4b5fd',
                    border: '1px solid rgba(157, 151, 238,0.25)',
                    '&:hover': { bgcolor: 'rgba(157, 151, 238,0.18)' },
                  }}
                />
              ))}
              <Chip
            ...
            >
              <ToggleButton
                ...
                sx={{
                  ...
                  borderColor: BORDER,
                  bgcolor: drawingMode && drawingAllowed ? 'rgba(157, 151, 238,0.18)' : 'transparent',
                  fontSize: 11,
                  px: 1, py: 0.25,
      ...
      <Dialog
        ...
        PaperProps={{ sx: { bgcolor: '#0b0a1c', border: `1px solid ${BORDER}`, color: danceFlowColors.textSecondary } }}
      ...
      >
        ...
        <DialogActions>
          ...
          <Button
            ...
            sx={{ bgcolor: PURPLE, '&:hover': { bgcolor: '#5446e1' }, textTransform: 'none', fontWeight: 700 }}
          ...
          {annotation.targetDancerIds.length > 0 ? (
            <Stack direction="row" spacing={0.5} flexWrap="wrap" useFlexGap sx={{ mt: 0.5 }}>
              {annotation.targetDancerIds.map((id) => {
                ...
                return (
                  <Chip key={id} size="small" label={`@${p?.displayName ?? id}`} sx={{ height: 18, fontSize: 10, bgcolor: 'rgba(157, 151, 238,0.12)', color: PURPLE_LIGHT }} />
                );
              })}
            </Stack>
          ) : null}

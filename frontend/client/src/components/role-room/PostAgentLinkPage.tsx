  ...
  return (
    <div
      style={{
        ...
        background:
          'radial-gradient(ellipse 80% 60% at 50% 0%, rgba(74, 48, 192, 0.18), transparent 60%), #060518',
        color: '#eeedfc',
    ...
    >
      ...
      >
        ...
        <p style={{ color: '#aca8d8', fontSize: 14, marginTop: 8, marginBottom: 24 }}>
        ...
        <p style={{ color: '#7974a8', fontSize: 11, marginTop: 24, marginBottom: 0 }}>

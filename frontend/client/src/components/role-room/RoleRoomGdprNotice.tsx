    ...
    >
      <Paper
        ...
        sx={{
          ...
          boxShadow: '0 24px 80px rgba(0,0,0,0.5), 0 0 40px rgba(93, 118, 203,0.12)',
          pointerEvents: 'auto',
          p: { xs: 2.2, sm: 3 },
        }}
      >
          ...
          <Stack direction="row" spacing={1.5} alignItems="center">
            <Box
              sx={{
                ...
                boxShadow: '0 4px 15px rgba(93, 118, 203,0.3)',
              }}
            >
              <CookieOutlinedIcon />
            </Box>
        ...
        <Stack direction="row" spacing={1} sx={{ mb: 2, flexWrap: 'wrap', gap: 1 }}>
          {(['Nødvendige', 'Analyse', 'Markedsføring', 'Preferanser'] as const).map((label, i) => (
            <Chip
              ...
              size="small"
              sx={{
                bgcolor: i === 0 ? 'rgba(52,211,153,0.18)' : 'rgba(93, 118, 203,0.12)',

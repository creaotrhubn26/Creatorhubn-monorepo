...
const palette = {
  bgCard: 'rgba(14, 11, 46, 0.96)',
  border: 'rgba(118, 102, 230, 0.32)',
  textPrimary: '#f5f3ff',
    ...
    >
      <Paper
        ...
        sx={{
          ...
          boxShadow: '0 24px 80px rgba(0,0,0,0.5), 0 0 40px rgba(118, 102, 230,0.12)',
          pointerEvents: 'auto',
          p: { xs: 2.2, sm: 3 },
        }}
      >
          ...
          <Stack direction="row" spacing={1.5} alignItems="center">
            <Box
              sx={{
                ...
                boxShadow: '0 4px 15px rgba(118, 102, 230,0.3)',
              }}
            >
              <CookieOutlinedIcon />
            </Box>
        ...
        <Stack direction="row" spacing={1} sx={{ mb: 2, flexWrap: 'wrap', gap: 1 }}>
          {(['Nødvendige', 'Analyse', 'Markedsføring', 'Preferanser'] as const).map((label, i) => (
            <Chip
              ...
              size="small"
              sx={{
                bgcolor: i === 0 ? 'rgba(52,211,153,0.18)' : 'rgba(118, 102, 230,0.12)',
            ...
            <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.4}>
              ...
              <Button
                ...
                sx={{
                  ...
                  fontWeight: 700, py: 1.3, borderRadius: 2, fontSize: '0.95rem',
                  '&:hover': { borderColor: palette.accentBright, bgcolor: 'rgba(118, 102, 230,0.08)' },
                }}
              >
                Kun nødvendige
              </Button>
  ...
  const manageButton = !visible ? (
    <Button
      ...
      sx={{
        ...
        bgcolor: 'rgba(5, 4, 21,0.9)', backdropFilter: 'blur(12px)',
        '&:hover': { borderColor: palette.accentBright, bgcolor: 'rgba(5, 4, 21,0.96)' },
      }}
    >

          ...
          {block.primaryCtaLabel ? (
            <Button
              ...
              sx={{
                ...
                py: 1.4,
                borderRadius: 1.5,
                boxShadow: '0 8px 24px rgba(147, 164, 220,0.32)',
                transition: 'all 0.2s ease',
                '&:hover': {
                  transform: 'translateY(-2px)',
                  boxShadow: '0 12px 32px rgba(147, 164, 220,0.5)',
                  background: 'linear-gradient(135deg, #c3cbe6 0%, #93a4dc 100%)',
                },
              }}
            >
              {block.primaryCtaLabel}
        ...
        <Box
          sx={{
            ...
            '& a': {
              ...
              textDecorationColor: 'rgba(147, 164, 220,0.4)',
              transition: 'all 0.15s ease',
              '&:hover': { textDecorationColor: '#93a4dc' },
            },
...
function FaqAccordionItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <Card
      sx={{
        bgcolor: open ? 'rgba(147, 164, 220,0.06)' : 'rgba(255,255,255,0.03)',
        border: open ? '1px solid rgba(147, 164, 220,0.32)' : '1px solid rgba(255,255,255,0.08)',
        transition: 'all 0.2s ease',
        '&:hover': {
          bgcolor: 'rgba(147, 164, 220,0.05)',
    ...
    >
      ...
      >
        ...
        <ExpandMoreIcon
          sx={{
            color: open ? '#93a4dc' : 'rgba(203,213,225,0.6)',
      ...
      >
        <Table>
          <TableHead>
            <TableRow
              sx={{
                background: 'linear-gradient(180deg, rgba(147, 164, 220,0.08), rgba(147, 164, 220,0.02))',
              }}
            >
              <TableCell
                sx={{
            ...
            {rows.map((row, i) => (
              <TableRow
                ...
                sx={{
                  ...
                  '&:hover': { bgcolor: 'rgba(147, 164, 220,0.04)' },
    ...
    <Card
      sx={{
        ...
        '&::before': {
          ...
          width: 200,
          height: 200,
          background: 'radial-gradient(circle, rgba(147, 164, 220,0.2), transparent 70%)',
          pointerEvents: 'none',
        },
      }}
    >
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ pt: 1 }}>
            <Button
              ...
              sx={{
                ...
                py: 1.4,
                borderRadius: 1.5,
                boxShadow: '0 8px 24px rgba(147, 164, 220,0.4)',
                transition: 'all 0.2s ease',
                '&:hover': {
                  background: 'linear-gradient(135deg, #c3cbe6 0%, #93a4dc 100%)',
                  transform: 'translateY(-2px)',
                ...
                <Chip
                  ...
                  sx={{
                    ...
                    '&:hover': {
                      ...
                      boxShadow: '0 4px 12px rgba(147, 164, 220,0.2)',
                    },
                  }}
                />
              </motion.div>

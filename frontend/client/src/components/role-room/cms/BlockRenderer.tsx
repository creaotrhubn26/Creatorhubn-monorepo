...
function InfographicView({ block }: { block: InfographicBlock }) {
  // Bibliotek-maler er DATA (server-side DB): «auto» + bare mal-id-er (uten skråstrek)
  // finnes bare server-side → tvinger img-pathen. Inline HTML / URL-er kan kjøre klient-side.
  const url = block.templateUrl || '';
  const isServerId = url === 'auto' || /^[a-z0-9][a-z0-9-]*$/.test(url);
  if (!block.templateHtml && (isServerId || (block.serverRender && url.startsWith('/embed/')))) {
      ...
      {block.audienceChip ? (
        <Chip
          ...
          sx={{
            ...
            background: 'linear-gradient(135deg, rgba(157, 151, 238,0.18), rgba(96,165,250,0.18))',
            color: '#ddd6fe',
            fontWeight: 700,
            letterSpacing: 0.3,
        ...
        <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ pt: 1.5 }}>
          {block.primaryCtaLabel ? (
            <Button
              ...
              size="large"
              sx={{
                background: 'linear-gradient(135deg, #9d97ee 0%, #756be7 100%)',
                color: '#0b1120',
                textTransform: 'none',
                fontWeight: 700,
                fontSize: '1rem',
                ...
                py: 1.4,
                borderRadius: 1.5,
                boxShadow: '0 8px 24px rgba(157, 151, 238,0.32)',
                transition: 'all 0.2s ease',
                '&:hover': {
                  transform: 'translateY(-2px)',
                  boxShadow: '0 12px 32px rgba(157, 151, 238,0.5)',
                  background: 'linear-gradient(135deg, #c4b5fd 0%, #9d97ee 100%)',
                },
              }}
            >
              {block.primaryCtaLabel}
        ...
        <Box
          sx={{
            ...
            '& a': {
              ...
              textDecorationColor: 'rgba(157, 151, 238,0.4)',
              transition: 'all 0.15s ease',
              '&:hover': { textDecorationColor: '#9d97ee' },
            },
...
function FaqAccordionItem({ q, a }: { q: string; a: string }) {
  ...
  return (
    <Card
      sx={{
        bgcolor: open ? 'rgba(157, 151, 238,0.06)' : 'rgba(255,255,255,0.03)',
        border: open ? '1px solid rgba(157, 151, 238,0.32)' : '1px solid rgba(255,255,255,0.08)',
        transition: 'all 0.2s ease',
        '&:hover': {
          bgcolor: 'rgba(157, 151, 238,0.05)',
    ...
    >
      ...
      >
        ...
        <ExpandMoreIcon
          sx={{
            color: open ? '#9d97ee' : 'rgba(203,213,225,0.6)',
      ...
      >
        <Table>
          <TableHead>
            <TableRow
              sx={{
                background: 'linear-gradient(180deg, rgba(157, 151, 238,0.08), rgba(157, 151, 238,0.02))',
              }}
            >
              <TableCell
                sx={{
            ...
            {rows.map((row, i) => (
              <TableRow
                ...
                sx={{
                  ...
                  '&:hover': { bgcolor: 'rgba(157, 151, 238,0.04)' },
...
function CtaView({ block }: { block: CtaBlock }) {
  return (
    <Card
      sx={{
        background: 'linear-gradient(135deg, rgba(157, 151, 238,0.14) 0%, rgba(96,165,250,0.12) 100%)',
        border: '1px solid rgba(157, 151, 238,0.32)',
        borderRadius: 2.5,
        position: 'relative',
        overflow: 'hidden',
        '&::before': {
          ...
          width: 200,
          height: 200,
          background: 'radial-gradient(circle, rgba(157, 151, 238,0.2), transparent 70%)',
          pointerEvents: 'none',
        },
      }}
    >
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={1.5} sx={{ pt: 1 }}>
            <Button
              ...
              sx={{
                ...
                py: 1.4,
                borderRadius: 1.5,
                boxShadow: '0 8px 24px rgba(157, 151, 238,0.4)',
                transition: 'all 0.2s ease',
                '&:hover': {
                  background: 'linear-gradient(135deg, #c4b5fd 0%, #9d97ee 100%)',
                  transform: 'translateY(-2px)',
            ...
            {items.map((it, i) => (
              <motion.div key={i} variants={STAGGER_CHILD_VARIANTS}>
                <Chip
                  label={it}
                  sx={{
                    background: 'linear-gradient(135deg, rgba(157, 151, 238,0.14), rgba(96,165,250,0.10))',
                    color: '#ddd6fe',
                    fontWeight: 500,
                    fontSize: '0.92rem',
                    border: '1px solid rgba(157, 151, 238,0.24)',
                    ...
                    '&:hover': {
                      ...
                      boxShadow: '0 4px 12px rgba(157, 151, 238,0.2)',
                    },
                  }}
                />
              </motion.div>

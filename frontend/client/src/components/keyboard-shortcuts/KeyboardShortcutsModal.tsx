...
const KeyboardShortcutsModal: React.FC<KeyboardShortcutsModalProps> = ({ open, onClose, profession }) => {
      ...
      >
        <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            ...
            />
            <Box>
              <Typography variant="h5" sx={{ fontWeight: 'bold', color: professionColor, mb: 0.5 }}>
      ...
      >
        <Button
          ...
          sx={{
            ...
            borderRadius: 2,
            px: 4,
            ...theming.getThemedButtonSx('primary'),
          }}
        >
          Lukk
        </Button>

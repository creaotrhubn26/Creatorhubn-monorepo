...
interface VideoShowcaseYouTubeProps {
  userId?: string;
}

const VideoShowcaseYouTube: React.FC<VideoShowcaseYouTubeProps> = ({
        ...
        {featuredVideo && (
          <Box sx={{ mb:  4 }}>
            ...
            >
                ...
                >
                  {isPlaying ? (
                    <Pause sx={{ fontSize:  40, color: '#000'}} />
                  ) : (
                ...
                <Box sx={{ position: 'absolute', bottom:  24, left:  24, right: 24}}>
                  ...
                  {featuredVideo.description && (
                    <Typography variant="h6" sx={{  color: '#e0e0e0', mb:  3, fontWeight: 40 }}>
                      {featuredVideo.description}
                    </Typography>
                  )}
                  <Box sx={{ display: 'flex', alignItems: 'center', gap:  3 }}>
                    ...
                    >
                      ...
                      <Typography variant="body1">1.2K views</Typography>
                    </Box>
                  </Box>
                </Box>
              </CardMedia>
...
export default VideoShowcaseYouTube;

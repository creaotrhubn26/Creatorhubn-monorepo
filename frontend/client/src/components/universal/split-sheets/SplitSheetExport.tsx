      ...
      <Dialog open={open} onClose={() => setOpen(false)} maxWidth="sm" fullWidth>
        ...
        <DialogContent>
          ...
          <FormControl fullWidth sx={{ mb: 3 }}>
            <InputLabel>Eksportformat</InputLabel>
            <Select value={format} label="Eksportformat" onChange={(e) => setFormat(e.target.value as any)}>
              <MenuItem value="csv">
                <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
          ...
          {format === 'accounting' && (
            <FormControl fullWidth sx={{ mb: 3 }}>
              <InputLabel>Regnskapsformat</InputLabel>
              <Select
          ...
          <FormGroup>
            <FormControlLabel
              ...
              label="Bidragsytere og prosenter"
            />
            <FormControlLabel
              control={
                <Checkbox

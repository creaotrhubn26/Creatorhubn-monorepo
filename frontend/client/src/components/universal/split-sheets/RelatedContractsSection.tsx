...
export default function RelatedContractsSection({
  ...
  // Fetch related contracts by project_id
      ...
      <CardContent sx={theming.getThemedCardSx()}>
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', mb: 2 }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 1 }}>
            <ContractIcon sx={{ color: theming.colors.primary }} />
                    ...
                    <Box sx={{ mt: 0.5 }}>
                      ...
                      <Box sx={{ display: 'flex', gap: 2, mt: 0.5 }}>
                        <Typography variant="caption" color="text.secondary">
                          Beløp: NOK {contract.totalAmount?.toLocaleString('no-NO') || '0'}
                        </Typography>
                        <Typography variant="caption" color="text.secondary">
                ...
                />
                  <ListItemSecondaryAction>
                    <Box sx={{ display: 'flex', gap: 0.5 }}>
                      ...
                      <Tooltip title="Opprett Kontrakt fra Split Sheet">
                        <IconButton
                          edge="end"
                          onClick={onCreateContract}
                          sx={{ color: theming.colors.primary }}

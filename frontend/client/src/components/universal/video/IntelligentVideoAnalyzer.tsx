...
import {
  ...
  Movie as VideocamIcon,
  Image as ImageIcon,
  Download as DownloadIcon,
  Share as ShareIcon,
  Highlight as HighlightIcon,
  PhotoCameraAlt as ThumbnailIcon,
...
export default function IntelligentVideoAnalyzer() {
        ...
        socialClips: [
          {
            ...
            platform: 'instagram',
            format: 'square',
            downloadUrl: '/api/download/social_30s.mp' },
        ],
        thumbnails: [
          {
            timestamp: 30,
  ...
  return (
    <Box sx={{ p:  3 }}>
                ...
                <Grid container spacing={2}>
                    ...
                    <Paper
                     ...
                     sx={theming.getThemedCardSx()}>
                      <Typography variant="h4" sx={{ color: theming.colors.primary }}>
                        {analysisResult.summary.socialClipsGenerated}
                      </Typography>
                  ...
                  <Grid item xs={6} md={3}>
                    <Paper
                     ...
                     sx={theming.getThemedCardSx()}>
                      <Typography variant="h4" sx={{ color: theming.colors.primary }}>
                        {analysisResult.summary.thumbnailsGenerated}
                      </Typography>
                  ...
                  <Grid item xs={6} md={3}>
                    <Paper
                     ...
                     sx={theming.getThemedCardSx()}>
                      <Typography variant="h4" sx={{ color: theming.colors.primary }}>
                        {formatDuration(analysisResult.summary.videoDuration)}
                      </Typography>
            ...
            <MuiCard>
              <CardContent sx={theming.getThemedCardSx()}>
                ...
                <List dense>
                  ...
                  <ListItem>
                    <ListItemText primary="FPS" secondary={analysisResult.metadata.fps} />
                  </ListItem>
                  <ListItem>
                    <ListItemText
                      primary="Lydkanaler"
      ...
      {/* Custom Clip Dialog */}
      <Dialog
        open={customClipDialog}
        onClose={() => setCustomClipDialog(false)}
        maxWidth="sm"
        fullWidth
      >
      ...
      <Dialog
        open={customThumbnailDialog}
        onClose={() => setCustomThumbnailDialog(false)}
        maxWidth="sm"
        fullWidth
      >

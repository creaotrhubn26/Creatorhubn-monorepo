...
const professionComponentMappings = {
  photographer: {
    overview: {
      analytics: [
        'BusinessIntelligenceDashboard', 'GoogleAnalyticsDashboard','RevenueAnalyticsDashboard','PerformanceAnalyticsDashboard',
      ],
    ...
    projects: {
      project: [
        'ProjectManagementPageD','ProjectTimelineManager','ProjectBackupManager','ProjectManager',
      ],
    ...
    clients: {
      communication: [
        'ClientManagementPageD','ClientCommunicationDashboard','ProfessionalEmailSystem',
      ],
      contracts: [
        'ContractTemplateManager','ContractGenerator','ContractAnalyzer','EnhancedContractWizard',
      ],
      crm: ['UniversalChatWidget','EmailChatIntegration','ComprehensiveChatSystem'],
  },
    equipment: {
      equipment: [
        'ComprehensiveEquipmentDashboard','EquipmentTrackingDashboard','LiveEquipmentDashboard','EquipmentMaintenanceScheduler',
      ],
      lighting: ['LightingSimulator3','InteractiveLensVisualization','SmartLensMatching'],
      maintenance: [
        'EquipmentMaintenanceTracker','EquipmentNotificationSystem','EquipmentUpgradeRoadmap',
      ],
  },
    settings: {
      integrations: [
        'GoogleDriveIntegration','MicrosoftIntegrationDemo','ComprehensiveDriveIntegration',
      ],
  ...
  videographer: {
    overview: {
      analytics: [
        'AnalyticsManagementDashboard','PerformanceAnalyticsDashboard','RevenueAnalyticsDashboard',
      ],
    ...
    projects: {
      ...
      collaboration: [
        'UnifiedVideoMusicCollaboration','LiveCollaborationWorkspace','ContentCollaboration',
      ],
  },
    clients: {
    ...
    equipment: {
      equipment: [
        'LiveEquipmentDashboard','VideoEquipmentTracker','VideoEquipmentMaintenanceScheduler',
      ],
      video: ['ComprehensiveEquipmentDashboard','EquipmentTrackingDashboard'],
  },
    settings: {
      integrations: [
        'ComprehensiveDriveIntegration','MicrosoftCalendarIntegration','UnifiedMicrosoftDashboard',
      ],
  ...
  musicproducer: {
    overview: {
      analytics: [
        'BusinessIntelligenceDashboard','AIMarketingDashboard','RevenueAnalyticsDashboard',
      ],
    ...
    projects: {
      project: [
        'ProjectManagementPageD','ProjectTimelineManager','MusicProducerDashboardWithIntegration',
      ],
      music: ['SoundLibrary','SpotifyArtistManagement','MusicShowcaseManager'],
  },
    clients: {
      communication: [
        'ClientManagementPageD','ClientCommunicationDashboard','UniversalChatWidget',
      ],
      contracts: [
        'ContractAnalyzer','MusicProducerContractTemplates','EnhancedContractGenerator',
      ],
  },
    equipment: {
    ...
    settings: {
      integrations: [
        'GoogleDriveFileManager','MicrosoftOneDriveIntegration','MusicProducerUltimateIntegration',
      ],
  ...
  vendor: {
    overview: {
      analytics: [
        'AnalyticsManagementDashboard','AIBudgetOptimizer','BusinessIntelligenceDashboard',
      ],
    ...
    projects: {
      ...
      marketplace: [
        'VendorMarketplaceMobileInterface','PartnerProductManager','RentalComparison',
      ],
  },
    clients: {
    ...
    equipment: {
      equipment: [
        'ComprehensiveEquipmentDashboard','EquipmentMaintenanceScheduler','EquipmentTrackingDashboard',
      ],
      inventory: ['LiveEquipmentDashboard','EquipmentPricingDashboard','EquipmentSearchSystem'],
  },
    settings: {
      integrations: [
        'GoogleDriveIntegration','MicrosoftIntegrationDemo','SeamlessWorkflowIntegration',
      ],
...
export default function ComponentOrchestrator({
  ...
  const totalActiveComponents = Object.values(currentTabComponents).reduce(
      ...
      <MuiCard sx={{ mb:  3, bgcolor: '#e3f2fd'}}>
        <CardContent sx={{ display: 'flex', alignItems: 'center', gap:  2 ,  ...theming.getThemedCardSx() }}>
          ...
          <Typography variant="body1">
            <strong>{currentTab.charAt(0).toUpperCase() + currentTab.slice(1)}</strong> fane er
            aktiv med <strong>{totalActiveComponents} komponenter</strong> fordelt på{''}
                ...
                <CardContent sx={theming.getThemedCardSx()}>
                  ...
                  >
                    <Typography variant="h6"
                      sx={{ color: config.color, textTransform: 'capitalize'}}
                     sx={{ ...{}, color: theming.colors.primary }}>
                      {category}
                    </Typography>
                    <Chip label={`${components.length} komponenter`} size="small" color="primary" />
                  </Box>
          ...
          <Grid container spacing={2}>
            <Grid item xs={12} sm={4}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap:  1 }}>
                ...
                <Typography variant="body2">Universal Dashboard: Aktivt</Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={4}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap:  1 }}>
                <CheckCircle sx={{ color: '#4caf50'}} />
                <Typography variant="body2">Profession Adapter: Aktivt</Typography>
              </Box>
            </Grid>
            <Grid item xs={12} sm={4}>
              <Box sx={{ display: 'flex', alignItems: 'center', gap:  1 }}>
                <CheckCircle sx={{ color: '#4caf50'}} />
                <Typography variant="body2">Component Registry: Aktivt</Typography>
              </Box>
            </Grid>
          </Grid>
        </CardContent>

...
export default function AdvancedCMSInterface() {
  ...
  const { data: systemSettings = {} as SystemSettings, isLoading: settingsLoading } =
  ...
  const getProfessionIcon = (profession: string) => {
    switch (profession) {
      ...
      case 'videographer':
        return theming.getThemedIcon('videocam');
      case 'music_producer':
        return theming.getThemedIcon('libraryMusic');
      case 'vendor':
        return theming.getThemedIcon('store');
    ...
    <Box>
      <Box
        sx={{
          ...
          mb:  3}}
      >
        <Typography variant="h5" sx={{ color: theming.colors.primary }}>Komponent & Sidestyring</Typography>
        <Box>
          ...
          <TableBody>
            {components.map((component) => (
              <TableRow key={component.id}>
                ...
                <TableCell>
                  <Chip label={component.profession} size="small" color="primary" />
                </TableCell>
                <TableCell>
                  <Chip
                ...
                <TableCell>
                  <Typography variant="caption">{component.lastModified}</Typography>
                  ...
                  onChange={(e) =>
                    updateSystemSettingsMutation.mutate({
                      features: {
                        ...
                        google_drive_integration: e.target.checked,
                    },
                  })
                }
                />
                ...
                <Switch
                  ...
                  onChange={(e) =>
                    updateSystemSettingsMutation.mutate({
                      features: {
                        ...systemSettings.features,
                        spotify_integration: e.target.checked,
                    },
                  })
                }
                />
              ...
              <TextField
                ...
                onChange={(e) =>
                  updateSystemSettingsMutation.mutate({
                    security: {
                      ...systemSettings.security,
                      password_requirements: e.target.value,
                  },
                })
              }
              />
    ...
    <Box sx={{ p:  3 }}>
      ...
      >
        ...
        <DialogContent>
          {selectedComponent && (
            <Box sx={{ pt:  2 }}>
              <TextField fullWidth label="Navn" value={selectedComponent.name} sx={{ mb:  2 }} />

...
const localProfessionConfigs: ProfessionConfigs = {
  admin: {
    ...
    tabs: [
      ...
      { id: 'role-room', label: 'The Role Room', icon: <img src="/theroleroom-mark-1024.png" alt="Role Room" style={{ width: 24, height: 24, objectFit: 'contain' }} /> },
      ...
      {showNotifications && (
        <Box
          sx={{
            ...
            // Slice 9X.72 — dark theme
            background: `linear-gradient(135deg, ${alpha(customBranding.color, 0.08)}, rgba(15,10,7,0.96))`,
            color: '#fff5e8',
            borderLeft: `1px solid ${alpha(customBranding.color, 0.18)}`,

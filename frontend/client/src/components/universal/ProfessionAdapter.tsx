...
export default function ProfessionAdapter({ 
  ...
  const currentComponents = config.components?.[currentTab] || [];
      ...
      case 'files':
        return (
          <Box sx={{ p: 3 }}>
            ...
            <FilesTab profession={profession as 'photographer' | 'videographer' | 'music_producer' | 'vendor'} userId={projectId} />
          </Box>
        );
      ...
      default: return (
          <Box sx={{ p: 2 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, mb: 3 }}>
              {React.cloneElement(config.icon, { sx: { color: config.iconColor, fontSize: 32} })}
              ...
              <MuiCardContent>
                <Box sx={{ display: 'flex', alignItems: 'center', gap:  2 }}>
                  ...
                  <Button
                    ...
                    sx={{ ml: 'auto', borderColor: config.color, color: config.iconColor }}
                  >
                    Oppdater
                  </Button>
                </Box>
            ...
            <Grid container spacing={2}>
              {currentComponents.map((componentName, index) => {
                const Component = componentRegistry[componentName];
                
                return (
                  <Grid size={{ xs: 12, md: 6, lg: 4 }} key={componentName}>
                    <MuiCard sx={{
                      height: '200px',
                          ...
                          <React.Suspense fallback={
                            ...
                            <Box sx={{ flex: 1, overflow: 'hidden' }}>
                              {componentName === 'UniversalVendorDashboard' && profession === 'vendor' ? (
                                <Component
                                  vendorType={config.vendorType || 'software'}

  ...
  no: {
    ...
    pricing: {
      ...
      enterprise: {
        ...
        points: ['White label', 'Dedikert onboarding', 'Tilpassede integrasjoner', 'Google/Microsoft-pålogging og rollebasert tilgangsstyring'],
        cta: 'Kontakt salg',
      },
    },
    why: {
  ...
  en: {
    ...
    pricing: {
      ...
      enterprise: {
        ...
        points: ['White label', 'Dedicated onboarding', 'Custom integrations', 'Google/Microsoft login and role-based access control'],
        cta: 'Contact sales',
      },
    },
    why: {

      ...
      <ViewModule className="w-full max-w-2xl">
        <CardContent className="pt-8" sx={theming.getThemedCardSx()}>
          <div className="flex flex-col items-center justify-center min-h-screen">
            ...
            <div className="flex flex-col items-center justify-center min-h-screen">
              <Button
                onClick={ () => window.open('mailto:hello@creatorhubn.com?subject=CreatorHub Norge Access Request&body=Hello,%0D%0A%0D%0AI would like to request access to CreatorHub Norge.%0D%0A%0D%0AName: %0D%0AProfession: %0D%0ACompany/Studio: %0D%0AReason for access: %0D%0A%0D%0AThank you!', '_blank') }

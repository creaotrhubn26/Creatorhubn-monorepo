...
export default function MicrosoftIntegrationAdmin() {
const queryClient = useQueryClient();
  
  // Theming system
  const theming = useTheming('prototype_tester');
  
  // Database connection for MicrosoftIntegrationAdmin
  ...
  const updateMicrosoftIntegrationAdmin = useMutation({

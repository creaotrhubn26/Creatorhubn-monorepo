...
export default function UnifiedWeddingPlatform() {
const queryClient = useQueryClient();
  
  // Theming system
  const theming = useTheming('photographer');
  
  // Database connection for UnifiedWeddingPlatform
  ...
  const updateUnifiedWeddingPlatform = useMutation({

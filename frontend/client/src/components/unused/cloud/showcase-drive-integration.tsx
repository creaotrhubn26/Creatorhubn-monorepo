...
export default function ShowcaseDriveIntegration() {
const queryClient = useQueryClient();
  
  // Theming system
  const theming = useTheming('photographer');
  
  // Database connection for ShowcaseDriveIntegration
  ...
  const updateShowcaseDriveIntegration = useMutation({

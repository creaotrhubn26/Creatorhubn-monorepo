...
export default function EnhancedWeddingItinerary() {
const queryClient = useQueryClient();
  
  // Theming system
  const theming = useTheming('photographer');
  
  // Database connection for EnhancedWeddingItinerary
  ...
  const updateEnhancedWeddingItinerary = useMutation({

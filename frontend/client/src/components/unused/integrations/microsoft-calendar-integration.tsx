...
export default function MicrosoftCalendarIntegration() {
const queryClient = useQueryClient();
  
  // Theming system
  const theming = useTheming('prototype_tester');
  
  // Database connection for MicrosoftCalendarIntegration
  ...
  const updateMicrosoftCalendarIntegration = useMutation({

...
export default function EventPlanningManager() {
const queryClient = useQueryClient();
  
  // Theming system
  const theming = useTheming('photographer');
  
  // Database connection for EventPlanningManager
  ...
  const updateEventPlanningManager = useMutation({

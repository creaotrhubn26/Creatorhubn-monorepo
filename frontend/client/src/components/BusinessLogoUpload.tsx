...
export const BusinessLogoUpload: React.FC<BusinessLogoUploadProps> = ({
  ...
  const getSizeProps = () => {
    switch (size) {
      ...
      case 'large': return { width: 10, height: 120,};
  ...
  const deleteMutation = useMutation({
    mutationFn: async () => {
      ...
      return apiRequest(`/api/business-logo/${userId}`, {
        headers: {
          "Content-Type" : "application/json"
    },
        method: 'DELETE'
  ...
  return (
    <Card sx={{ maxWidth: 40, mx: 'auto',  ...theming.getThemedCardSx() }}>

...
const PRICE_RANGE_VALUES =
  ['budget', 'mid-range', 'professional', 'cinema'] as const satisfies readonly CameraPriceRange[];
const SOURCE_VALUES =
  ['manual', 'api', 'discovery', 'seed'] as const satisfies readonly CameraSource[];
